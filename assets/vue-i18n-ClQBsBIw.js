import { Dt as e, Ht as t, Ot as n, Rt as r, Wt as i, Yt as a, Zt as o, gt as s, ht as c, it as l, mt as u, ot as d, pt as f, tt as p, vt as m, wt as h } from "./index-Vl7drdoJ.js";
function g(e2, t2) {
...
function hr(e2 = {}, t2) {
  let { __root: n2, __injectWithOption: i2 } = e2, s2 = n2 === void 0, c2 = e2.flatJson, l2 = _ ? a : o, u2 = !!e2.translateExistCompatible, f2 = I(e2.inheritLocale) ? e2.inheritLocale : true, p2 = l2(n2 && f2 ? n2.locale.value : F(e2.locale) ? e2.locale : en), m2 = l2(n2 && f2 ? n2.fallbackLocale.value : F(e2.fallbackLocale) || N(e2.fallbackLocale) || z(e2.fallbackLocale) || e2.fallbackLocale === false ? e2.fallbackLocale : p2.value), h2 = l2(sr(p2.value, e2)), g2 = l2(z(e2.datetimeFormats) ? e2.datetimeFormats : { [p2.value]: {} }), v2 = l2(z(e2.numberFormats) ? e2.numberFormats : { [p2.value]: {} }), y2 = n2 ? n2.missingWarn : I(e2.missingWarn) || C(e2.missingWarn) ? e2.missingWarn : true, b2 = n2 ? n2.fallbackWarn : I(e2.fallbackWarn) || C(e2.fallbackWarn) ? e2.fallbackWarn : true, S2 = n2 ? n2.fallbackRoot : I(e2.fallbackRoot) ? e2.fallbackRoot : true, w2 = !!e2.fallbackFormat, E2 = P(e2.missing) ? e2.missing : null, D2 = P(e2.missing) ? mr(e2.missing) : null, O2 = P(e2.postTranslation) ? e2.postTranslation : null, k2 = n2 ? n2.warnHtmlMessage : I(e2.warnHtmlMessage) ? e2.warnHtmlMessage : true, ee2 = !!e2.escapeParameter, te2 = n2 ? n2.modifiers : z(e2.modifiers) ? e2.modifiers : {}, A2 = e2.pluralRules || n2 && n2.pluralRules, j2;
  j2 = (() => {
    s2 && pn(null);
  ...
  let B2 = (e3, t3, r2, i3, a2, o2) => {
    ne2();
    let c3;
    try {
      __INTLIFY_PROD_DEVTOOLS__, s2 || (j2.fallbackContext = n2 ? mn() : void 0), c3 = e3(j2);
    } finally {
      __INTLIFY_PROD_DEVTOOLS__, s2 || (j2.fallbackContext = void 0);
    }
    if (r2 !== `translate exists` && x(c3) && c3 === -1 || r2 === `translate exists` && !c3) {
      let [e4, r3] = t3();
      return n2 && S2 ? i3(n2) : a2(e4);
  ...
  function pe2(...e3) {
    let [t3, n3, r2] = e3;
    if (r2 && !L(r2)) throw $(Q.INVALID_ARGUMENT);
    return fe2(t3, n3, T({ resolvedMessage: true }, r2 || {}));
  }
  function me2(...e3) {
  ...
  function ve2(...e3) {
    return B2((t3) => {
      let n3, r2 = t3;
      try {
        r2.processor = _e2, n3 = Reflect.apply(Mn, null, [r2, ...e3]);
      } finally {
        r2.processor = null;
      }
      return n3;
  ...
  function xe2(e3, t3) {
    return B2(() => {
      if (!e3) return false;
      let n3 = U2(F(t3) ? t3 : p2.value), r2 = j2.messageResolver(n3, e3);
      return u2 ? r2 != null : K(r2) || Y(r2) || F(r2);
    }, () => [e3], `translate exists`, (n3) => Reflect.apply(n3.te, n3, [e3, t3]), fr, (e4) => I(e4));
  }
  function H2(e3) {
    let t3 = null, n3 = Yt(j2, m2.value, p2.value);
    for (let r2 = 0; r2 < n3.length; r2++) {
      let i3 = h2.value[n3[r2]] || {}, a2 = j2.messageResolver(i3, e3);
      if (a2 != null) {
        t3 = a2;
        break;
      }
  ...
  function Ce2(e3, t3) {
    if (c2) {
      let n3 = { [e3]: t3 };
      for (let e4 in n3) M(n3, e4) && or(n3[e4]);
      t3 = n3[e3];
    }
  ...
  function we2(e3, t3) {
    ...
    let n3 = { [e3]: t3 };
    if (c2) for (let e4 in n3) M(n3, e4) && or(n3[e4]);
    t3 = n3[e3], ce(t3, h2.value[e3]), j2.messages = h2.value;
  }
  function Te2(e3) {
    return g2.value[e3] || {};
  }
  ...
  let W2 = { id: pr, locale: R2, fallbackLocale: re2, get inheritLocale() {
    ...
    f2 = e3, e3 && n2 && (p2.value = n2.locale.value, m2.value = n2.fallbackLocale.value, yn(j2, p2.value, m2.value));
...
function Dr(e2) {
  ...
  return { created: (n2, i2) => {
    let [a2, o2] = t2(i2);
    _ && e2.global === o2 && (n2.__i18nWatcher = r(o2.locale, () => {
      i2.instance && i2.instance.$forceUpdate();
    })), n2.__composer = o2, n2.textContent = a2;
  }, unmounted: (e3) => {
...
function Ir(e2, n2, r2) {
  let i2 = t();
  {
    let t2 = __VUE_I18N_LEGACY_API__ && n2 ? i2.run(() => _r(e2)) : i2.run(() => hr(e2));
    if (t2 == null) throw $(Q.UNEXPECTED_ERROR);
    return [i2, t2];
  }
}
function Lr(e2) {
...
function Hr(t2, r2, i2) {
  e(() => {
  }, r2), n(() => {
    let e2 = i2;
    t2.__deleteInstance(r2);
    let n2 = e2[ar];
    n2 && (n2(), delete e2[ar]);
  }, r2);
}
function Ur(e2, t2, n2, r2 = {}) {
  let i2 = t2 === `local`, s2 = o(null);
  if (i2 && e2.proxy && !(e2.proxy.$options.i18n || e2.proxy.$options.__i18n)) throw $(Q.MUST_DEFINE_I18N_OPTION_IN_ALLOW_COMPOSITION);
  let c2 = I(r2.inheritLocale) ? r2.inheritLocale : !F(r2.locale), l2 = a(!i2 || c2 ? n2.locale.value : F(r2.locale) ? r2.locale : en), u2 = a(!i2 || c2 ? n2.fallbackLocale.value : F(r2.fallbackLocale) || N(r2.fallbackLocale) || z(r2.fallbackLocale) || r2.fallbackLocale === false ? r2.fallbackLocale : l2.value), f2 = a(sr(l2.value, r2)), p2 = a(z(r2.datetimeFormats) ? r2.datetimeFormats : { [l2.value]: {} }), m2 = a(z(r2.numberFormats) ? r2.numberFormats : { [l2.value]: {} }), g2 = i2 ? n2.missingWarn : I(r2.missingWarn) || C(r2.missingWarn) ? r2.missingWarn : true, _2 = i2 ? n2.fallbackWarn : I(r2.fallbackWarn) || C(r2.fallbackWarn) ? r2.fallbackWarn : true, v2 = i2 ? n2.fallbackRoot : I(r2.fallbackRoot) ? r2.fallbackRoot : true, y2 = !!r2.fallbackFormat, b2 = P(r2.missing) ? r2.missing : null, x2 = P(r2.postTranslation) ? r2.postTranslation : null, S2 = i2 ? n2.warnHtmlMessage : I(r2.warnHtmlMessage) ? r2.warnHtmlMessage : true, w2 = !!r2.escapeParameter, T2 = i2 ? n2.modifiers : z(r2.modifiers) ? r2.modifiers : {}, E2 = r2.pluralRules || i2 && n2.pluralRules;
  function D2() {
  ...
  function ce2(e3, t3) {
    return s2.value ? s2.value.te(e3, t3) : false;
  }
  function le2(e3) {
    return s2.value ? s2.value.getLocaleMessage(e3) : {};
  }
  function ue2(e3, t3) {
    s2.value && (s2.value.setLocaleMessage(e3, t3), f2.value[e3] = t3);
  }
  function de2(e3, t3) {
    s2.value && s2.value.mergeLocaleMessage(e3, t3);
  }
  function B2(e3) {
    return s2.value ? s2.value.getDateTimeFormat(e3) : {};
  }
  function fe2(e3, t3) {
    s2.value && (s2.value.setDateTimeFormat(e3, t3), p2.value[e3] = t3);
  }
  function pe2(e3, t3) {
    s2.value && s2.value.mergeDateTimeFormat(e3, t3);
  }
  function me2(e3) {
    return s2.value ? s2.value.getNumberFormat(e3) : {};
  }
  function he2(e3, t3) {
    s2.value && (s2.value.setNumberFormat(e3, t3), m2.value[e3] = t3);
  }
  function ge2(e3, t3) {
    s2.value && s2.value.mergeNumberFormat(e3, t3);
  }
  let _e2 = { get id() {
  ...
  function ve2(e3) {
    e3.locale.value = l2.value, e3.fallbackLocale.value = u2.value, Object.keys(f2.value).forEach((t3) => {
      ...
      e3.mergeNumberFormat(t3, m2.value[t3]);
  ...
  return h(() => {
    ...
    let n3 = s2.value = e2.proxy.$i18n.__composer;
    t2 === `global` ? (l2.value = n3.locale.value, u2.value = n3.fallbackLocale.value, f2.value = n3.messages.value, p2.value = n3.datetimeFormats.value, m2.value = n3.numberFormats.value) : i2 && ve2(n3);
  }), _e2;
}
