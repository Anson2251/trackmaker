...
import { N as e, o as t } from "./Card-kwg1fWHx.js";
import { Rt as n, Yt as r, a as i, d as a, f as o, p as s } from "./index-Vl7drdoJ.js";
import { i as c, n as l, r as u } from "./core-XYwh2dOT.js";
...
const m = i(`settings`, () => {
  let e2 = r({ theme: `system`, interfaceLanguage: `en`, mapLanguage: `interface`, watchCompatibilityMode: true, geolocationCorrection: false });
  async function t2() {
    let t3 = await l(`settings`);
    t3 && (e2.value = { ...e2.value, ...t3 });
  }
  async function i2() {
    await c(`settings`, JSON.parse(JSON.stringify(e2.value))), await u();
  }
  return n(e2, i2, { deep: true }), { settings: e2, init: t2 };
});
var h = class {
  constructor() {
