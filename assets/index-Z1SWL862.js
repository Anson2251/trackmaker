import { n as d, o as g, p as v, b as m, L as u, q as x, g as b, a as G, s as Z, i as R, f as h, t as a, j as k, E as f, h as w } from "./index-CbBO3481.js";
...
function A(O) {
  ...
  if (e.name == "PropertyName" && e.parent.name == "MemberExpression") return { type: "prop", node: e, target: e.parent };
...
const H = d.inputHandler.of((O, i, t, r) => r != "%" || i != t || O.state.doc.sliceString(i - 1, t + 1) != "{}" ? false : (O.dispatch(O.state.changeByRange((e) => ({ changes: { from: e.from, to: e.to, insert: "%%" }, range: g.cursor(e.from + 1) })), { scrollIntoView: true, userEvent: "input.type" }), true));
function p(O) {
  return (i) => {
