...
`,[E("scrollbar",`
 ...
 opacity: 0;
 `)]),["warning","error"].map(e=>Y(`${e}-status`,[y("state-border",`border: var(--n-border-${e});`),Le("disabled",[se("&:hover",[y("state-border",`
