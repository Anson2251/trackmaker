...
import { D as e, M as t, N as n, P as r, at as i, ct as a, d as o, dt as s, f as c, g as l, h as u, lt as d, m as f, o as p, ot as m, p as h, s as g, ut as _, v, w as y, x as b } from "./Card-Cnwdt0Jy.js";
import { J as x, M as S, U as C, b as w, c as T, f as E } from "./light-B0oNY7_E.js";
import { At as D, J as O, Jt as k, St as A, Tt as j, Zt as M, ft as N, gt as P, mt as F, ot as I, u as ee, vt as L } from "./index-DqD7808G.js";
...
const Xe = S && `chrome` in window;
S && navigator.userAgent.includes(`Firefox`);
const Ze = S && navigator.userAgent.includes(`Safari`) && !Xe;
function X(e2) {
...
var tt = { name: `Button`, common: p, self: et }, nt = i([m(`button`, `
 ...
 `), d(`dashed`, [a(`border, state-border`, { borderStyle: `dashed !important` })]), d(`disabled`, { cursor: `not-allowed`, opacity: `var(--n-opacity-disabled)` })]), i(`@keyframes button-wave-spread`, { from: { boxShadow: `0 0 0.5px 0 var(--n-ripple-color)` }, to: { boxShadow: `0 0 0.5px 4.5px var(--n-ripple-color)` } }), i(`@keyframes button-wave-opacity`, { from: { opacity: `var(--n-wave-opacity)` }, to: { opacity: 0 } })]), Q = F({ name: `Button`, props: Object.assign(Object.assign({}, c.props), { color: String, textColor: String, text: Boolean, block: Boolean, loading: Boolean, disabled: Boolean, circle: Boolean, size: String, ghost: Boolean, round: Boolean, secondary: Boolean, tertiary: Boolean, quaternary: Boolean, strong: Boolean, focusable: { type: Boolean, default: true }, keyboard: { type: Boolean, default: true }, tag: { type: String, default: `button` }, type: { type: String, default: `default` }, dashed: Boolean, renderIcon: Function, iconPlacement: { type: String, default: `left` }, attrType: { type: String, default: `button` }, bordered: { type: Boolean, default: true }, onClick: [Function, Array], nativeFocusBehavior: { type: Boolean, default: !Ze } }), slots: Object, setup(t2) {
  let r2 = k(null), i2 = k(null), a2 = k(false), o2 = x(() => !t2.quaternary && !t2.tertiary && !t2.secondary && !t2.text && (!t2.color || t2.ghost || t2.dashed) && t2.bordered), d2 = L(Qe, {}), { mergedSizeRef: f2 } = ie({}, { defaultSize: `medium`, mergedSize: (e2) => {
    let { size: n2 } = t2;
    if (n2) return n2;
    let { size: r3 } = d2;
    if (r3) return r3;
  ...
  return { selfElRef: r2, waveElRef: i2, mergedClsPrefix: S2, mergedFocusable: p2, mergedSize: f2, showBorder: o2, enterPressed: a2, rtlEnabled: E2, handleMousedown: m2, handleKeydown: _2, handleBlur: y2, handleKeyup: g2, handleClick: h2, customColorCssVars: I(() => {
    let { color: e2 } = t2;
    if (!e2) return null;
    let n2 = X(e2);
