import { A as e, at as t, f as n, g as r, lt as i, o as a, ot as o, v as s } from "./Card-wTK5VWgg.js";
import { S as c } from "./light-DcazuQOY.js";
import { St as l, _t as u, ht as d, st as f } from "./index-C4uc8sCV.js";
function p(e2) {
...
const g = d({ _n_icon__: true, name: `Icon`, inheritAttrs: false, props: Object.assign(Object.assign({}, n.props), { depth: [String, Number], size: [Number, String], color: String, component: [Object, Function] }), setup(e2) {
  let { mergedClsPrefixRef: t2, inlineThemeDisabled: i2 } = s(e2), a2 = n(`Icon`, `-icon`, h, m, e2, t2), o2 = f(() => {
  ...
  }), l2 = i2 ? r(`icon`, f(() => `${e2.depth || `d`}`), o2, e2) : void 0;
  return { mergedClsPrefix: t2, mergedStyle: f(() => {
  ...
  return ((_a = t2 == null ? void 0 : t2.$options) == null ? void 0 : _a._n_icon__) && e(`icon`, "don't wrap `n-icon` inside `n-icon`"), a2 == null ? void 0 : a2(), u(`i`, l(this.$attrs, { role: `img`, class: [`${r2}-icon`, o2, { [`${r2}-icon--depth`]: n2, [`${r2}-icon--color-transition`]: n2 !== void 0 }], style: [this.cssVars, this.mergedStyle] }), i2 ? u(i2) : this.$slots);
} });
