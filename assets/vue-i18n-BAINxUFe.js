import { Ct as e, Et as t, Jt as n, Lt as r, Ot as i, Pt as a, Qt as o, Rt as s, Tt as c, an as l, dt as u, en as d, gt as f, mt as p, sn as m, wt as h } from "./index-DTVnoW_1.js";
function g(e2, t2) {
...
function hr(e2 = {}, t2) {
  ...
  j2 = (() => {
    ...
    let n2 = gn(t3);
    return a2 && pn(n2), n2;
  })(), yn(j2, d2.value, p2.value);
  function ne2() {
    return [d2.value, p2.value, h2.value, g2.value, v2.value];
  }
  let R2 = f({ get: () => d2.value, set: (e3) => {
    d2.value = e3, j2.locale = d2.value;
  } }), re2 = f({ get: () => p2.value, set: (e3) => {
    p2.value = e3, j2.fallbackLocale = p2.value, yn(j2, d2.value, e3);
  } }), ie2 = f(() => h2.value), ae2 = f(() => g2.value), oe2 = f(() => v2.value);
  function se2() {
    return P(O2) ? O2 : null;
  }
  function le2(e3) {
  ...
  let B2 = (e3, t3, n2, i3, o3, s3) => {
    ne2();
    let c3;
    try {
      __INTLIFY_PROD_DEVTOOLS__, a2 || (j2.fallbackContext = r2 ? mn() : void 0), c3 = e3(j2);
    } finally {
      __INTLIFY_PROD_DEVTOOLS__, a2 || (j2.fallbackContext = void 0);
    }
    if (n2 !== `translate exists` && x(c3) && c3 === -1 || n2 === `translate exists` && !c3) {
      let [e4, n3] = t3();
      return r2 && S2 ? i3(r2) : o3(e4);
  ...
  function xe2(e3, t3) {
    return B2(() => {
      ...
      return c2 ? r3 != null : K(r3) || Y(r3) || F(r3);
    }, () => [e3], `translate exists`, (n2) => Reflect.apply(n2.te, n2, [e3, t3]), fr, (e4) => I(e4));
  }
  function H2(e3) {
    let t3 = null, n2 = Yt(j2, p2.value, d2.value);
  ...
  function Ce2(e3, t3) {
    ...
    h2.value[e3] = t3, j2.messages = h2.value;
  }
  function we2(e3, t3) {
    h2.value[e3] = h2.value[e3] || {};
    let n2 = { [e3]: t3 };
    if (o2) for (let e4 in n2) M(n2, e4) && or(n2[e4]);
    t3 = n2[e3], ce(t3, h2.value[e3]), j2.messages = h2.value;
  }
  function Te2(e3) {
    return g2.value[e3] || {};
  }
  ...
  pr++, r2 && _ && (n(r2.locale, (e3) => {
    u2 && (d2.value = e3, j2.locale = e3, yn(j2, d2.value, p2.value));
  }), n(r2.fallbackLocale, (e3) => {
    u2 && (p2.value = e3, j2.fallbackLocale = e3, yn(j2, d2.value, p2.value));
  }));
  let W2 = { id: pr, locale: R2, fallbackLocale: re2, get inheritLocale() {
    return u2;
  }, set inheritLocale(e3) {
    u2 = e3, e3 && r2 && (d2.value = r2.locale.value, p2.value = r2.fallbackLocale.value, yn(j2, d2.value, p2.value));
...
function yr({ slots: e2 }, t2) {
  return t2.length === 1 && t2[0] === `default` ? (e2.default ? e2.default() : []).reduce((e3, t3) => [...e3, ...t3.type === u ? t3.children : [t3]], []) : t2.reduce((t3, n2) => {
    let r2 = e2[n2];
...
var xr = h({ name: `i18n-t`, props: T({ keypath: { type: String, required: true }, plural: { type: [Number, String], validator: (e2) => x(e2) || !isNaN(e2) } }, vr), setup(e2, n2) {
  let { slots: r2, attrs: i2 } = n2, a2 = e2.i18n || Fr({ useScope: e2.scope, __useComponent: true });
  return () => {
    let o2 = Object.keys(r2).filter((e3) => e3 !== `_`), s2 = D();
    e2.locale && (s2.locale = e2.locale), e2.plural !== void 0 && (s2.plural = F(e2.plural) ? +e2.plural : e2.plural);
    let c2 = yr(n2, o2), l2 = a2[er](e2.keypath, c2, s2), u2 = T(D(), i2);
    return t(F(e2.tag) || L(e2.tag) ? e2.tag : br(), u2, l2);
  };
} });
function Sr(e2) {
  return N(e2) && !F(e2[0]);
}
function Cr(e2, n2, r2, i2) {
  let { slots: a2, attrs: o2 } = n2;
  return () => {
    let n3 = { part: true }, s2 = D();
    e2.locale && (n3.locale = e2.locale), F(e2.format) ? n3.key = e2.format : L(e2.format) && (F(e2.format.key) && (n3.key = e2.format.key), s2 = Object.keys(e2.format).reduce((t2, n4) => r2.includes(n4) ? T(D(), t2, { [n4]: e2.format[n4] }) : t2, D()));
    let c2 = i2(e2.value, n3, s2), l2 = [n3.key];
    N(c2) ? l2 = c2.map((e3, t2) => {
      let n4 = a2[e3.type], r3 = n4 ? n4({ [e3.type]: e3.value, index: t2, parts: c2 }) : [e3.value];
      return Sr(r3) && (r3[0].key = `${e3.type}-${t2}`), r3;
    }) : F(c2) && (l2 = [c2]);
    let u2 = T(D(), o2);
    return t(F(e2.tag) || L(e2.tag) ? e2.tag : br(), u2, l2);
  };
}
var wr = h({ name: `i18n-n`, props: T({ value: { type: Number, required: true }, format: { type: [String, Object] } }, vr), setup(e2, t2) {
  let n2 = e2.i18n || Fr({ useScope: e2.scope, __useComponent: true });
  return Cr(e2, t2, Kn, (...e3) => n2[nr](...e3));
} }), Tr = h({ name: `i18n-d`, props: T({ value: { type: [Number, Date], required: true }, format: { type: [String, Object] } }, vr), setup(e2, t2) {
  let n2 = e2.i18n || Fr({ useScope: e2.scope, __useComponent: true });
...
function Lr(e2) {
  {
    let t2 = i(e2.isCE ? Nr : e2.appContext.app.__VUE_I18N_SYMBOL__);
...
function Hr(e2, t2, n2) {
  r(() => {
    ...
    let r2 = n2;
    e2.__deleteInstance(t2);
    let i2 = r2[ar];
    i2 && (i2(), delete r2[ar]);
  }, t2);
}
function Ur(e2, t2, n2, r2 = {}) {
  let i2 = t2 === `local`, o2 = m(null);
  if (i2 && e2.proxy && !(e2.proxy.$options.i18n || e2.proxy.$options.__i18n)) throw $(Q.MUST_DEFINE_I18N_OPTION_IN_ALLOW_COMPOSITION);
  let s2 = I(r2.inheritLocale) ? r2.inheritLocale : !F(r2.locale), c2 = l(!i2 || s2 ? n2.locale.value : F(r2.locale) ? r2.locale : en), u2 = l(!i2 || s2 ? n2.fallbackLocale.value : F(r2.fallbackLocale) || N(r2.fallbackLocale) || z(r2.fallbackLocale) || r2.fallbackLocale === false ? r2.fallbackLocale : c2.value), d2 = l(sr(c2.value, r2)), p2 = l(z(r2.datetimeFormats) ? r2.datetimeFormats : { [c2.value]: {} }), h2 = l(z(r2.numberFormats) ? r2.numberFormats : { [c2.value]: {} }), g2 = i2 ? n2.missingWarn : I(r2.missingWarn) || C(r2.missingWarn) ? r2.missingWarn : true, _2 = i2 ? n2.fallbackWarn : I(r2.fallbackWarn) || C(r2.fallbackWarn) ? r2.fallbackWarn : true, v2 = i2 ? n2.fallbackRoot : I(r2.fallbackRoot) ? r2.fallbackRoot : true, y2 = !!r2.fallbackFormat, b2 = P(r2.missing) ? r2.missing : null, x2 = P(r2.postTranslation) ? r2.postTranslation : null, S2 = i2 ? n2.warnHtmlMessage : I(r2.warnHtmlMessage) ? r2.warnHtmlMessage : true, w2 = !!r2.escapeParameter, T2 = i2 ? n2.modifiers : z(r2.modifiers) ? r2.modifiers : {}, E2 = r2.pluralRules || i2 && n2.pluralRules;
  function D2() {
    return [c2.value, u2.value, d2.value, p2.value, h2.value];
  }
  let O2 = f({ get: () => o2.value ? o2.value.locale.value : c2.value, set: (e3) => {
    o2.value && (o2.value.locale.value = e3), c2.value = e3;
  } }), k2 = f({ get: () => o2.value ? o2.value.fallbackLocale.value : u2.value, set: (e3) => {
    o2.value && (o2.value.fallbackLocale.value = e3), u2.value = e3;
  } }), ee2 = f(() => o2.value ? o2.value.messages.value : d2.value), te2 = f(() => p2.value), A2 = f(() => h2.value);
  function j2() {
    return o2.value ? o2.value.getPostTranslationHandler() : x2;
  }
  function M2(e3) {
    o2.value && o2.value.setPostTranslationHandler(e3);
  }
  function L2() {
    return o2.value ? o2.value.getMissingHandler() : b2;
  }
  function ne2(e3) {
    o2.value && o2.value.setMissingHandler(e3);
  }
  function R2(e3) {
    return D2(), e3();
  }
  function re2(...e3) {
    return o2.value ? R2(() => Reflect.apply(o2.value.t, null, [...e3])) : R2(() => ``);
  }
  function ie2(...e3) {
    return o2.value ? Reflect.apply(o2.value.rt, null, [...e3]) : ``;
  }
  function ae2(...e3) {
    return o2.value ? R2(() => Reflect.apply(o2.value.d, null, [...e3])) : R2(() => ``);
  }
  function oe2(...e3) {
    return o2.value ? R2(() => Reflect.apply(o2.value.n, null, [...e3])) : R2(() => ``);
  }
  function se2(e3) {
    return o2.value ? o2.value.tm(e3) : {};
  }
  function ce2(e3, t3) {
    return o2.value ? o2.value.te(e3, t3) : false;
  }
  function le2(e3) {
    return o2.value ? o2.value.getLocaleMessage(e3) : {};
  }
  function ue2(e3, t3) {
    o2.value && (o2.value.setLocaleMessage(e3, t3), d2.value[e3] = t3);
  }
  function de2(e3, t3) {
    o2.value && o2.value.mergeLocaleMessage(e3, t3);
  }
  function B2(e3) {
    return o2.value ? o2.value.getDateTimeFormat(e3) : {};
  }
  function fe2(e3, t3) {
    o2.value && (o2.value.setDateTimeFormat(e3, t3), p2.value[e3] = t3);
  }
  function pe2(e3, t3) {
    o2.value && o2.value.mergeDateTimeFormat(e3, t3);
  }
  function me2(e3) {
    return o2.value ? o2.value.getNumberFormat(e3) : {};
  }
  function he2(e3, t3) {
    o2.value && (o2.value.setNumberFormat(e3, t3), h2.value[e3] = t3);
  }
  function ge2(e3, t3) {
    o2.value && o2.value.mergeNumberFormat(e3, t3);
  }
  let _e2 = { get id() {
    return o2.value ? o2.value.id : -1;
  }, locale: O2, fallbackLocale: k2, messages: ee2, datetimeFormats: te2, numberFormats: A2, get inheritLocale() {
    return o2.value ? o2.value.inheritLocale : s2;
  }, set inheritLocale(e3) {
    o2.value && (o2.value.inheritLocale = e3);
  }, get availableLocales() {
    return o2.value ? o2.value.availableLocales : Object.keys(d2.value);
  }, get modifiers() {
    return o2.value ? o2.value.modifiers : T2;
  }, get pluralRules() {
    return o2.value ? o2.value.pluralRules : E2;
  }, get isGlobal() {
    return o2.value ? o2.value.isGlobal : false;
  }, get missingWarn() {
    return o2.value ? o2.value.missingWarn : g2;
  }, set missingWarn(e3) {
    o2.value && (o2.value.missingWarn = e3);
  }, get fallbackWarn() {
    return o2.value ? o2.value.fallbackWarn : _2;
  }, set fallbackWarn(e3) {
    o2.value && (o2.value.missingWarn = e3);
  }, get fallbackRoot() {
    return o2.value ? o2.value.fallbackRoot : v2;
  }, set fallbackRoot(e3) {
    o2.value && (o2.value.fallbackRoot = e3);
  }, get fallbackFormat() {
    return o2.value ? o2.value.fallbackFormat : y2;
  }, set fallbackFormat(e3) {
    o2.value && (o2.value.fallbackFormat = e3);
  }, get warnHtmlMessage() {
    return o2.value ? o2.value.warnHtmlMessage : S2;
  }, set warnHtmlMessage(e3) {
    o2.value && (o2.value.warnHtmlMessage = e3);
  }, get escapeParameter() {
    return o2.value ? o2.value.escapeParameter : w2;
  }, set escapeParameter(e3) {
    o2.value && (o2.value.escapeParameter = e3);
  ...
  function ve2(e3) {
    e3.locale.value = c2.value, e3.fallbackLocale.value = u2.value, Object.keys(d2.value).forEach((t3) => {
      e3.mergeLocaleMessage(t3, d2.value[t3]);
    }), Object.keys(p2.value).forEach((t3) => {
      e3.mergeDateTimeFormat(t3, p2.value[t3]);
  ...
  return a(() => {
    ...
    let n3 = o2.value = e2.proxy.$i18n.__composer;
    t2 === `global` ? (c2.value = n3.locale.value, u2.value = n3.fallbackLocale.value, d2.value = n3.messages.value, p2.value = n3.datetimeFormats.value, h2.value = n3.numberFormats.value) : i2 && ve2(n3);
  }), _e2;
}
...
function Kr(e2, t2) {
  ...
  return Wr.forEach((e3) => {
    ...
    Object.defineProperty(n2, e3, i2);
