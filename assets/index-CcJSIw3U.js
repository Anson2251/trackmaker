import { L as g, b as q, p as P, q as l, a as c, v as i, s as R, t as r, E as p } from "./index-CbBO3481.js";
...
}), top: "Attribute" }), E = { parser: U }, N = { parser: y }, s = P({ selfClosingTags: true });
function S(O) {
...
function _(O = {}) {
  let t = s;
  if (O.base) {
    if (O.base.language.name != "html" || !(O.base.language instanceof g)) throw new RangeError("The base option must be the result of calling html(...)");
    t = O.base;
  }
  return new q(t.language == s.language ? k : S(t.language), [t.support, t.language.data.of({ closeBrackets: { brackets: ["[", "{", '"'] }, indentOnInput: /^\s*[\}\]]$/ })]);
}
export {
  _ as angular,
