import { d as L, c as ve, o as re, a as ae, r as so, b as Q, e as Io, f as cr, h as g, n as So, F as Ce, p as N, g as qe, T as Bo, w as dr, v as ur, i as ee, j as S, k as ge, l as yo, m as _e, q as Ge, s as mr, t as co, u as hr, x as pr, y as ko, z as vr, A as j, B as F, C as J, D as gr, E as Cr, _ as Eo, G as wo, H as Ye, K as fr, I as br, J as xr } from "./index-DFWefHdl.js";
import { h as Ir, c as Sr, s as Z, r as Do, a as Se, b as Br, d as yr, e as kr, f as Er, g as wr, i as C, j as Dr, k as Rr, l as zr, m as Pr, n as Mr, o as Hr, p as Or, q as Qr, t as Tr, u as Fr, v as Lr, w as jr, x as Vr, y as Nr, z as Wr, A as Zr, B as $r, C as Gr, D as Yr, E as Kr, F as Jr, G as Xr, H as qr, I as _r, J as Ur, K as eA, L as oA, M as rA, N as AA, O as tA, P as nA, Q as aA, R as le, S as lA, T as Pe, U as iA, V as Ro, W as sA, X as Ue, Y as zo, Z as Po, _ as cA, $ as Oe, a0 as dA, a1 as uA, a2 as B, a3 as mA, a4 as P, a5 as Be, a6 as fe, a7 as eo, a8 as hA, a9 as pA, aa as vA, ab as R, ac as Mo, ad as y, ae as gA, af as CA, ag as ue, ah as fA, ai as Ho, aj as bA, ak as ne, al as xA, am as IA, an as Oo, ao as SA, ap as BA, aq as yA, ar as kA, as as Qo, at as EA, au as wA, av as DA, aw as RA, ax as zA, ay as PA, az as MA, aA as HA, aB as OA, aC as QA, aD as TA, aE as FA, aF as LA, aG as jA, aH as VA, aI as NA, aJ as WA, aK as ZA, aL as $A, aM as GA, aN as YA, aO as KA, aP as JA, aQ as XA, aR as qA, aS as _A, aT as UA, aU as et, aV as ot, aW as rt, aX as At, aY as uo, aZ as tt, a_ as nt, a$ as at, b0 as lt, b1 as Ie, b2 as oo, b3 as it, b4 as Ke, b5 as st, b6 as ct, b7 as dt, b8 as Ne, b9 as mo, ba as ut, bb as mt, bc as ht, bd as se, be as pt, bf as To, bg as vt, bh as gt, bi as Ct, bj as ft, bk as bt, bl as ro, bm as Fo, bn as xt, bo as It, bp as ho, bq as St, br as Bt, bs as yt, bt as Ee, bu as kt, bv as Et, bw as wt, bx as Dt, by as Rt } from "./SelectorDrawer.vue_vue_type_script_setup_true_lang-p26tZzOo.js";
import { z as zt } from "./index-Bdt8aUFf.js";
import { getSystemLocale as po } from "./index-D1-kdmz_.js";
...
const Cn = L({ name: "LoadingBar", props: { containerClass: String, containerStyle: [String, Object] }, setup() {
 ...
 `)])]), Sn = { info: () => g(kA, null), success: () => g(yA, null), warning: () => g(BA, null), error: () => g(SA, null), default: () => null }, Bn = L({ name: "Message", props: Object.assign(Object.assign({}, _o), { render: Function }), setup(e) {
  const { inlineThemeDisabled: o, mergedRtlRef: r } = Be(e), { props: A, mergedClsPrefixRef: t } = ee(Ho), l = bA("Message", r, t), a = fe("Message", "-message", In, xA, A, t), c = S(() => {
...
const ar = Object.assign(Object.assign({}, lo), { rawNodes: { type: Array, default: () => [] }, tmNodes: { type: Array, default: () => [] }, tmNode: { type: Object, required: true }, disabled: Boolean, icon: Function, onClick: Function, domId: String, virtualChildActive: { type: Boolean, default: void 0 }, isEllipsisPlaceholder: Boolean }), wa = oo(ar), Xe = L({ name: "Submenu", props: ar, setup(e) {
  ...
  const x = ut(e, ["expandedNames", "expandedKeys"]), k = mo(x, h), z = S(() => a.value.treeNodes), O = S(() => a.value.getPath(m.value).keyPath);
  ...
  return (s, i) => (re(), ve(Ce, null, [t.value ? (re(), ve("div", { key: 0, class: "title-bar", onClick: i[0] || (i[0] = (m) => l.value = true) }, [j(F(gt), null, { default: J(() => [j(F(Ct), { depth: 3, style: { display: "block", padding: "4px 8px", "min-width": "48px" } }, { default: J(() => [gr(Cr(t.value), 1)]), _: 1 })]), _: 1 })])) : vr("", true), j(ft, { active: l.value, "onUpdate:active": i[1] || (i[1] = (m) => l.value = m), list: a.value, "active-id": F(A).currentSketchId || "", onSelect: c, onRemove: n }, null, 8, ["active", "list", "active-id"])], 64));
  ...
  return (x, k) => (re(), ve("div", { class: So(["app-layout", f.value ? "app-layout-horizontal" : "app-layout-vertical"]) }, [f.value ? (re(), ve("div", Fa, [j(F(We), { options: n, "default-value": "tracker", value: i.value, mode: f.value ? "vertical" : "horizontal" }, null, 8, ["value", "mode"]), ae("div", La, [ae("div", ja, [j(F(We), { options: s, mode: f.value ? "vertical" : "horizontal", value: i.value }, null, 8, ["mode", "value"])]), ae("div", Va, [j(fo)])])])) : (re(), ve("div", Na, [j(F(St), { trigger: F(A).isMobile ? "click" : "hover", style: { padding: "2px 0", transform: "translateX(2px)" }, placement: "bottom-start" }, { trigger: J(() => [j(F(It), { style: { width: "48px" } }, { icon: J(() => [j(F(ho), null, { default: J(() => [j(F(Mt))]), _: 1 })]), _: 1 })]), default: J(() => [j(F(We), { options: n.concat(s), "default-value": "tracker", value: i.value, "dropdown-placement": "top-start", mode: "vertical" }, null, 8, ["options", "value"])]), _: 1 }, 8, ["trigger"]), ae("div", Wa, [j(fo)])])), ae("div", Za, [j(F(Bt), null, { default: J(({ Component: z }) => [j(Bo, { name: "slide-fade", mode: "out-in" }, { default: J(() => [(re(), Ye(fr, null, [(re(), Ye(br(z), { key: i.value }))], 1024))]), _: 2 }, 1024)]), _: 1 })])], 2));
...
const _a = xr(qa), Al = L({ __name: "App", setup(e) {
  const o = ro(), r = window.GeolocationManager, A = Tt(), t = S(() => o.settings.nightMode ? "dark" : o.settings.theme === "system" ? A.value : o.settings.theme), l = S(() => t.value === "dark" ? Oa : Dt), a = { common: { fontFamily: 'Barlow, "Maple Mono", -apple-system, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"', fontFamilyMono: '"Maple Mono", "SF Mono", Monaco, "Cascadia Code", "Roboto Mono", Consolas, "Courier New", monospace' } };
  return N("applicationDarkThemeEnabled", t), N("platformInfo", new Fo()), N("settings", o), N("noSleep", new _a()), N("geolocation", r), Ka(), _e(() => o.init()), (c, n) => (re(), Ye(F(Rt), { theme: l.value, abstract: true, "inline-theme-disabled": true, "theme-overrides": a }, { default: J(() => [j(F(hn), null, { default: J(() => [j(F(zn), null, { default: J(() => [j(F(bn), null, { default: J(() => [j(F(wn), { placement: "bottom-right" }, { default: J(() => [j(Ga), j(F(pa))]), _: 1 })]), _: 1 })]), _: 1 })]), _: 1 })]), _: 1 }, 8, ["theme"]));
} });
export {
  Al as default
};
