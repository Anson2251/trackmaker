import { A as e, D as t, M as n, O as r, S as i, at as a, ct as o, dt as s, f as c, ft as l, g as u, h as d, ht as f, k as p, l as m, lt as h, nt as g, ot as _, pt as v, s as y, u as b, v as x, w as S } from "./Card-CWMqfBGT.js";
import { E as C, S as ee, _ as w, a as te, b as ne, c as T, d as re, g as ie, i as ae, l as oe, o as se, r as ce, s as le, t as ue, u as de, v as fe, w as pe, x as me, y as he } from "./SelectorDrawer-DE8Fw0ad.js";
import { I as ge, J as _e, K as ve, Q as ye, S as be, _ as xe, c as Se, nt as Ce, r as we, tt as Te } from "./light-ByoFy5cz.js";
import { i as Ee, n as De, r as Oe, t as ke } from "./Image-DiZcehic.js";
import { $ as Ae, At as je, Bt as E, Dt as Me, Ft as Ne, It as Pe, J as Fe, Mt as Ie, Ot as Le, Pt as Re, Q as ze, Qt as D, Rt as O, St as Be, U as Ve, Vt as He, X as Ue, Yt as k, Z as We, Zt as Ge, _ as Ke, a as qe, bt as Je, ct as A, dt as Ye, ft as j, g as Xe, gt as M, in as N, jt as Ze, kt as P, l as Qe, lt as F, mt as I, nn as L, o as $e, ot as R, pt as z, rn as B, rt as et, st as V, t as H, tn as U, tt, ut as W, vt as nt, x as rt, zt as it } from "./index-C57mZnh3.js";
import { H as at, n as ot, t as st, y as ct } from "./sketch-store-DSDq88LI.js";
import { n as lt } from "./vue-i18n-Bm-kk62j.js";
import { I as ut, M as dt, h as ft, s as pt, t as mt, y as ht, z as gt } from "./light-Co9qcx_O.js";
import { C as _t, D as vt, T as yt, i as bt, l as xt, n as St, r as Ct, w as wt } from "./core-DZnL_1Th.js";
import { i as Tt, n as Et, r as Dt, t as Ot } from "./Warning-CRcobcpO.js";
import { t as kt } from "./fade-in-height-expand.cssr-l0OyU0OR.js";
import { n as At, t as jt } from "./platform-DF4B6bNi.js";
import { r as G } from "./light-D1X0x42x.js";
import { t as Mt } from "./Space-DZu9_qcN.js";
import { t as Nt } from "./use-theme-vars-DLk79qG5.js";
...
I({ name: `CheckboxGroup`, props: { min: Number, max: Number, size: String, value: Array, defaultValue: { type: Array, default: null }, disabled: { type: Boolean, default: void 0 }, "onUpdate:value": [Function, Array], onUpdateValue: [Function, Array], onChange: [Function, Array] }, setup(e2) {
  let { mergedClsPrefixRef: n2 } = x(e2), r2 = vt(e2), { mergedSizeRef: i2, mergedDisabledRef: a2 } = r2, o2 = k(e2.defaultValue), s2 = _e(R(() => e2.value), o2), c2 = R(() => {
    var _a2;
  ...
  return je(dn, { checkedCountRef: c2, maxRef: D(e2, `max`), minRef: D(e2, `min`), valueSetRef: l2, disabledRef: a2, mergedSizeRef: i2, toggleCheckbox: u2 }), { mergedClsPrefix: n2 };
}, render() {
  return M(`div`, { class: `${this.mergedClsPrefix}-checkbox-group`, role: `group` }, this.$slots);
} });
var fn = () => M(`svg`, { viewBox: `0 0 64 64`, class: `check-icon` }, M(`path`, { d: `M50.42,16.76L22.34,39.45l-8.1-11.46c-1.12-1.58-3.3-1.96-4.88-0.84c-1.58,1.12-1.95,3.3-0.84,4.88l10.26,14.51  c0.56,0.79,1.42,1.31,2.38,1.45c0.16,0.02,0.32,0.03,0.48,0.03c0.8,0,1.57-0.27,2.2-0.78l30.99-25.03c1.5-1.21,1.74-3.42,0.52-4.92  C54.13,15.78,51.93,15.55,50.42,16.76z` })), pn = () => M(`svg`, { viewBox: `0 0 100 100`, class: `line-icon` }, M(`path`, { d: `M80.2,55.5H21.4c-2.8,0-5.1-2.5-5.1-5.5l0,0c0-3,2.3-5.5,5.1-5.5h58.7c2.8,0,5.1,2.5,5.1,5.5l0,0C85.2,53.1,82.9,55.5,80.2,55.5z` })), mn = a([_(`checkbox`, `
 ...
 `))]), hn = I({ name: `Checkbox`, props: Object.assign(Object.assign({}, c.props), { size: String, checked: { type: [Boolean, String, Number], default: void 0 }, defaultChecked: { type: [Boolean, String, Number], default: false }, value: [String, Number], disabled: { type: Boolean, default: void 0 }, indeterminate: Boolean, label: String, focusable: { type: Boolean, default: true }, checkedValue: { type: [Boolean, String, Number], default: true }, uncheckedValue: { type: [Boolean, String, Number], default: false }, "onUpdate:checked": [Function, Array], onUpdateChecked: [Function, Array], privateInsideTable: Boolean, onChange: [Function, Array] }), setup(e2) {
  let n2 = nt(dn, null), r2 = k(null), { mergedClsPrefixRef: i2, inlineThemeDisabled: a2, mergedRtlRef: o2 } = x(e2), l2 = k(e2.defaultChecked), f2 = _e(D(e2, `checked`), l2), p2 = ye(() => {
    if (n2) {
  ...
  } }), { mergedDisabledRef: h2, mergedSizeRef: g2 } = m2, _2 = c(`Checkbox`, `-checkbox`, mn, gt, e2, i2);
  function v2(r3) {
  ...
  return Object.assign(m2, C2, { rtlEnabled: ee2, selfRef: r2, mergedClsPrefix: i2, mergedDisabled: h2, renderedChecked: p2, mergedTheme: _2, labelId: Ce(), handleClick: y2, handleKeyUp: b2, handleKeyDown: S2, cssVars: a2 ? void 0 : w2, themeClass: te2 == null ? void 0 : te2.themeClass, onRender: te2 == null ? void 0 : te2.onRender });
}, render() {
  var e2;
  ...
  } }, M(`div`, { class: `${l2}-checkbox-box-wrapper` }, `\xA0`, M(`div`, { class: `${l2}-checkbox-box` }, M(yt, null, { default: () => this.indeterminate ? M(`div`, { key: `indeterminate`, class: `${l2}-checkbox-icon` }, pn()) : M(`div`, { key: `check`, class: `${l2}-checkbox-icon` }, fn()) }), M(`div`, { class: `${l2}-checkbox-box__border` }))), m2);
} }), gn = { success: M(Et, null), error: M(Tt, null), warning: M(Ot, null), info: M(Dt, null) }, _n = I({ name: `ProgressCircle`, props: { clsPrefix: { type: String, required: true }, status: { type: String, required: true }, strokeWidth: { type: Number, required: true }, fillColor: [String, Object], railColor: String, railStyle: [String, Object], percentage: { type: Number, default: 0 }, offsetDegree: { type: Number, default: 0 }, showIndicator: { type: Boolean, required: true }, indicatorTextColor: String, unit: String, viewBoxWidth: { type: Number, required: true }, gapDegree: { type: Number, required: true }, gapOffsetDegree: { type: Number, default: 0 } }, setup(e2, { slots: t2 }) {
  let n2 = R(() => {
  ...
  }), i2 = R(() => e2.railBorderRadius === void 0 ? e2.height === void 0 ? `` : be(e2.height, { c: 0.5 }) : be(e2.railBorderRadius)), a2 = R(() => e2.fillBorderRadius === void 0 ? e2.railBorderRadius === void 0 ? e2.height === void 0 ? `` : be(e2.height, { c: 0.5 }) : be(e2.railBorderRadius) : be(e2.fillBorderRadius));
  return () => {
...
var xn = I({ name: `ProgressMultipleCircle`, props: { clsPrefix: { type: String, required: true }, viewBoxWidth: { type: Number, required: true }, percentage: { type: Array, default: [0] }, strokeWidth: { type: Number, required: true }, circleGap: { type: Number, required: true }, showIndicator: { type: Boolean, required: true }, fillColor: { type: Array, default: () => [] }, railColor: { type: Array, default: () => [] }, railStyle: { type: Array, default: () => [] } }, setup(e2, { slots: t2 }) {
  ...
  return () => {
    ...
    return M(`div`, { class: `${f2}-progress-content`, role: `none` }, M(`div`, { class: `${f2}-progress-graph`, "aria-hidden": true }, M(`div`, { class: `${f2}-progress-graph-circle` }, M(`svg`, { viewBox: `0 0 ${i2} ${i2}` }, M(`defs`, null, d2.map((e3, t3) => r2(e3, t3))), d2.map((e3, t3) => M(`g`, { key: t3 }, M(`path`, { class: `${f2}-progress-graph-circle-rail`, d: bn(i2 / 2 - a2 / 2 * (1 + 2 * t3) - o2 * t3, a2, i2), "stroke-width": a2, "stroke-linecap": `round`, fill: `none`, style: [{ strokeDashoffset: 0, stroke: l2[t3] }, u2[t3]] }), M(`path`, { class: [`${f2}-progress-graph-circle-fill`, e3 === 0 && `${f2}-progress-graph-circle-fill--empty`], d: bn(i2 / 2 - a2 / 2 * (1 + 2 * t3) - o2 * t3, a2, i2), "stroke-width": a2, "stroke-linecap": `round`, fill: `none`, style: { strokeDasharray: n2.value[t3], strokeDashoffset: 0, stroke: typeof c2[t3] == `object` ? `url(#gradient-${t3})` : c2[t3] } })))))), s2 && t2.default ? M(`div`, null, M(`div`, { class: `${f2}-progress-text` }, t2.default())) : null);
  };
} }), Sn = a([_(`progress`, { display: `inline-block` }, [_(`progress-icon`, `
 ...
 `)]), Cn = I({ name: `Progress`, props: Object.assign(Object.assign({}, c.props), { processing: Boolean, type: { type: String, default: `line` }, gapDegree: Number, gapOffsetDegree: Number, status: { type: String, default: `default` }, railColor: [String, Array], railStyle: [String, Array], color: [String, Array, Object], viewBoxWidth: { type: Number, default: 100 }, strokeWidth: { type: Number, default: 7 }, percentage: [Number, Array], unit: { type: String, default: `%` }, showIndicator: { type: Boolean, default: true }, indicatorPosition: { type: String, default: `outside` }, indicatorPlacement: { type: String, default: `outside` }, indicatorTextColor: String, circleGap: { type: Number, default: 1 }, height: Number, borderRadius: [String, Number], fillBorderRadius: [String, Number], offsetDegree: Number }), setup(e2) {
  ...
  }), { mergedClsPrefixRef: r2, inlineThemeDisabled: i2 } = x(e2), a2 = c(`Progress`, `-progress`, Sn, ht, e2, r2), o2 = R(() => {
  ...
  return C2 == null ? void 0 : C2(), M(`div`, { class: [x2, `${v2}-progress`, `${v2}-progress--${e2}`, `${v2}-progress--${i2}`], style: t2, "aria-valuemax": 100, "aria-valuemin": 0, "aria-valuenow": c2, role: e2 === `circle` || e2 === `line` || e2 === `dashboard` ? `progressbar` : `none` }, e2 === `circle` || e2 === `dashboard` ? M(_n, { clsPrefix: v2, status: i2, showIndicator: r2, indicatorTextColor: n2, railColor: a2, fillColor: s2, railStyle: o2, offsetDegree: this.offsetDegree, percentage: c2, viewBoxWidth: l2, strokeWidth: u2, gapDegree: y2 === void 0 ? e2 === `dashboard` ? 75 : 0 : y2, gapOffsetDegree: b2, unit: f2 }, S2) : e2 === `line` ? M(yn, { clsPrefix: v2, status: i2, showIndicator: r2, indicatorTextColor: n2, railColor: a2, fillColor: s2, railStyle: o2, percentage: c2, processing: g2, indicatorPlacement: d2, unit: f2, fillBorderRadius: m2, railBorderRadius: p2, height: h2 }, S2) : e2 === `multiple-circle` ? M(xn, { clsPrefix: v2, strokeWidth: u2, railColor: a2, fillColor: s2, railStyle: o2, viewBoxWidth: l2, percentage: c2, showIndicator: r2, circleGap: _2 }, S2) : null);
} }), wn = a([a(`@keyframes spin-rotate`, `
 from {
 transform: rotate(0);
 }
 to {
 ...
 `)])]), Tn = { small: 20, medium: 18, large: 16 }, En = I({ name: `Spin`, props: Object.assign(Object.assign({}, c.props), { contentClass: String, contentStyle: [Object, String], description: String, stroke: String, size: { type: [String, Number], default: `medium` }, show: { type: Boolean, default: true }, strokeWidth: Number, rotate: { type: Boolean, default: true }, spinning: { type: Boolean, validator: () => true, default: void 0 }, delay: Number }), slots: Object, setup(e2) {
  ...
  }), i2, e2) : void 0, o2 = ve(e2, [`spinning`, `show`]), l2 = k(false);
  return it((t3) => {
    let n3;
    if (o2.value) {
      let { delay: r3 } = e2;
    ...
    let { size: n3 } = e2;
    return Tn[typeof n3 == `number` ? `medium` : n3];
  }), cssVars: n2 ? void 0 : i2, themeClass: a2 == null ? void 0 : a2.themeClass, onRender: a2 == null ? void 0 : a2.onRender };
}, render() {
  var _a2;
  var e2;
  let { $slots: t2, mergedClsPrefix: n2, description: r2 } = this, i2 = t2.icon && this.rotate, a2 = (r2 || t2.description) && M(`div`, { class: `${n2}-spin-description` }, r2 || ((_a2 = t2.description) == null ? void 0 : _a2.call(t2))), o2 = t2.icon ? M(`div`, { class: [`${n2}-spin-body`, this.themeClass] }, M(`div`, { class: [`${n2}-spin`, i2 && `${n2}-spin--rotate`], style: t2.default ? `` : this.cssVars }, t2.icon()), a2) : M(`div`, { class: [`${n2}-spin-body`, this.themeClass] }, M(_t, { clsPrefix: n2, style: t2.default ? `` : this.cssVars, stroke: this.stroke, "stroke-width": this.mergedStrokeWidth, class: `${n2}-spin` }), a2);
  return (e2 = this.onRender) == null || e2.call(this), t2.default ? M(`div`, { class: [`${n2}-spin-container`, this.themeClass], style: this.cssVars }, M(`div`, { class: [`${n2}-spin-content`, this.active && `${n2}-spin-content--spinning`, this.contentClass], style: this.contentStyle }, t2), M(Fe, { name: `fade-in-transition` }, { default: () => this.active ? o2 : null })) : o2;
} });
const Dn = n(`n-upload`);
var On = a([_(`upload`, `width: 100%;`, [h(`dragger-inside`, [_(`upload-trigger`, `
 display: block;
 ...
 height: 0;
 opacity: 0;
 `)]), kn = I({ name: `UploadDragger`, __UPLOAD_DRAGGER__: true, setup(e2, { slots: t2 }) {
  let n2 = nt(Dn, null);
...
var Mn = I({ name: `UploadProgress`, props: { show: Boolean, percentage: { type: Number, required: true }, status: { type: String, required: true } }, setup() {
  return { mergedTheme: nt(Dn).mergedThemeRef };
}, render() {
  return M(y, null, { default: () => this.show ? M(Cn, { type: `line`, showIndicator: false, percentage: this.percentage, status: this.status, height: 2, theme: this.mergedTheme.peers.Progress, themeOverrides: this.mergedTheme.peerOverrides.Progress }) : null });
} }), Nn = function(e2, t2, n2, r2) {
  function i2(e3) {
...
var In = /(webp|svg|png|gif|jpg|jpeg|jfif|bmp|dpg|ico)$/i;
const Ln = (e2) => {
  if (e2.type) return Pn(e2.type);
  let t2 = Fn(e2.name || ``);
  if (In.test(t2)) return true;
  let n2 = e2.thumbnailUrl || e2.url || ``, r2 = Fn(n2);
  return !!(/^data:image\//.test(n2) || In.test(r2));
};
function Rn(e2) {
  return Nn(this, void 0, void 0, function* () {
    return yield new Promise((t2) => {
      if (!e2.type || !Pn(e2.type)) {
        t2(``);
        return;
      }
...
const zn = ge && window.FileReader && window.File;
function Bn(e2) {
...
var Gn = function(e2, t2, n2, r2) {
...
}, Kn = { paddingMedium: `0 3px`, heightMedium: `24px`, iconSizeMedium: `18px` }, qn = I({ name: `UploadFile`, props: { clsPrefix: { type: String, required: true }, file: { type: Object, required: true }, listType: { type: String, required: true }, index: { type: Number, required: true } }, setup(t2) {
  let n2 = nt(Dn), r2 = k(null), i2 = k(``), a2 = R(() => {
    let { file: e2 } = t2;
  ...
  }), f2 = ye(() => i2.value || t2.file.thumbnailUrl || t2.file.url), p2 = R(() => {
  ...
  let x2 = () => Gn(this, void 0, void 0, function* () {
    let { listType: e2 } = t2;
  ...
  a2 = o2 || n2 === `image-card` ? !this.shouldUseThumbnailUrl(r2) || !this.mergedThumbnailUrl ? M(`span`, { class: `${e2}-upload-file-info__thumbnail` }, i2 ? i2(r2) : Ln(r2) ? M(b, { clsPrefix: e2 }, { default: An }) : M(b, { clsPrefix: e2 }, { default: jn })) : M(`a`, { rel: `noopener noreferer`, target: `_blank`, href: r2.url || void 0, class: `${e2}-upload-file-info__thumbnail`, onClick: this.handlePreviewClick }, n2 === `image-card` ? M(ke, { src: this.mergedThumbnailUrl || void 0, previewSrc: r2.url || void 0, alt: r2.name, ref: `imageRef` }) : M(`img`, { src: this.mergedThumbnailUrl || void 0, alt: r2.name })) : M(`span`, { class: `${e2}-upload-file-info__thumbnail` }, i2 ? i2(r2) : M(b, { clsPrefix: e2 }, { default: () => M(sn, null) }));
  let s2 = M(Mn, { show: this.showProgress, percentage: r2.percentage || 0, status: this.progressStatus }), c2 = n2 === `text` || n2 === `image`;
  return M(`div`, { class: [`${e2}-upload-file`, `${e2}-upload-file--${this.progressStatus}-status`, r2.url && r2.status !== `error` && n2 !== `image-card` && `${e2}-upload-file--with-url`, `${e2}-upload-file--${n2}-type`] }, M(`div`, { class: `${e2}-upload-file-info` }, a2, M(`div`, { class: `${e2}-upload-file-info__name` }, c2 && (r2.url && r2.status !== `error` ? M(`a`, { rel: `noopener noreferer`, target: `_blank`, href: r2.url || void 0, onClick: this.handlePreviewClick }, r2.name) : M(`span`, { onClick: this.handlePreviewClick }, r2.name)), o2 && s2), M(`div`, { class: [`${e2}-upload-file-info__action`, `${e2}-upload-file-info__action--${n2}-type`] }, this.showPreviewButton ? M(xt, { key: `preview`, quaternary: true, type: this.buttonType, onClick: this.handlePreviewClick, theme: t2.peers.Button, themeOverrides: t2.peerOverrides.Button, builtinThemeOverrides: Kn }, { icon: () => M(b, { clsPrefix: e2 }, { default: () => M(he, null) }) }) : null, (this.showRemoveButton || this.showCancelButton) && !this.disabled && M(xt, { key: `cancelOrTrash`, theme: t2.peers.Button, themeOverrides: t2.peerOverrides.Button, quaternary: true, builtinThemeOverrides: Kn, type: this.buttonType, onClick: this.handleRemoveOrCancelClick }, { icon: () => M(yt, null, { default: () => this.showRemoveButton ? M(b, { clsPrefix: e2, key: `trash` }, { default: () => M(un, null) }) : M(b, { clsPrefix: e2, key: `cancel` }, { default: () => M(cn, null) }) }) }), this.showRetryButton && !this.disabled && M(xt, { key: `retry`, quaternary: true, type: this.buttonType, onClick: this.handleRetryClick, theme: t2.peers.Button, themeOverrides: t2.peerOverrides.Button, builtinThemeOverrides: Kn }, { icon: () => M(b, { clsPrefix: e2 }, { default: () => M(ln, null) }) }), this.showDownloadButton ? M(xt, { key: `download`, quaternary: true, type: this.buttonType, onClick: this.handleDownloadClick, theme: t2.peers.Button, themeOverrides: t2.peerOverrides.Button, builtinThemeOverrides: Kn }, { icon: () => M(b, { clsPrefix: e2 }, { default: () => M(Oe, null) }) }) : null)), !o2 && s2);
} }), Jn = I({ name: `UploadTrigger`, props: { abstract: Boolean }, slots: Object, setup(e2, { slots: t2 }) {
  let n2 = nt(Dn, null);
  ...
  function S2(e3) {
    ...
    (t3 == null ? void 0 : t3.length) ? Hn(Array.from(t3).map((e4) => e4.webkitGetAsEntry()), f2.value).then((e4) => {
      d2(e4);
    }).finally(() => {
      c2.value = false;
    }) : c2.value = false;
  ...
  return () => {
    var _a2;
    let { value: n3 } = r2;
    return e2.abstract ? (_a2 = t2.default) == null ? void 0 : _a2.call(t2, { handleClick: _2, handleDrop: S2, handleDragOver: v2, handleDragEnter: y2, handleDragLeave: x2 }) : M(`div`, { class: [`${n3}-upload-trigger`, (a2.value || o2.value) && `${n3}-upload-trigger--disabled`, g2.value && `${n3}-upload-trigger--image-card`, m2.value], style: h2.value, onClick: _2, onDrop: S2, onDragover: v2, onDragenter: y2, onDragleave: x2 }, g2.value ? M(kn, null, { default: () => i(t2.default, () => [M(b, { clsPrefix: n3 }, { default: () => M(ne, null) })]) }) : t2);
  };
} }), Yn = I({ name: `UploadFileList`, setup(e2, { slots: t2 }) {
  let n2 = nt(Dn, null);
  n2 || p(`upload-file-list`, "`n-upload-file-list` must be placed inside `n-upload`.");
  let { abstractRef: r2, mergedClsPrefixRef: i2, listTypeRef: a2, mergedFileListRef: o2, fileListClassRef: s2, fileListStyleRef: c2, cssVarsRef: l2, themeClassRef: u2, maxReachedRef: d2, showTriggerRef: f2, imageGroupPropsRef: m2 } = n2, h2 = R(() => a2.value === `image-card`), g2 = () => o2.value.map((e3, t3) => M(qn, { clsPrefix: i2.value, key: e3.id, file: e3, index: t3, listType: a2.value })), _2 = () => h2.value ? M(De, Object.assign({}, m2.value), { default: g2 }) : M(y, { group: true }, { default: g2 });
  return () => {
    let { value: e3 } = i2, { value: n3 } = r2;
    return M(`div`, { class: [`${e3}-upload-file-list`, h2.value && `${e3}-upload-file-list--grid`, n3 ? u2 == null ? void 0 : u2.value : void 0, s2.value], style: [n3 && l2 ? l2.value : ``, c2.value] }, _2(), f2.value && !d2.value && h2.value && M(Jn, null, t2));
  };
...
function Zn(e2, t2, n2) {
  ...
  function o2(n3) {
    ...
    i2.delete(t2.id), o3 = Un(((_a2 = e2.onError) == null ? void 0 : _a2.call(e2, { file: o3, event: n3 })) || o3), r2(o3, n3);
  }
  function s2(s3) {
    var _a2;
    if (e2.isErrorState) {
    ...
    i2.delete(t2.id), c2 = Un(((_a2 = e2.onFinish) == null ? void 0 : _a2.call(e2, { file: c2, event: s3 })) || c2), r2(c2, s3);
  }
...
function Qn(e2) {
  ...
  s2({ file: n2, data: r2, headers: i2, withCredentials: a2, action: o2, onProgress(e3) {
    ...
    e3 = Un(((_a2 = t2.onFinish) == null ? void 0 : _a2.call(t2, { file: e3 })) || e3), c2(e3);
  }, onError() {
    var _a2;
    let e3 = Object.assign({}, n2, { status: `error`, percentage: l2 });
    e3 = Un(((_a2 = t2.onError) == null ? void 0 : _a2.call(t2, { file: e3 })) || e3), c2(e3);
  } });
}
function $n(e2, t2, n2) {
  let r2 = Zn(e2, t2, n2);
...
var ir = I({ name: `Upload`, props: Object.assign(Object.assign({}, c.props), { name: { type: String, default: `file` }, accept: String, action: String, customRequest: Function, directory: Boolean, directoryDnd: { type: Boolean, default: void 0 }, method: { type: String, default: `POST` }, multiple: Boolean, showFileList: { type: Boolean, default: true }, data: [Object, Function], headers: [Object, Function], withCredentials: Boolean, responseType: { type: String, default: `` }, disabled: { type: Boolean, default: void 0 }, onChange: Function, onRemove: Function, onFinish: Function, onError: Function, onRetry: Function, onBeforeUpload: Function, isErrorState: Function, onDownload: Function, customDownload: Function, defaultUpload: { type: Boolean, default: true }, fileList: Array, "onUpdate:fileList": [Function, Array], onUpdateFileList: [Function, Array], fileListClass: String, fileListStyle: [String, Object], defaultFileList: { type: Array, default: () => [] }, showCancelButton: { type: Boolean, default: true }, showRemoveButton: { type: Boolean, default: true }, showDownloadButton: Boolean, showRetryButton: { type: Boolean, default: true }, showPreviewButton: { type: Boolean, default: true }, listType: { type: String, default: `text` }, onPreview: Function, shouldUseThumbnailUrl: { type: Function, default: (e2) => zn ? Ln(e2) : false }, createThumbnailUrl: Function, abstract: Boolean, max: Number, showTrigger: { type: Boolean, default: true }, imageGroupProps: Object, inputProps: Object, triggerClass: String, triggerStyle: [String, Object], renderIcon: Function }), setup(e2) {
  ...
  function ne2(t2, n3) {
    ...
    t2 = t2.filter(({ file: e3, source: t3 }) => t3 === `dnd` && (a3 == null ? void 0 : a3.trim()) ? Wn(e3.name, e3.type, a3) : true), i3 && (t2 = t2.slice(0, i3 - y2.value.length));
    let o3 = Ce();
    Promise.all(t2.map((e3) => Xn(this, [e3], void 0, function* ({ file: e4, entry: t3 }) {
    ...
    }))).then((e3) => Xn(this, void 0, void 0, function* () {
  ...
  function T2(t2) {
    ...
    c2.forEach((t3) => {
      let { status: c3 } = t3;
      (c3 === `pending` || c3 === `error` && l3) && (e2.customRequest ? Qn({ inst: { doChange: te2, xhrMap: _2, onFinish: e2.onFinish, onError: e2.onError }, file: t3, action: r3, withCredentials: i3, headers: a3, data: o3, customRequest: e2.customRequest }) : rr({ doChange: te2, xhrMap: _2, onFinish: e2.onFinish, onError: e2.onError, isErrorState: e2.isErrorState }, s3, t3, { method: n3, action: r3, withCredentials: i3, responseType: e2.responseType, headers: a3, data: o3 }));
    });
  }
  function re2(t2) {
    if (t2.thumbnailUrl) return t2.thumbnailUrl;
    let { createThumbnailUrl: n3 } = e2;
    return n3 ? n3(t2.file, t2) ?? (t2.url || ``) : t2.url ? t2.url : t2.file ? Rn(t2.file) : ``;
  }
  let ie2 = R(() => {
  ...
  je(Dn, { mergedClsPrefixRef: n2, mergedThemeRef: a2, showCancelButtonRef: D(e2, `showCancelButton`), showDownloadButtonRef: D(e2, `showDownloadButton`), showRemoveButtonRef: D(e2, `showRemoveButton`), showRetryButtonRef: D(e2, `showRetryButton`), onRemoveRef: D(e2, `onRemove`), onDownloadRef: D(e2, `onDownload`), customDownloadRef: D(e2, `customDownload`), mergedFileListRef: y2, triggerClassRef: D(e2, `triggerClass`), triggerStyleRef: D(e2, `triggerStyle`), shouldUseThumbnailUrlRef: D(e2, `shouldUseThumbnailUrl`), renderIconRef: D(e2, `renderIcon`), xhrMap: _2, submit: T2, doChange: te2, showPreviewButtonRef: D(e2, `showPreviewButton`), onPreviewRef: D(e2, `onPreview`), getFileThumbnailUrlResolver: re2, listTypeRef: D(e2, `listType`), dragOverRef: g2, openOpenFileDialog: S2, draggerInsideRef: h2, handleFileAddition: ne2, mergedDisabledRef: s2.mergedDisabledRef, maxReachedRef: b2, fileListClassRef: D(e2, `fileListClass`), fileListStyleRef: D(e2, `fileListStyle`), abstractRef: D(e2, `abstract`), acceptRef: D(e2, `accept`), cssVarsRef: r2 ? void 0 : ie2, themeClassRef: ae2 == null ? void 0 : ae2.themeClass, onRender: ae2 == null ? void 0 : ae2.onRender, showTriggerRef: D(e2, `showTrigger`), imageGroupPropsRef: D(e2, `imageGroupProps`), mergedDirectoryDndRef: R(() => e2.directoryDnd ?? e2.directory), onRetryRef: D(e2, `onRetry`) });
  let oe2 = { clear: () => {
    l2.value = [];
  }, submit: T2, openOpenFileDialog: S2 };
  return Object.assign({ mergedClsPrefix: n2, draggerInsideRef: h2, rtlEnabled: o2, inputElRef: m2, mergedTheme: a2, dragOver: g2, mergedMultiple: w2, cssVars: r2 ? void 0 : ie2, themeClass: ae2 == null ? void 0 : ae2.themeClass, onRender: ae2 == null ? void 0 : ae2.onRender, handleFileInputChange: C2 }, oe2);
}, render() {
  var _a2, _b, _c;
  ...
  return this.abstract ? M(tt, null, (_c = n2.default) == null ? void 0 : _c.call(n2), M(et, { to: `body` }, a2)) : (i2 == null ? void 0 : i2(), M(`div`, { class: [`${t2}-upload`, this.rtlEnabled && `${t2}-upload--rtl`, e2.value && `${t2}-upload--dragger-inside`, this.dragOver && `${t2}-upload--drag-over`, this.themeClass], style: this.cssVars }, a2, this.showTrigger && this.listType !== `image-card` && M(Jn, null, n2), this.showFileList && M(Yn, null, n2)));
} });
function ar(e2 = {}) {
  let { autoStart: t2 = false } = e2, n2 = k(0), r2 = k(false), i2 = k(false), a2 = k(null), o2 = null, s2 = (e3) => e3.webkitCompassHeading === void 0 ? e3.alpha === null ? 0 : (360 - e3.alpha) % 360 : e3.webkitCompassHeading, c2 = (e3) => {
    try {
...
var or = 0.3, sr = H(I({ __name: `MapCompass`, props: Je({ pitch: {}, size: {}, tracking: { type: Boolean } }, { bearing: { default: 0 }, bearingModifiers: {} }), emits: Je([`toggleTracking`], [`update:bearing`]), setup(e2, { emit: t2 }) {
  Ue((e3) => ({ v77b18c8c: U(n2).primaryColor, v2f184cfe: U(n2).modalColor, v21daa1a8: U(n2).borderColor, v3fc1f57c: U(n2).textColorBase }));
  let n2 = Nt(), r2 = e2, i2 = Ne(e2, `bearing`), a2 = t2, { bearing: o2, isTracking: s2, isSupported: c2, error: l2, toggleTracking: u2 } = ar();
  O(o2, (e3) => {
  ...
  return Me(() => {
    ...
    e3.onclick = () => {
      ...
      e4.preventDefault();
      let t3 = (i2.value + e4.deltaY * or) % 360;
      i2.value = Math.round(t3 >= 0 ? t3 : 360 + t3);
    });
  }), (e3, t3) => (P(), W(`div`, { style: B(p2.value) }, [V(`div`, { class: L([`map-compass`, { "tracking-active": r2.tracking }]), style: B(w2.value) }, [V(`div`, { class: `compass-panel`, style: B(f2.value) }, [V(`div`, { class: `pin north-pin`, style: B(b2.value) }, null, 4), V(`div`, { class: `pin east-pin`, style: B(x2.value) }, null, 4), V(`div`, { class: `pin south-pin`, style: B(S2.value) }, null, 4), V(`div`, { class: `pin west-pin`, style: B(C2.value) }, null, 4)], 4), V(`span`, { class: `compass-orientation-text`, style: B(ee2.value) }, N(ne2.value), 5)], 6)], 4));
} }), [[`__scopeId`, `data-v-7d13d21d`]]);
const cr = qe(`routes`, () => {
  let e2 = st(), t2 = R(() => e2.routeCollection), n2 = R({ get: (() => e2.currentRouteId), set: ((t3) => e2.setCurrentRouteId(t3)) }), r2 = k(0);
  O(n2, (t3) => {
    var _a2, _b;
    t3 !== null && (r2.value = ((_b = (_a2 = e2.getRouteById(t3)) == null ? void 0 : _a2.meta) == null ? void 0 : _b.record_timespan) ?? 0);
  });
  let i2 = k(false), a2 = k(-1), o2 = k(null), s2, c2 = R(() => e2.routes);
  function l2(e3) {
    o2.value = e3;
  }
  async function u2() {
...
var lr = { class: `upload-container` }, ur = { class: `action-buttons` }, dr = H(I({ __name: `TextFileUploaderDialog`, props: Je({ multiple: { type: Boolean }, icon: {}, prompt: {}, types: {} }, { show: { default: false, type: Boolean }, showModifiers: {} }), emits: Je([`update:value`, `confirm`], [`update:show`]), setup(e2, { emit: t2 }) {
  let n2 = ie(), r2 = e2, i2 = t2, a2 = Ne(e2, `show`), o2 = [], s2 = (e3) => {
    o2 = [];
    for (let t3 of e3) {
      let a3 = t3.file;
  ...
  return (e3, t3) => (P(), A(U(ct), { show: a2.value, "onUpdate:show": t3[2] || (t3[2] = (e4) => a2.value = e4), preset: `dialog`, title: `Dialog` }, { header: E(() => [...t3[3] || (t3[3] = [j(` File Upload `, -1)])]), default: E(() => [V(`div`, lr, [z(U(ir), { multiple: r2.multiple ?? false, onChange: t3[0] || (t3[0] = ({ fileList: e4 }) => s2(e4)), onBeforeUpload: l2 }, { default: E(() => [z(U(kn), null, { default: E(() => [z(U(G), { size: 36, name: `upload`, class: `upload-icon` }, { default: E(() => [(P(), A(Re(r2.icon ?? U(me))))]), _: 1 }), V(`div`, null, N(r2.prompt ?? `Drag and drop a file here or click to upload`), 1)]), _: 1 })]), _: 1 }, 8, [`multiple`])])]), action: E(() => [V(`div`, ur, [z(U(xt), { onClick: t3[1] || (t3[1] = (e4) => a2.value = false) }, { default: E(() => [...t3[4] || (t3[4] = [j(` Cancel `, -1)])]), _: 1 }), z(U(xt), { type: `primary`, onClick: c2 }, { default: E(() => [...t3[5] || (t3[5] = [j(` Upload `, -1)])]), _: 1 })])]), _: 1 }, 8, [`show`]));
} }), [[`__scopeId`, `data-v-14c5a0c1`]]), fr = { width: `24`, height: `24`, viewBox: `0 0 24 24`, fill: `none`, xmlns: `http://www.w3.org/2000/svg` }, pr = { key: 0, d: `M12 4V20M12 4L8 8M12 4L16 8`, stroke: `currentColor`, "stroke-width": `2`, "stroke-linecap": `round`, "stroke-linejoin": `round` }, mr = { key: 1, d: `M12 20V4M12 20L8 16M12 20L16 16`, stroke: `currentColor`, "stroke-width": `2`, "stroke-linecap": `round`, "stroke-linejoin": `round` }, hr = { key: 2, d: `M4 12H20M4 12L8 8M4 12L8 16`, stroke: `currentColor`, "stroke-width": `2`, "stroke-linecap": `round`, "stroke-linejoin": `round` }, gr = { key: 3, d: `M20 12H4M20 12L16 8M20 12L16 16`, stroke: `currentColor`, "stroke-width": `2`, "stroke-linecap": `round`, "stroke-linejoin": `round` }, _r = { style: { height: `100%`, width: `100%`, overflow: `auto` } }, vr = 80, yr = H(I({ __name: `MglDrawer`, props: Je({ position: {} }, { show: { type: Boolean, default: false }, showModifiers: {} }), emits: Je([`update:width`, `update:height`, `click`, `contextmenu`], [`update:show`]), setup(e2, { emit: t2 }) {
  Ue((e3) => ({ b10bfffe: U(i2).modalColor, v22296c69: U(i2).borderRadius, v27078208: U(i2).textColorBase, v4e659f18: m2.value, v16f05bba: p2.value }));
  let n2 = e2, r2 = t2, i2 = Nt(), a2 = Pe(`route-drawer`), o2 = R(() => n2.position || `left`), s2 = 0, c2 = 0, l2 = (e3) => {
    ...
    o2.value === `left` && r3 < -vr && (a3 = true), o2.value === `right` && r3 > vr && (a3 = true), o2.value === `top` && i3 < -vr && (a3 = true), o2.value === `bottom` && i3 > vr && (a3 = true), a3 && (h2.value = false), s2 = 0, c2 = 0;
  }, d2 = R(() => {
    var _a2, _b, _c, _d;
  ...
  }), p2 = R(() => o2.value === `left` ? `${-16 - d2.value}px` : o2.value === `right` ? `${16 + d2.value}px` : o2.value === `top` ? `${-16 - f2.value}px` : o2.value === `bottom` ? `${16 + f2.value}px` : `0px`), m2 = R(() => o2.value === `left` || o2.value === `right` ? `${d2.value}px` : `${f2.value}px`), h2 = Ne(e2, `show`);
  return O(d2, () => r2(`update:width`, d2.value)), O(f2, () => r2(`update:height`, f2.value)), (e3, t3) => (P(), A(Fe, { name: `slide-${o2.value}` }, { default: E(() => [He(V(`div`, { ref: `route-drawer`, class: L([`route-drawer`, `route-drawer--${o2.value}`]), onClick: t3[0] || (t3[0] = (e4) => r2(`click`, e4)), onContextmenu: t3[1] || (t3[1] = (e4) => r2(`contextmenu`, e4)), onTouchstart: l2, onTouchend: u2 }, [V(`div`, { class: L([`swipe-indicator`, `swipe-indicator--${o2.value}`]) }, [(P(), W(`svg`, fr, [o2.value === `top` ? (P(), W(`path`, pr)) : o2.value === `bottom` ? (P(), W(`path`, mr)) : o2.value === `left` ? (P(), W(`path`, hr)) : o2.value === `right` ? (P(), W(`path`, gr)) : F(``, true)]))], 2), V(`div`, _r, [Ie(e3.$slots, `default`, {}, void 0, true)])], 34), [[We, h2.value]])]), _: 3 }, 8, [`name`]));
} }), [[`__scopeId`, `data-v-ba41f527`]]), br = { class: `menu-list` }, xr = [`onClick`, `onContextmenu`, `onTouchstart`], Sr = { class: `swipe-container` }, Cr = { style: { height: `fit-content`, padding: `8px 12px` } }, wr = [`onClick`], Tr = { style: { padding: `16px` } }, Er = 120, Dr = 40, Or = H(I({ __name: `SelectableSwipeableMenuList`, props: Je({ items: {}, menuOptions: {}, swipeActions: {} }, { selection: { type: String, default: null }, selectionModifiers: {}, multipleSelection: { type: Array, default: () => [] }, multipleSelectionModifiers: {} }), emits: Je([`contextmenu`], [`update:selection`, `update:multipleSelection`]), setup(e2, { emit: t2 }) {
  Ue((e3) => ({ af602246: U(o2).hoverColor, v2c598f52: U(o2).primaryColor, f032366a: U(o2).bodyColor, v6ce963b2: s2.value }));
  let n2 = e2, r2 = Ne(e2, `selection`), i2 = Ne(e2, `multipleSelection`), a2 = t2, o2 = Nt(), s2 = k(`0s`), c2 = k({ startX: 0, delta: 0, currentX: 0, containerWidth: 0, activeId: null, leftMax: 0, rightMax: 0 }), l2 = k(false), u2 = k(0), d2 = k(0), f2 = k(null);
  function p2(e3, t3) {
    c2.value.activeId !== t3 && _2();
    let n3 = e3.touches[0];
    c2.value = { startX: n3.clientX, delta: c2.value.delta ?? 0, currentX: n3.clientX, containerWidth: e3.currentTarget.offsetWidth, activeId: t3, leftMax: Er < 0 ? c2.value.containerWidth : Er, rightMax: Dr < 0 ? c2.value.containerWidth : Dr };
  }
  function m2(e3) {
  ...
  return (e3, t3) => (P(), W(tt, null, [V(`div`, br, [(P(true), W(tt, null, Ze(n2.items, (t4) => (P(), W(`div`, { key: t4.id, class: L([`menu-list-item`, ...t4.id === r2.value ? [`active`] : []]), style: B({ "touch-action": c2.value.activeId === t4.id ? `pan-y` : `auto` }), onClick: (e4) => g2(e4, t4), onContextmenu: Ae((e4) => v2(e4, t4), [`prevent`]), onTouchstart: (e4) => p2(e4, t4.id), onTouchmove: m2, onTouchend: h2 }, [V(`div`, Sr, [V(`div`, { class: `content-col`, style: B({ transform: `translateX(${c2.value.activeId === t4.id || c2.value.delta > 0 ? c2.value.delta : 0}px)`, willChange: c2.value.activeId === t4.id ? `transform` : `auto`, flexDirection: c2.value.delta >= 0 || c2.value.activeId !== t4.id ? `row` : `row-reverse` }) }, [Ie(e3.$slots, `item`, { item: t4 }, () => [V(`div`, Cr, [V(`div`, null, N(t4.name ?? `Untitled`), 1)])], true)], 4), V(`div`, { class: `actions-col`, style: B({ width: `${c2.value.activeId === t4.id && c2.value.delta < 0 ? -c2.value.delta : 0}px`, visibility: c2.value.activeId === t4.id && c2.value.delta < 0 ? `visible` : `hidden`, willChange: c2.value.activeId === t4.id ? `width` : `auto` }) }, [(P(true), W(tt, null, Ze(n2.swipeActions, (e4) => (P(), W(`button`, { key: e4.name, class: `menu-action`, style: B({ background: e4.color || U(o2).primaryColorSuppl }), onClick: () => {
    e4.action(t4.id), c2.value.activeId = null;
  } }, N(e4.label), 13, wr))), 128))], 4), V(`div`, { class: `select-col`, style: B({ width: `${c2.value.delta > 0 ? c2.value.delta : 0}px`, backgroundColor: r2.value === t4.id ? U(o2).primaryColor : `transparent`, visibility: c2.value.delta > 0 ? `visible` : `hidden` }) }, [V(`div`, Tr, [z(U(hn), { checked: i2.value.includes(t4.id), style: B({ border: r2.value === t4.id ? `1px solid ${U(o2).bodyColor}` : `none`, BorderRadius: r2.value === t4.id ? U(o2).borderRadiusSmall : `none` }), "onUpdate:checked": () => y2(t4.id) }, null, 8, [`checked`, `style`, `onUpdate:checked`])])], 4)])], 46, xr))), 128))]), z(U(dt), { show: l2.value, x: u2.value, y: d2.value, options: n2.menuOptions.map((e4) => {
    var _a2;
...
} }), [[`__scopeId`, `data-v-b353d352`]]), kr = { class: `drawer-floating` }, Ar = { class: `drawer-container` }, jr = { class: `drawer-header` }, Mr = { class: `drawer-title` }, Nr = { style: { height: `fit-content`, padding: `8px 12px`, "text-align": `left` } }, Pr = { style: { "font-size": `0.8rem`, opacity: `0.7`, display: `flex`, "flex-direction": `row`, gap: `12px` } }, Fr = { key: 0 }, Ir = H(I({ __name: `TrackerViewRouteDrawer`, props: { show: { type: Boolean, default: false }, showModifiers: {} }, emits: Je([`update:width`], [`update:show`]), setup(e2, { emit: t2 }) {
  Ue((e3) => ({ v47589e0b: U(s2).borderRadius, v9a2db618: U(s2).hoverColor, v1460ff94: U(s2).primaryColorPressed, v9a1176a4: U(s2).primaryColor, v4a59e058: U(s2).bodyColor }));
  let n2 = new jt().isMobile, { t: r2 } = lt(), i2 = w(), a2 = t2, o2 = cr(), s2 = Nt(), c2 = Ne(e2, `show`), l2 = k(false), u2 = k(0), d2 = k(0), f2 = k(null), p2 = k(false), m2 = k(``), h2 = k(null), g2 = [{ label: R(() => r2(`components.trackerViewRouteDrawer.contextMenu.new`)), key: `new`, props: { onClick: () => {
  ...
  return (e3, t3) => (P(), W(tt, null, [z(yr, { show: c2.value, "onUpdate:show": t3[5] || (t3[5] = (e4) => c2.value = e4), position: U(n2) ? `bottom` : `left`, onClick: t3[6] || (t3[6] = () => U(o2).currentRouteId = null), "onUpdate:width": t3[7] || (t3[7] = (e4) => a2(`update:width`, e4)), onContextmenu: t3[8] || (t3[8] = (e4) => y2(e4)) }, { default: E(() => [V(`div`, kr, [U(n2) && c2.value ? Ie(e3.$slots, `bottom-floating`, { key: 0 }, void 0, true) : F(``, true)]), V(`div`, Ar, [V(`div`, jr, [V(`p`, Mr, N(U(r2)(`components.trackerViewRouteDrawer.routes`)), 1), x2.value.length > 0 ? (P(), A(U(xt), { key: 0, strong: ``, secondary: ``, circle: ``, type: `error`, onClick: S2 }, { icon: E(() => [z(U(G), { component: U(ee) }, null, 8, [`component`])]), _: 1 })) : F(``, true)]), V(`div`, { class: `drawer-content`, onTouchstart: t3[3] || (t3[3] = (e4) => e4.stopPropagation()), onTouchend: t3[4] || (t3[4] = (e4) => e4.stopPropagation()) }, [z(Or, { selection: U(o2).currentRouteId, "onUpdate:selection": t3[0] || (t3[0] = (e4) => U(o2).currentRouteId = e4), "multiple-selection": x2.value, "onUpdate:multipleSelection": t3[1] || (t3[1] = (e4) => x2.value = e4), items: U(o2).routes, "menu-options": _2, "swipe-actions": v2, onContextmenu: t3[2] || (t3[2] = (e4, t4) => {
    h2.value = (t4 == null ? void 0 : t4.id) ?? null, f2.value = t4 ?? null;
  }) }, { item: E(({ item: e4 }) => {
    var _a2;
    return [V(`div`, Nr, [V(`div`, null, N(e4.name ?? U(r2)(`components.trackerViewRouteDrawer.nameNewRoute`)), 1), V(`div`, Pr, [V(`div`, null, N(U(r2)(`components.trackerViewRouteDrawer.points`, { num: e4.points.length })), 1), e4.points.length > 1 && ((_a2 = e4.meta) == null ? void 0 : _a2.distance) ? (P(), W(`div`, Fr, N(U(r2)(`components.trackerViewRouteDrawer.distance`, { distance: U(Qe)(e4.meta.distance) })), 1)) : F(``, true)])])];
  }), _: 1 }, 8, [`selection`, `multiple-selection`, `items`])], 32)])]), _: 3 }, 8, [`show`, `position`]), z(U(dt), { show: l2.value, x: u2.value, y: d2.value, options: g2.map((e4) => ({ ...e4, label: e4.label.value })), placement: `bottom-start`, trigger: `manual`, onClickoutside: t3[9] || (t3[9] = (e4) => l2.value = false) }, null, 8, [`show`, `x`, `y`, `options`]), z(U(ct), { show: p2.value, "onUpdate:show": t3[12] || (t3[12] = (e4) => p2.value = e4), preset: `dialog`, title: `Rename Route`, "positive-text": `Save`, "negative-text": `Cancel`, onPositiveClick: t3[13] || (t3[13] = () => {
    h2.value && b2(h2.value);
  }) }, { default: E(() => [z(U(fe), { value: m2.value, "onUpdate:value": t3[10] || (t3[10] = (e4) => m2.value = e4), placeholder: `Enter new route name`, onKeyup: t3[11] || (t3[11] = ze(() => {
    h2.value && b2(h2.value);
  }, [`enter`])) }, null, 8, [`value`])]), _: 1 }, 8, [`show`])], 64));
} }), [[`__scopeId`, `data-v-473cdb34`]]);
const Lr = qe(`map`, () => {
  let e2 = k(7), t2 = k([0, 0]), n2 = k(0), r2 = k(0), i2 = k(false);
  async function a2() {
...
var Ur = `Feature mode property does not match the mode being added to`, Wr;
(function(e2) {
  e2.Drawing = `drawing`, e2.Select = `select`, e2.Static = `static`, e2.Render = `render`;
})(Wr || (Wr = {}));
var Gr = { rightClick: true, contextMenu: false, leftClick: true, onDragStart: true, onDrag: true, onDragEnd: true }, Kr = class {
  get state() {
    return this._state;
  }
  set state(e2) {
  ...
  performFeatureValidation(e2) {
    ...
    let t2 = (function(e3, t3) {
      let n2;
      if (Br(e3)) if (e3.id == null) n2 = `Feature has no id`;
      else if (typeof e3.id != `string` && typeof e3.id != `number`) n2 = `Feature must be string or number as per GeoJSON spec`;
      else if (t3(e3.id)) if (Br(e3.geometry)) if (Br(e3.properties)) if (typeof e3.geometry.type == `string` && [`Polygon`, `LineString`, `Point`].includes(e3.geometry.type)) if (Array.isArray(e3.geometry.coordinates)) {
  ...
  validateModeFeature(e2, t2) {
    ...
    return n2.valid ? e2.properties.mode === this.mode ? t2(e2) : { valid: false, reason: Ur } : { valid: false, reason: n2.reason };
  }
  onFinish(e2, t2) {
  }
  onDeselect(e2) {
...
var Qr = 57.29577951308232, $r = 0.017453292519943295, ei = 6378137, Q = (e2, t2) => ({ x: e2 === 0 ? 0 : e2 * $r * ei, y: t2 === 0 ? 0 : Math.log(Math.tan(Math.PI / 4 + t2 * $r / 2)) * ei }), ti = (e2, t2) => ({ lng: e2 === 0 ? 0 : e2 / ei * Qr, lat: t2 === 0 ? 0 : (2 * Math.atan(Math.exp(t2 / ei)) - Math.PI / 2) * Qr });
function ni(e2) {
  let t2;
  ...
  function i2(e3, i3, a2, o2) {
    let s2 = t2[e3][i3], c2 = t2[e3][i3 + 1], l2 = t2[a2][o2], u2 = t2[a2][o2 + 1], d2 = (function(e4, t3, n3, r3) {
      if (ri(e4, n3) || ri(e4, r3) || ri(t3, n3) || ri(r3, n3)) return null;
...
function ci({ unproject: e2, point: t2, pointerDistance: n2 }) {
...
var li = class extends $ {
  ...
  create(e2) {
    ...
    return ci({ unproject: this.unproject, point: { x: t2, y: n2 }, pointerDistance: this.pointerDistance });
  }
}, ui = class extends $ {
  constructor(e2) {
    super(e2);
  ...
  measure(e2, t2) {
    ...
    return si({ x: n2, y: r2 }, { x: e2.containerX, y: e2.containerY });
  }
}, di = class extends $ {
...
function fi(e2, t2, n2) {
  let r2 = X(e2[0]), i2 = X(e2[1]), a2 = X(n2), o2 = Xr(t2), s2 = Math.asin(Math.sin(i2) * Math.cos(o2) + Math.cos(i2) * Math.sin(o2) * Math.cos(a2));
  return [Zr(r2 + Math.atan2(Math.sin(a2) * Math.sin(o2) * Math.cos(i2), Math.cos(o2) - Math.sin(i2) * Math.sin(s2))), Zr(s2)];
}
function pi(e2, t2) {
  ...
  return Zr(Math.atan2(o2, s2));
}
function mi({ x: e2, y: t2 }, { x: n2, y: r2 }) {
...
function hi(e2, t2, n2) {
  ...
  for (let i3 = 0; i3 < e2.length && !(t2 >= c2 && i3 === e2.length - 1); i3++) {
    if (c2 > t2 && r2.length === 0) {
      ...
      o2 = pi(e2[i3], e2[i3 - 1]) - 180, s2 = fi(e2[i3], a2, o2), r2.push(s2);
    }
    if (c2 >= n2) return a2 = n2 - c2, a2 ? (o2 = pi(e2[i3], e2[i3 - 1]) - 180, s2 = fi(e2[i3], a2, o2), r2.push(s2), r2) : (r2.push(e2[i3]), r2);
...
var vi = class extends $ {
  ...
  generateInsertionCoordinates(e2, t2, n2) {
    let r2 = [e2, t2], i2 = 0;
    for (let e3 = 0; e3 < r2.length - 1; e3++) i2 += Jr(r2[0], r2[1]);
    if (i2 <= n2) return r2;
    let a2 = i2 / n2 - 1;
    Number.isInteger(a2) || (a2 = Math.floor(a2) + 1);
    let o2 = [];
    for (let e3 = 0; e3 < a2; e3++) {
      let t3 = hi(r2, n2 * e3, n2 * (e3 + 1));
      o2.push(t3);
    }
    let s2 = [];
  ...
  generateInsertionGeodesicCoordinates(e2, t2, n2) {
    let r2 = Jr(e2, t2), i2 = (function(e3, t3, n3) {
      let r3 = [], i3 = gi(e3[1]), a2 = gi(e3[0]), o2 = gi(t3[1]), s2 = gi(t3[0]);
      n3 += 1;
      ...
      for (let e4 = 0; e4 <= n3; e4++) {
        ...
        isNaN(m2) || isNaN(h2) || r3.push([_i(h2), _i(m2)]);
      }
      return r3.slice(1, -1);
...
function bi(e2, t2) {
  ...
  for (let n2 = 0; n2 < e2.geometry.coordinates.length; n2++) {
    if (!ai(e2.geometry.coordinates[n2])) return { valid: false, reason: `Feature has invalid coordinates` };
    if (!ii(e2.geometry.coordinates[n2], t2)) return { valid: false, reason: `Feature has coordinates with excessive precision` };
  }
  return { valid: true };
}
function xi(e2) {
...
function wi(e2) {
  let [t2, n2, r2] = e2, i2 = Zr(Math.asin(r2));
  return [Zr(Math.atan2(n2, t2)), i2];
}
function Ti(e2, t2, n2) {
  let r2 = Ci(e2), i2 = Ci(t2), [a2, o2, s2] = Ci(n2), [c2, l2, u2] = (function(e3, t3) {
    let [n3, r3, i3] = e3, [a3, o3, s3] = t3;
    return [r3 * s3 - i3 * o3, i3 * a3 - n3 * s3, n3 * o3 - r3 * a3];
  })(r2, i2), d2 = l2 * s2 - u2 * o2, f2 = u2 * a2 - c2 * s2, p2 = c2 * o2 - l2 * a2, m2 = p2 * l2 - f2 * u2, h2 = d2 * u2 - p2 * c2, g2 = f2 * c2 - d2 * l2, _2 = 1 / Math.sqrt(m2 ** 2 + h2 ** 2 + g2 ** 2), v2 = [m2 * _2, h2 * _2, g2 * _2], y2 = [-1 * m2 * _2, -1 * h2 * _2, -1 * g2 * _2], b2 = Si(r2, i2), x2 = Si(r2, v2), S2 = Si(i2, v2), C2 = Si(r2, y2), ee2 = Si(i2, y2), w2;
  return w2 = x2 < C2 && x2 < ee2 || S2 < C2 && S2 < ee2 ? v2 : y2, Si(r2, w2) > b2 || Si(i2, w2) > b2 ? Jr(wi(w2), wi(r2)) <= Jr(wi(w2), wi(i2)) ? [wi(r2), true, false] : [wi(i2), false, true] : [wi(w2), false, false];
}
...
var Di = class extends $ {
      ...
      if (this.config.projection === `web-mercator` ? a2 = (function(e3, t4) {
        ...
        for (let a3 of t4) {
          ...
          if (o3[0] === e3[0] && o3[1] === e3[1]) c2 = o3;
            ...
            let { x: e4, y: t5 } = Ei(u2, d2, f2), { lng: n5, lat: r5 } = ti(e4, t5);
            c2 = [n5, r5];
          }
          c2 && (l2 = si(f2, Q(c2[0], c2[1])), l2 < r4 && (n4 = c2, r4 = l2, i3 = t4.indexOf(a3)));
        }
        ...
        for (let a3 of t4) {
          ...
          o3[0] === e3[0] && o3[1] === e3[1] ? c2 = o3 : s3[0] === e3[0] && s3[1] === e3[1] ? c2 = s3 : [c2] = Ti(o3, s3, e3), c2 && (l2 = Jr(e3, c2), l2 < r4 && (n4 = c2, r4 = l2, i3 = t4.indexOf(a3)));
        }
  ...
  generateInsertCoordinates(e2, t2) {
    ...
    let n2 = Jr(e2, t2) / (this.insertCoordinates.value + 1), r2 = [];
  ...
  updateToLine(e2, t2) {
    ...
    if (si({ x: a2, y: o2 }, { x: t2.x, y: t2.y }) < this.pointerDistance) return void this.close();
    this.setCursor(this.cursors.close);
    let s2 = [...n2, e2];
    this.updateGeometries(s2, n2[n2.length - 1], q.Commit), this.currentCoordinate++;
  }
  registerBehaviors(e2) {
    this.coordinateSnapping = new di(e2, new ui(e2), new li(e2)), this.insertPoint = new vi(e2), this.clickBoundingBox = new li(e2), this.pixelDistance = new ui(e2), this.lineSnapping = new Di(e2, this.pixelDistance, this.clickBoundingBox), this.coordinateSnapping = new di(e2, this.pixelDistance, this.clickBoundingBox);
  }
  start() {
  ...
  onMouseMove(e2) {
    ...
    if (n2.pop(), this.closingPointId) {
      ...
      si({ x: i2, y: a2 }, { x: e2.containerX, y: e2.containerY }) < this.pointerDistance && this.setCursor(this.cursors.close);
    }
    let r2 = [...n2, t2];
  ...
  styleFeature(e2) {
    ...
    if (e2.type === `Feature` && e2.geometry.type === `LineString` && e2.properties.mode === this.mode) return t2.lineStringColor = this.getHexColorStylingValue(this.styles.lineStringColor, t2.lineStringColor, e2), t2.lineStringWidth = this.getNumericStylingValue(this.styles.lineStringWidth, t2.lineStringWidth, e2), t2.zIndex = zr, t2;
...
}, ji = `Feature is not a Point`, Mi = `Feature has invalid coordinates`, Ni = `Feature has coordinates with excessive precision`;
function Pi(e2, t2) {
  return e2.geometry.type === `Point` ? ai(e2.geometry.coordinates) ? ii(e2.geometry.coordinates, t2) ? { valid: true } : { valid: false, reason: Ni } : { valid: false, reason: Mi } : { valid: false, reason: ji };
}
var Fi = { create: `crosshair`, dragStart: `grabbing`, dragEnd: `crosshair` }, Ii = class extends Kr {
  constructor(e2) {
    super(e2, true), this.mode = `point`, this.cursors = Fi, this.editable = false, this.editedFeatureId = void 0, this.pixelDistance = void 0, this.clickBoundingBox = void 0, this.updateOptions(e2);
  }
  updateOptions(e2) {
  ...
  registerBehaviors(e2) {
    this.pixelDistance = new ui(e2), this.clickBoundingBox = new li(e2);
  }
  styleFeature(e2) {
    let t2 = K({}, { polygonFillColor: `#3f97e0`, polygonOutlineColor: `#3f97e0`, polygonOutlineWidth: 4, polygonFillOpacity: 0.3, pointColor: `#3f97e0`, pointOutlineColor: `#ffffff`, pointOutlineWidth: 0, pointWidth: 6, lineStringColor: `#3f97e0`, lineStringWidth: 4, zIndex: 0, markerUrl: void 0, markerHeight: void 0, markerWidth: void 0 });
    if (e2.type === `Feature` && e2.geometry.type === `Point` && e2.properties.mode === this.mode) {
  ...
  validateFeature(e2) {
    return this.validateModeFeature(e2, (e3) => Pi(e3, this.coordinatePrecision));
  }
  onLeftClick(e2) {
...
function Ri(e2, t2) {
  ...
  let s2 = Math.log(Math.tan(a2 / 2 + Math.PI / 4) / Math.tan(i2 / 2 + Math.PI / 4)), c2 = (Zr(Math.atan2(o2, s2)) + 360) % 360;
  return c2 > 180 ? -(360 - c2) : c2;
}
function zi(e2, t2, n2) {
  let r2 = t2;
  t2 < 0 && (r2 = -Math.abs(r2));
  let i2 = r2 / Yr, a2 = e2[0] * Math.PI / 180, o2 = X(e2[1]), s2 = X(n2), c2 = i2 * Math.cos(s2), l2 = o2 + c2;
...
var Ui = class extends $ {
  ...
  create(e2, t2, n2) {
    ...
    this._midPoints = this.store.create((function(e3, t3, n3, r2, i2, a2) {
      return Hi({ featureCoords: e3, precision: n3, project: r2, unproject: i2, projection: a2 }).map((e4, n4) => ({ geometry: { type: `Point`, coordinates: e4 }, properties: t3(n4) }));
  ...
  getUpdated(e2) {
    if (this._midPoints.length !== 0) return Hi({ featureCoords: e2, precision: this.coordinatePrecision, project: this.config.project, unproject: this.config.unproject, projection: this.config.projection }).map((e3, t2) => ({ id: this._midPoints[t2], geometry: { type: `Point`, coordinates: e3 } }));
  }
}, Wi = class extends $ {
  constructor(e2) {
...
var Ki = (e2, t2, n2) => {
    ...
    for (let l3 = 0; l3 < u2.length; l3++) {
      ...
      if (f2.type === `Point`) {
        ...
        for (let t3 = 0; t3 < f2.coordinates.length - 1; t3++) {
          let n3 = f2.coordinates[t3], i3 = f2.coordinates[t3 + 1], a3 = Ki({ x: e2.containerX, y: e2.containerY }, this.project(n3[0], n3[1]), this.project(i3[0], i3[1]));
          a3 < this.pointerDistance && a3 < s2 && (s2 = a3, r2 = d2);
        }
      } else if (f2.type === `Polygon`) {
        if (n2 || r2) continue;
        Gi([e2.lng, e2.lat], f2.coordinates) && (a2 = d2);
      }
    }
    ...
    if (n2.type === `Polygon` || n2.type === `LineString`) {
      ...
      for (let e3 = 0; e3 < a2; e3++) {
        ...
        if (this.config.projection === `web-mercator`) {
          let e4 = Q(this.dragPosition[0], this.dragPosition[1]), i3 = Q(r2[0], r2[1]), o3 = Q(t3[0], t3[1]), s3 = { x: e4.x - i3.x, y: e4.y - i3.y }, { lng: c3, lat: l2 } = ti(o3.x - s3.x, o3.y - s3.y);
          n3 = c3, a3 = l2;
        } else {
  ...
  drag(e2, t2, n2, r2) {
    ...
    return !(o2.type !== `Point` && !t2 && ni({ type: `Feature`, geometry: o2, properties: {} }) || n2 && !n2(u2, { project: this.config.project, unproject: this.config.unproject, coordinatePrecision: this.config.coordinatePrecision, updateType: q.Provisional }).valid || (this.store.updateGeometry([{ id: i2, geometry: o2 }, ...p2, ...m2, ...h2]), 0));
  }
  isDragging() {
...
var Zi = (e2, t2) => {
  ...
  let a2 = r2.map((e3) => ({ x: i2.x + (e3.x - i2.x) * Math.cos(n2) - (e3.y - i2.y) * Math.sin(n2), y: i2.y + (e3.x - i2.x) * Math.sin(n2) + (e3.y - i2.y) * Math.cos(n2) })).map(({ x: e3, y: t3 }) => [ti(e3, t3).lng, ti(e3, t3).lat]);
...
var $i = class extends $ {
  ...
  rotate(e2, t2, n2) {
    ...
    if (this.config.projection === `web-mercator`) {
      this.selectedGeometryWebMercatorCentroid || (this.selectedGeometryWebMercatorCentroid = Qi(o2));
      let t3 = Q(e2.lng, e2.lat);
      if (a2 = mi(this.selectedGeometryWebMercatorCentroid, t3), a2 === 0) return;
      if (!this.lastBearing) return void (this.lastBearing = a2);
      Zi(o2, -(this.lastBearing - a2));
    } else {
      if (this.config.projection !== `globe`) throw Error(`Unsupported projection`);
      if (this.selectedGeometryCentroid || (this.selectedGeometryCentroid = Xi({ type: `Feature`, geometry: r2, properties: {} })), a2 = Ri(this.selectedGeometryCentroid, i2), !this.lastBearing) return void (this.lastBearing = a2 + 180);
      (function(e3, t3) {
        if (t3 === 0 || t3 === 360 || t3 === -360) return e3;
        let n3 = Xi(e3);
        (e3.geometry.type === `Polygon` ? e3.geometry.coordinates[0] : e3.geometry.coordinates).forEach((e4) => {
          let r3 = Ri(n3, e4) + t3, i3 = zi(n3, (function(e5, t4) {
            e5[0] += e5[0] - t4[0] > 180 ? -360 : t4[0] - e5[0] > 180 ? 360 : 0;
            let n4 = Yr, r4 = t4[1] * Math.PI / 180, i4 = e5[1] * Math.PI / 180, a3 = i4 - r4, o3 = Math.abs(e5[0] - t4[0]) * Math.PI / 180;
...
function ta({ coordinates: e2, originX: t2, originY: n2, xScale: r2, yScale: i2 }) {
  r2 === 1 && i2 === 1 || e2.forEach((e3) => {
    let { x: a2, y: o2 } = Q(e3[0], e3[1]), { lng: s2, lat: c2 } = ti(t2 + (a2 - t2) * r2, n2 + (o2 - n2) * i2);
    e3[0] = s2, e3[1] = c2;
  });
}
var na = class extends $ {
  ...
  centerWebMercatorDrag(e2) {
    ...
    if (!t2) return null;
    let { feature: n2, boundingBox: r2, updatedCoords: i2, selectedCoordinate: a2 } = t2, o2 = Qi(n2);
    if (!o2) return null;
  ...
  scaleFixedWebMercator({ closestBBoxIndex: e2, webMercatorOrigin: t2, webMercatorSelected: n2, webMercatorCursor: r2, updatedCoords: i2 }) {
    ...
    let a2 = si(t2, r2) / si(t2, n2);
    return a2 < 0 && (a2 = this.minimumScale), ta({ coordinates: i2, originX: t2.x, originY: t2.y, xScale: a2, yScale: a2 }), i2;
  }
  ...
  getIndexesWebMercator(e2, t2) {
    ...
    for (let i2 = 0; i2 < e2.length; i2++) {
      let a2 = si({ x: t2.x, y: t2.y }, { x: e2[i2][0], y: e2[i2][1] });
      a2 < r2 && (n2 = i2, r2 = a2);
    }
  ...
  drag(e2, t2, n2) {
    ...
    for (let e3 = 0; e3 < i2.length; e3++) {
      let t3 = i2[e3];
      if (t3[0] = Z(t3[0], this.coordinatePrecision), t3[1] = Z(t3[1], this.coordinatePrecision), !ii(t3, this.coordinatePrecision)) return false;
    }
  ...
  registerBehaviors(e2) {
    this.pixelDistance = new ui(e2), this.clickBoundingBox = new li(e2), this.featuresAtMouseEvent = new qi(e2, this.clickBoundingBox, this.pixelDistance), this.selectionPoints = new Wi(e2), this.coordinatePoints = new Li(e2), this.midPoints = new Ui(e2, this.selectionPoints, this.coordinatePoints), this.coordinateSnap = new di(e2, this.pixelDistance, this.clickBoundingBox), this.lineSnap = new Di(e2, this.pixelDistance, this.clickBoundingBox), this.rotateFeature = new $i(e2, this.selectionPoints, this.midPoints, this.coordinatePoints), this.dragFeature = new Ji(e2, this.featuresAtMouseEvent, this.selectionPoints, this.midPoints, this.coordinatePoints), this.dragCoordinate = new Yi(e2, this.pixelDistance, this.selectionPoints, this.midPoints, this.coordinatePoints, this.coordinateSnap, this.lineSnap), this.dragCoordinateResizeFeature = new na(e2, this.pixelDistance, this.selectionPoints, this.midPoints, this.coordinatePoints), this.scaleFeature = new ea(e2, this.dragCoordinateResizeFeature);
  }
  deselectFeature() {
    this.deselect();
  }
  ...
  styleFeature(e2) {
    ...
    if (e2.properties.mode === this.mode && e2.geometry.type === `Point`) {
      ...
      if (e2.geometry.type === `Point` && e2.properties[Y.MARKER]) return t2.markerUrl = this.getUrlStylingValue(this.styles.selectedMarkerUrl, Rr, e2), t2.markerHeight = this.getNumericStylingValue(this.styles.selectedMarkerHeight, 40, e2), t2.markerWidth = this.getNumericStylingValue(this.styles.selectedMarkerWidth, 32, e2), t2;
      ...
      if (e2.geometry.type === `LineString`) return t2.lineStringColor = this.getHexColorStylingValue(this.styles.selectedLineStringColor, t2.lineStringColor, e2), t2.lineStringWidth = this.getNumericStylingValue(this.styles.selectedLineStringWidth, t2.lineStringWidth, e2), t2.zIndex = zr, t2;
      if (e2.geometry.type === `Point`) return t2.pointWidth = this.getNumericStylingValue(this.styles.selectedPointWidth, t2.pointWidth, e2), t2.pointColor = this.getHexColorStylingValue(this.styles.selectedPointColor, t2.pointColor, e2), t2.pointOutlineColor = this.getHexColorStylingValue(this.styles.selectedPointOutlineColor, t2.pointOutlineColor, e2), t2.pointOutlineWidth = this.getNumericStylingValue(this.styles.selectedPointOutlineWidth, t2.pointOutlineWidth, e2), t2.zIndex = zr, t2;
    }
    return t2;
  }
  afterFeatureUpdated(e2) {
  ...
  constructor(...e2) {
    super(...e2), this.type = Wr.Static, this.mode = `static`;
  }
  start() {
  }
  stop() {
...
function sa(e2, t2, n2, r2, i2) {
  for (; r2 > n2; ) {
    if (r2 - n2 > 600) {
      let a3 = r2 - n2 + 1, o3 = t2 - n2 + 1, s3 = Math.log(a3), c2 = 0.5 * Math.exp(2 * s3 / 3), l2 = 0.5 * Math.sqrt(s3 * c2 * (a3 - c2) / a3) * (o3 - a3 / 2 < 0 ? -1 : 1);
      sa(e2, t2, Math.max(n2, Math.floor(t2 - o3 * c2 / a3 + l2)), Math.min(r2, Math.floor(t2 + (a3 - o3) * c2 / a3 + l2)), i2);
    }
    let a2 = e2[t2], o2 = n2, s2 = r2;
    for (ca(e2, n2, t2), i2(e2[r2], a2) > 0 && ca(e2, n2, r2); o2 < s2; ) {
      for (ca(e2, o2, s2), o2++, s2--; i2(e2[o2], a2) < 0; ) o2++;
      for (; i2(e2[s2], a2) > 0; ) s2--;
    }
    i2(e2[n2], a2) === 0 ? ca(e2, n2, s2) : (s2++, ca(e2, s2, r2)), s2 <= t2 && (n2 = s2 + 1), t2 <= s2 && (r2 = s2 - 1);
  }
}
...
function la(e2, t2) {
  ua(e2, 0, e2.children.length, t2, e2);
}
function ua(e2, t2, n2, r2, i2) {
  i2 || (i2 = ya([])), i2.minX = 1 / 0, i2.minY = 1 / 0, i2.maxX = -1 / 0, i2.maxY = -1 / 0;
  for (let a2 = t2; a2 < n2; a2++) {
    let t3 = e2.children[a2];
    da(i2, e2.leaf ? r2(t3) : t3);
  }
  return i2;
}
function da(e2, t2) {
...
var xa = class {
    ...
    if (va(e2, t2)) {
      ...
      for (; t2; ) {
        for (let r2 = 0; r2 < t2.children.length; r2++) {
          ...
          if (va(e2, a2)) {
            if (t2.leaf || _a(e2, a2)) return true;
            n2.push(i2);
          }
        }
        t2 = n2.pop();
  ...
  remove(e2) {
    ...
    for (; t2 || r2.length; ) {
      ...
      s2 || t2.leaf || !_a(t2, n2) ? o2 ? (a2++, t2 = o2.children[a2], s2 = false) : t2 = null : (r2.push(t2), i2.push(a2), a2 = 0, o2 = t2, t2 = t2.children[0]);
    }
  }
  toBBox(e2) {
    return e2;
  ...
  _build(e2, t2, n2, r2) {
    ...
    if (i2 <= o2) return a2 = ya(e2.slice(t2, n2 + 1)), la(a2, this.toBBox), a2;
    r2 || (r2 = Math.ceil(Math.log(i2) / Math.log(o2)), o2 = Math.ceil(i2 / o2 ** (r2 - 1))), a2 = ya([]), a2.leaf = false, a2.height = r2;
    let s2 = Math.ceil(i2 / o2), c2 = s2 * Math.ceil(Math.sqrt(o2));
    ba(e2, t2, n2, c2, this.compareMinX);
    for (let i3 = t2; i3 <= n2; i3 += c2) {
      let t3 = Math.min(i3 + c2 - 1, n2);
      ba(e2, i3, t3, s2, this.compareMinY);
      for (let n3 = i3; n3 <= t3; n3 += s2) {
        let i4 = Math.min(n3 + s2 - 1, t3);
        a2.children.push(this._build(e2, n3, i4, r2 - 1));
      }
    }
    return la(a2, this.toBBox), a2;
  }
  _chooseSubtree(e2, t2, n2, r2) {
    for (; r2.push(t2), !t2.leaf && r2.length - 1 !== n2; ) {
      let n3, r3 = 1 / 0, o2 = 1 / 0;
      for (let s2 = 0; s2 < t2.children.length; s2++) {
        let c2 = t2.children[s2], l2 = ma(c2), u2 = (i2 = e2, a2 = c2, (Math.max(a2.maxX, i2.maxX) - Math.min(a2.minX, i2.minX)) * (Math.max(a2.maxY, i2.maxY) - Math.min(a2.minY, i2.minY)) - l2);
  ...
  _insert(e2, t2, n2) {
    ...
    for (a2.children.push(e2), da(a2, r2); t2 >= 0 && i2[t2].children.length > this._maxEntries; ) this._split(i2, t2), t2--;
    this._adjustParentBBoxes(r2, i2, t2);
  }
  _split(e2, t2) {
    let n2 = e2[t2], r2 = n2.children.length, i2 = this._minEntries;
    this._chooseSplitAxis(n2, i2, r2);
    let a2 = this._chooseSplitIndex(n2, i2, r2), o2 = ya(n2.children.splice(a2, n2.children.length - a2));
    o2.height = n2.height, o2.leaf = n2.leaf, la(n2, this.toBBox), la(o2, this.toBBox), t2 ? e2[t2 - 1].children.push(o2) : this._splitRoot(n2, o2);
  }
  _splitRoot(e2, t2) {
    this.data = ya([e2, t2]), this.data.height = e2.height + 1, this.data.leaf = false, la(this.data, this.toBBox);
  }
  _chooseSplitIndex(e2, t2, n2) {
    let r2, i2 = 1 / 0, a2 = 1 / 0;
    for (let o2 = t2; o2 <= n2 - t2; o2++) {
      let t3 = ua(e2, 0, o2, this.toBBox), s2 = ua(e2, o2, n2, this.toBBox), c2 = ga(t3, s2), l2 = ma(t3) + ma(s2);
      c2 < i2 ? (i2 = c2, r2 = o2, a2 = l2 < a2 ? l2 : a2) : c2 === i2 && l2 < a2 && (a2 = l2, r2 = o2);
    }
    return r2 || n2 - t2;
  }
  _chooseSplitAxis(e2, t2, n2) {
    let r2 = e2.leaf ? this.compareMinX : fa, i2 = e2.leaf ? this.compareMinY : pa;
    this._allDistMargin(e2, t2, n2, r2) < this._allDistMargin(e2, t2, n2, i2) && e2.children.sort(r2);
  }
  _allDistMargin(e2, t2, n2, r2) {
    e2.children.sort(r2);
    let i2 = this.toBBox, a2 = ua(e2, 0, t2, i2), o2 = ua(e2, n2 - t2, n2, i2), s2 = ha(a2) + ha(o2);
    for (let r3 = t2; r3 < n2 - t2; r3++) {
      let t3 = e2.children[r3];
      da(a2, e2.leaf ? i2(t3) : t3), s2 += ha(a2);
    }
    for (let r3 = n2 - t2 - 1; r3 >= t2; r3--) {
      let t3 = e2.children[r3];
      da(o2, e2.leaf ? i2(t3) : t3), s2 += ha(o2);
    }
    return s2;
  }
  _adjustParentBBoxes(e2, t2, n2) {
    for (let r2 = n2; r2 >= 0; r2--) da(t2[r2], e2);
  }
  _condense(e2) {
    for (let t2, n2 = e2.length - 1; n2 >= 0; n2--) e2[n2].children.length === 0 ? n2 > 0 ? (t2 = e2[n2 - 1].children, t2.splice(t2.indexOf(e2[n2]), 1)) : this.clear() : la(e2[n2], this.toBBox);
  }
}, Sa = class {
  constructor(e2) {
    this.tree = void 0, this.idToNode = void 0, this.nodeToId = void 0, this.tree = new xa(e2 && e2.maxEntries ? e2.maxEntries : 9), this.idToNode = /* @__PURE__ */ new Map(), this.nodeToId = /* @__PURE__ */ new Map();
  }
  setMaps(e2, t2) {
...
}, Ca = { getId: () => `xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx`.replace(/[xy]/g, function(e2) {
  let t2 = 16 * Math.random() | 0;
  return (e2 == `x` ? t2 : 3 & t2 | 8).toString(16);
}), isValidId: (e2) => typeof e2 == `string` && e2.length === 36 }, wa = { target: `geometry` }, Ta = { target: `properties` }, Ea = class {
  constructor(e2) {
    this.idStrategy = void 0, this.tracked = void 0, this.spatialIndex = void 0, this.store = void 0, this._onChange = () => {
    }, this.store = {}, this.spatialIndex = new Sa(), this.tracked = !e2 || false !== e2.tracked, this.idStrategy = e2 && e2.idStrategy ? e2.idStrategy : Ca;
  }
  clone(e2) {
    ...
    i2 = i2.filter((e3) => {
      ...
      if (this.tracked) {
        if (e3.properties.createdAt) {
          if (!Hr(e3.properties.createdAt)) return a2.push({ id: e3.id, valid: false, reason: `createdAt is not a valid numeric timestamp` }), false;
        } else e3.properties.createdAt = +/* @__PURE__ */ new Date();
        if (e3.properties.updatedAt) {
          if (!Hr(e3.properties.updatedAt)) return a2.push({ id: e3.id, valid: false, reason: `updatedAt is not a valid numeric timestamp` }), false;
  ...
  updateGeometry(e2, t2) {
    ...
    }), this._onChange && n2.size > 0 && this._onChange([...n2], `update`, t2 ? K({}, t2, wa) : wa);
  }
  create(e2, t2) {
    let n2 = [];
...
var Da = class {
...
}, Oa = { __proto__: null, GeoJSONStore: Ea, TerraDrawBaseDrawMode: Kr, TerraDrawBaseSelectMode: qr, TerraDrawBaseAdapter: class {
  constructor(e2) {
  ...
  getAdapterListeners() {
    return [new Da({ name: `pointerdown`, callback: (e2) => {
    ...
    } }), new Da({ name: `pointermove`, callback: (e2) => {
      if (!this._currentModeCallbacks || !e2.isPrimary) return;
      e2.preventDefault();
      let t2 = this.getDrawEventFromEvent(e2);
      if (t2) if (this._dragState === `not-dragging`) this._currentModeCallbacks.onMouseMove(t2), this._lastDrawEvent = t2;
        ...
        let e3 = { x: this._lastDrawEvent.containerX, y: this._lastDrawEvent.containerY }, n2 = { x: t2.containerX, y: t2.containerY }, r2 = this._currentModeCallbacks.getState(), i2 = si(e3, n2), a2 = false;
    ...
    } }), new Da({ name: `contextmenu`, callback: (e2) => {
    ...
    } }), new Da({ name: `pointerup`, callback: (e2) => {
    ...
    } }), new Da({ name: `keydown`, callback: (e2) => {
...
function ka(e2) {
  ...
  if (Array.isArray(e2)) {
    for (let t2 of e2) if (!ka(t2)) return false;
  }
  return typeof e2 == `object` && Object.keys(e2).every((t2) => typeof t2 == `string` && ka(e2[t2]));
}
var Aa = class {
  constructor(e2) {
    this._modes = void 0, this._mode = void 0, this._adapter = void 0, this._enabled = false, this._store = void 0, this._eventListeners = void 0, this._instanceSelectMode = void 0, this._adapter = e2.adapter, this._mode = new oa();
    ...
    r2.forEach((e3) => {
      if (n2[e3].type === Wr.Select) {
        if (this._instanceSelectMode) throw Error(`only one type of select mode can be provided`);
        this._instanceSelectMode = e3;
      }
    }), this._modes = K({}, n2, { static: this._mode }), this._eventListeners = { change: [], select: [], deselect: [], finish: [], ready: [] }, this._store = new Ea({ tracked: !!e2.tracked, idStrategy: e2.idStrategy ? e2.idStrategy : void 0 });
    let i2 = (e3) => {
      let t3 = [];
  ...
  featuresAtLocation({ lng: e2, lat: t2 }, n2) {
    let r2 = n2 && n2.pointerDistance !== void 0 ? n2.pointerDistance : 30, i2 = !n2 || n2.ignoreSelectFeatures === void 0 || n2.ignoreSelectFeatures, a2 = !(!n2 || n2.ignoreCoordinatePoints === void 0) && n2.ignoreCoordinatePoints, o2 = !(!n2 || n2.ignoreCurrentlyDrawing === void 0) && n2.ignoreCurrentlyDrawing, s2 = !(!n2 || n2.ignoreClosingPoints === void 0) && n2.ignoreClosingPoints, c2 = !(!n2 || n2.ignoreSnappingPoints === void 0) && n2.ignoreSnappingPoints, l2 = this._adapter.unproject.bind(this._adapter), u2 = this._adapter.project.bind(this._adapter), d2 = u2(e2, t2), f2 = ci({ unproject: l2, point: d2, pointerDistance: r2 });
    return this._store.search(f2).filter((l3) => {
      ...
      if (l3.geometry.type === `Point`) {
        ...
        return si(d2, u2(e3[0], e3[1])) < r2;
      }
      if (l3.geometry.type === `LineString`) {
        let e3 = l3.geometry.coordinates;
        for (let t3 = 0; t3 < e3.length - 1; t3++) {
          let n3 = e3[t3], i3 = e3[t3 + 1];
          if (Ki(d2, u2(n3[0], n3[1]), u2(i3[0], i3[1])) < r2) return true;
        }
        return false;
      }
      if (Gi([e2, t2], l3.geometry.coordinates)) return true;
      ...
      for (let e3 = 0; e3 < i3.length; e3++) {
        let t3 = i3[e3], n3 = si(u2(t3[0], t3[1]), d2);
        n3 < s3 && (o3 = e3, s3 = n3, a3 = t3);
      }
      return r3.properties.closestCoordinateIndexToEvent = o3, r3.properties.closestCoordinatePixelDistanceToEvent = s3, r3.properties.closestCoordinateDistanceKmToEvent = Jr(a3, [e2, t2]), r3;
    });
  }
  ...
  updateFeatureProperties(e2, t2) {
    ...
    i2.forEach(([e3, t3]) => {
      ...
      if (t3 !== void 0 && !ka(t3)) throw Error(`Invalid JSON value provided for property ${e3}`);
  ...
  transformFeatureGeometry(e2, t2) {
    ...
    if (t2.type === `scale`) {
      ...
      ta({ coordinates: a2, originX: e3, originY: n3, xScale: t2.options.xScale || 1, yScale: t2.options.yScale || 1 });
    } else t2.type === `rotate` && (n2 = Zi(n2, t2.options.angle || 0), a2 = n2.geometry.type === `Polygon` ? n2.geometry.coordinates[0] : n2.geometry.coordinates);
...
}, ja = I({ __name: `MapContainer`, props: { styleUrl: {}, geojsonSource: {}, onMapInit: { type: Function }, onMapTouchStart: { type: Function }, onMapTouchEnd: { type: Function }, onMapClick: { type: Function } }, setup(e2, { expose: t2 }) {
  let n2 = e2, r2 = Ge(null), i2 = Ge(null), a2 = At(), o2 = Lr(), s2 = lt();
  ...
  let { bearing: f2, isTracking: p2, isSupported: m2, error: h2, startTracking: g2, stopTracking: _2 } = ar({ autoStart: false }), v2 = () => {
    var _a2;
  ...
  return O([f2, () => o2.isTrackingOrientation], ([e3, t3]) => {
    t3 && y2(e3);
  }), t2({ setupBuildingLayer: l2, removeBuildingLayer: u2, toggleOrientationTracking: v2, map: r2, draw: i2 }), (t3, n3) => (P(), A(U(de), { bearing: U(o2).bearing, "onUpdate:bearing": n3[0] || (n3[0] = (e3) => U(o2).bearing = e3), zoom: U(o2).zoom, "onUpdate:zoom": n3[1] || (n3[1] = (e3) => U(o2).zoom = e3), center: U(o2).center, "onUpdate:center": n3[2] || (n3[2] = (e3) => U(o2).center = e3), "map-style": e2.styleUrl, height: `100%`, "onMap:load": d2, "onMap:touchstart": e2.onMapTouchStart, "onMap:touchend": e2.onMapTouchEnd }, { default: E(() => [z(U(oe), { "source-id": `geojson`, data: e2.geojsonSource, "line-metrics": true }, { default: E(() => [z(U(T), { "layer-id": `geojson`, layout: { "line-join": `round`, "line-cap": `round` }, paint: { "line-width": 5, "line-gradient": [`interpolate`, [`linear`], [`line-progress`], 0, `#00ff00`, 0.7, `#00DD00`, 0.9, `#00BB00`, 1, `#008800`], "line-opacity": 0.8 } })]), _: 1 }, 8, [`data`]), Ie(t3.$slots, `default`)]), _: 3 }, 8, [`bearing`, `zoom`, `center`, `map-style`, `onMap:touchstart`, `onMap:touchend`]));
} }), Ma = H(I({ __name: `MapControls`, setup(e2) {
  return (e3, t2) => (P(), W(`div`, null, [z(U(te), { position: `top-left` }), z(U(se), { position: `top-left` }), z(U(ce), { position: `bottom-left` })]));
...
var Fa = class extends Oa.TerraDrawBaseAdapter {
  constructor(e2) {
...
}, Ia = [{ name: `point`, label: `point`, icon: at }, { name: `linestring`, label: `line`, icon: Zt }, { name: `select`, label: `select`, icon: Yt }, { name: `delete`, label: `delete`, icon: tn }], La = () => [new aa({ allowManualDeselection: true, pointerDistance: 10, flags: { point: { feature: { draggable: true } }, polygon: { feature: { draggable: true, coordinates: { midpoints: true, draggable: true, deletable: true } } }, linestring: { feature: { draggable: true, coordinates: { midpoints: true, draggable: true, deletable: true } } }, freehand: { feature: { draggable: true, coordinates: { midpoints: true, draggable: true, deletable: true } } }, circle: { feature: { draggable: true, coordinates: { midpoints: true, draggable: true, deletable: true } } }, rectangle: { feature: { draggable: true, coordinates: { midpoints: true, draggable: true, deletable: true } } } } }), new Ii(), new Ai()];
function Ra(e2) {
  let t2 = st(), n2 = Ge(null), r2 = k(`select`), i2 = k(false), a2 = k([]), o2 = k([]), s2 = R(() => a2.value.length > 0), c2 = R(() => o2.value.length > 0), l2 = k(/* @__PURE__ */ new Map()), u2 = k(/* @__PURE__ */ new Map()), d2 = k(false), f2 = k(null), p2 = k(null), m2 = k(null), h2 = k(``), g2 = k(``), _2 = () => {
    e2 && (n2.value = new Aa({ adapter: new Fa({ map: e2 }), modes: La() }), n2.value.start(), re2(`select`), w2(), i2.value = true);
  }, v2 = (e3) => {
    ...
    n2.value && (n2.value.on(`finish`, (e3, t3) => {
      ...
      i3 && (t3.action === `draw` ? (b2(i3), S2({ type: `create`, featureId: r3, feature: rt(i3) })) : (t3.action === `dragFeature` || t3.action === `dragCoordinate`) && (b2(i3, true), S2({ type: `update`, featureId: r3, feature: rt(i3) })));
    }), n2.value.on(`change`, (e3, t3) => {
      var _a2;
      if (!d2.value) {
        if (f2.value && e3.includes(String(f2.value.id))) {
          let e4 = f2.value, t4 = rt(e4);
    ...
    d2.value = true;
    try {
      if (!Ve(r3)) e3.type === `create` && t3 ? (n2.value.removeFeatures([t3]), await x2(t3)) : e3.type === `delete` ? r3 && (n2.value.addFeatures([r3]), await b2(r3)) : e3.type === `update` && r3 && (n2.value.addFeatures([r3]), await b2(r3, true));
    ...
    d2.value = true;
    try {
      if (!Ve(r3)) e3.type === `create` ? r3 && (n2.value.addFeatures([r3]), await b2(r3)) : e3.type === `delete` && t3 ? (n2.value.removeFeatures([t3]), await x2(t3)) : e3.type === `update` && r3 && (n2.value.addFeatures([r3]), await b2(r3, true));
  ...
  return { draw: n2, activeDrawMethod: r2, isDrawingEnabled: i2, canUndo: s2, canRedo: c2, selectedFeatureId: p2, selectedDraftId: m2, selectedFeatureName: h2, selectedFeatureDescription: g2, updateSelectedFeature: ee2, initDraw: _2, setMode: re2, undo: te2, redo: ne2, clearHistory: T2, clearAll: async () => {
    if (!n2.value) return;
    let e3 = n2.value.getSnapshot(), t3 = e3.map((e4) => String(e4.id));
    if (t3.length > 0) {
      S2({ type: `clear`, feature: rt(e3) }), d2.value = true;
      try {
...
var za = [`title`, `onClick`], Ba = [`disabled`, `title`], Va = [`disabled`, `title`], Ha = [`title`], Ua = H(I({ __name: `DrawingTools`, props: { activeDrawMethod: {}, canUndo: { type: Boolean, default: false }, canRedo: { type: Boolean, default: false }, drawerModes: { default: () => Ia } }, emits: [`setDrawMode`, `undo`, `redo`, `clearAll`], setup(e2, { emit: t2 }) {
  ...
  return (r3, a2) => U(t2) && U(t2).isServiceRunning() && e2.isWatchingCurrentLocation && n2.value ? (P(), A(U(ae), { key: 0, coordinates: i2.value }, { marker: E(() => [V(`div`, Ga, [V(`img`, { src: U(Wa), style: B({ height: `4em`, width: `4em`, transform: `rotate(${e2.deviceBearing}deg)`, "transform-origin": `2em 2.83em` }) }, null, 12, Ka)])]), _: 1 }, 8, [`coordinates`])) : F(``, true);
} }), Ja = H(I({ __name: `RecordingButton`, props: { isRecording: { type: Boolean }, recordTimespan: {}, isRouteDrawerOpen: { type: Boolean } }, emits: [`toggleRecording`], setup(e2, { emit: t2 }) {
  Ue((e3) => {
    var _a2, _b;
    return { v5507afc2: (_a2 = U(mt).Button.common) == null ? void 0 : _a2.primaryColorSuppl, v6d610bb6: (_b = U(mt).Button.common) == null ? void 0 : _b.errorColorSuppl };
  });
  let { t: n2 } = lt(), r2 = new jt().isMobile, i2 = t2;
  return (t3, a2) => U(r2) ? (P(), W(`div`, { key: 0, class: L([`mobile-record-button-container`, { "drawer-open": e2.isRouteDrawerOpen }]) }, [z(U(ut), { theme: U(mt) }, { default: E(() => [z(U(xt), { type: e2.isRecording ? `error` : `primary`, size: `large`, class: L([`mobile-record-button`, e2.isRecording ? `recording` : `not-recording`]), onClick: a2[0] || (a2[0] = (e3) => i2(`toggleRecording`)) }, { icon: E(() => [z(U(G), { size: 20 }, { default: E(() => [(P(), A(Re(e2.isRecording ? U(rn) : U($t)), { size: e2.isRecording ? 16 : 20 }, null, 8, [`size`]))]), _: 1 })]), default: E(() => [j(` ` + N(e2.isRecording ? U(n2)(`trackerView.uiRecordingStatus.on`) : U(n2)(`trackerView.uiRecordingStatus.off`)), 1)]), _: 1 }, 8, [`type`, `class`])]), _: 1 }, 8, [`theme`])], 2)) : F(``, true);
} }), [[`__scopeId`, `data-v-e8aa3504`]]), Ya = { key: 0, class: `status-item` }, Xa = { key: 1, class: `status-item` }, Za = { key: 2, class: `status-item` }, Qa = { class: `status-item` }, $a = H(I({ __name: `StatusBar`, props: { isRecording: { type: Boolean }, recordTimespan: {}, isRouteDrawerOpen: { type: Boolean }, currentLocation: {} }, setup(e2) {
  let { t: t2 } = lt(), n2 = new jt().isMobile, r2 = cr(), i2 = e2, a2 = R(() => r2.currentRouteId ? r2.routes.find((e3) => e3.id === r2.currentRouteId) : null), o2 = R(() => {
    var _a2;
  ...
  return (r3, i3) => U(n2) ? (P(), W(`div`, { key: 0, class: L([`mobile-status-bar`, { "drawer-open": e2.isRouteDrawerOpen }]) }, [z(U(ut), { theme: U(mt) }, { default: E(() => [z(U(Mt), { size: 16, align: `center`, justify: `center` }, { default: E(() => [e2.isRecording && e2.recordTimespan ? (P(), W(`div`, Ya, [z(U(ot), { class: `status-label` }, { default: E(() => [j(N(U(t2)(`trackerView.statusBar.recordingTime`)) + `: `, 1)]), _: 1 }), z(U(ot), { class: `status-value recording-time` }, { default: E(() => [j(N(c2(e2.recordTimespan)), 1)]), _: 1 })])) : F(``, true), o2.value > 0 ? (P(), W(`div`, Xa, [z(U(ot), { class: `status-label` }, { default: E(() => [j(N(U(t2)(`trackerView.statusBar.distance`)) + `: `, 1)]), _: 1 }), z(U(ot), { class: `status-value` }, { default: E(() => [j(N(l2(o2.value)), 1)]), _: 1 })])) : F(``, true), e2.isRecording && s2.value && e2.currentLocation ? (P(), W(`div`, Za, [z(U(ot), { class: `status-label` }, { default: E(() => [j(N(U(t2)(`trackerView.statusBar.kalmanGain`)) + `: `, 1)]), _: 1 }), z(U(ot), { class: `status-value kalman-gain` }, { default: E(() => [j(N(s2.value), 1)]), _: 1 })])) : F(``, true), V(`div`, Qa, [z(U(ot), { class: `status-label` }, { default: E(() => [j(N(U(t2)(`trackerView.statusBar.gps`)) + `: `, 1)]), _: 1 }), z(U(ot), { class: L([`status-value`, `gps-status`, e2.currentLocation ? `gps-active` : `gps-inactive`]) }, { default: E(() => [j(N(e2.currentLocation ? `GPS` : `No GPS`), 1)]), _: 1 }, 8, [`class`])])]), _: 1 })]), _: 1 }, 8, [`theme`])], 2)) : F(``, true);
} }), [[`__scopeId`, `data-v-d7ab4f5e`]]), eo = H(I({ __name: `BuildingLayerToggle`, props: { isShowingBuildingLayer: { type: Boolean } }, emits: [`toggle`], setup(e2, { emit: t2 }) {
  let n2 = t2, r2 = () => {
    n2(`toggle`);
  };
  return (t3, n3) => (P(), A(U(le), { position: `top-left` }, { default: E(() => [V(`button`, { class: L([`btn-control`, { active: e2.isShowingBuildingLayer }]), onClick: r2 }, [z(U(G), { size: 20 }, { default: E(() => [z(U(Ut))]), _: 1 })], 2)]), _: 1 }));
} }), [[`__scopeId`, `data-v-c189f5ba`]]), to = H(I({ __name: `CurrentLocationToggle`, props: { locator: {}, isWatchingCurrentLocation: { type: Boolean } }, emits: [`toggle`], setup(e2, { emit: t2 }) {
  new jt().isMobile;
  let n2 = t2, r2 = () => {
    n2(`toggle`);
  };
  return (t3, n3) => (P(), A(U(le), { position: `top-left` }, { default: E(() => [e2.locator.isUsingGPS() ? (P(), W(`button`, { key: 0, class: L([`btn-control`, { active: e2.isWatchingCurrentLocation }]), onClick: r2 }, [z(U(G), { size: 20 }, { default: E(() => [z(U(Gt))]), _: 1 })], 2)) : F(``, true)]), _: 1 }));
} }), [[`__scopeId`, `data-v-28daf92a`]]), no = { class: `popover-header` }, ro = { style: { display: `inline-block`, width: `100%` } }, io = { class: `feature-edit-popover` }, ao = H(I({ __name: `FeatureEditPopover`, props: { show: { type: Boolean }, x: {}, y: {}, name: {}, description: {} }, emits: [`update:show`, `update:name`, `update:description`, `save`], setup(e2, { emit: t2 }) {
  let n2 = e2, r2 = t2, i2 = k(false), a2 = k(false), o2 = k(null), s2 = k(null), c2 = k(``), l2 = k(``);
  ...
  return (t3, n3) => (P(), A(U(Se), { show: e2.show, x: e2.x, y: e2.y, trigger: `manual`, placement: `bottom` }, { header: E(() => [V(`div`, no, [V(`div`, ro, [z(Fe, { mode: `out-in`, name: `slide-up` }, { default: E(() => [i2.value ? (P(), A(U(fe), { key: 1, style: { position: `relative` }, ref_key: `nameInputRef`, ref: o2, value: c2.value, "onUpdate:value": n3[0] || (n3[0] = (e3) => c2.value = e3), placeholder: `Name`, autofocus: ``, onBlur: f2, onKeydown: ze(f2, [`enter`]) }, null, 8, [`value`])) : (P(), W(`div`, { key: 0, class: `popover-name`, onClick: Ae(u2, [`prevent`]), onTouchend: Ae(u2, [`prevent`]) }, N(e2.name || `Untitled`), 33))]), _: 1 })]), z(U(xt), { quaternary: ``, circle: ``, size: `small`, onClick: m2 }, { default: E(() => [z(U(G), { size: 14 }, { default: E(() => [z(U(on))]), _: 1 })]), _: 1 })])]), default: E(() => [V(`div`, io, [z(Fe, { mode: `out-in`, name: `slide-up` }, { default: E(() => [a2.value ? (P(), A(U(fe), { key: 1, ref_key: `descriptionInputRef`, ref: s2, value: l2.value, "onUpdate:value": n3[1] || (n3[1] = (e3) => l2.value = e3), type: `textarea`, placeholder: `Description`, rows: 3, onBlur: p2 }, null, 8, [`value`])) : (P(), W(`div`, { key: 0, class: L([`popover-description`, { "is-empty": !e2.description }]), onClick: Ae(d2, [`prevent`]), onTouchend: Ae(d2, [`prevent`]) }, N(e2.description || `Add description...`), 35))]), _: 1 })])]), _: 1 }, 8, [`show`, `x`, `y`]));
} }), [[`__scopeId`, `data-v-fdb32e52`]]), oo = { class: `map-layout-container` }, so = { class: `map-layout` }, co = { key: 0, style: { width: `100%`, height: `100%` } }, lo = [`title`], uo = { style: { zIndex: 99, position: `absolute`, right: `4px`, top: `16em` } }, fo = { key: 1, style: { width: `100%`, height: `100%`, display: `grid`, "place-content": `center` } }, po = H(I({ __name: `TrackerView`, setup(e2) {
  Ue((e3) => {
    var _a2;
    return { v3e183324: (_a2 = U(mt).Button.common) == null ? void 0 : _a2.successColorSuppl, e1df6b10: U(n2).boxShadow3, v571c5f8e: U(n2).borderRadius, v3bd0ece7: U(n2).borderColor };
  });
  let t2 = new jt().isMobile, n2 = Nt(), r2 = Lr(), i2 = st(), a2 = ie(), o2 = nt(`geolocation`), { t: s2 } = lt(), c2 = Ge(null), l2 = cr();
  l2.setLocator(o2);
  let u2 = nt(`noSleep`), d2 = R(() => {
    var _a2;
    return l2.currentRouteId && ((_a2 = l2.routes.find((e3) => e3.id === l2.currentRouteId)) == null ? void 0 : _a2.points) || [];
  }), f2 = k(false), p2 = R(() => d2.value.length > 1 || d2.value.length === 0 ? { type: `FeatureCollection`, features: [{ type: `Feature`, properties: { description: l2.currentRouteId }, geometry: { type: `LineString`, coordinates: d2.value.map((e3) => [e3.longitude, e3.latitude]) } }] } : { type: `FeatureCollection`, features: [] }), m2 = Ge(null), h2 = k(false), g2 = k(true), _2 = /* @__PURE__ */ (() => {
    let e3 = true;
    return async function() {
      try {
        l2.isRecording || (e3 = l2.currentRouteId === null), await l2.toggleRecording(s2), !l2.isRecording && e3 && (ae2.value = true, setTimeout(() => {
          ae2.value = false;
  ...
  let ne2 = k(0), T2 = k(false);
  O(T2, (e3) => {
    var _a2;
    let n3 = (_a2 = c2.value) == null ? void 0 : _a2.map;
    n3 && n3.easeTo({ padding: t2 ? { bottom: e3 ? ne2.value : 0 } : { left: e3 ? ne2.value : 0 }, duration: 500 });
  });
  let re2 = () => T2.value = !T2.value, ae2 = k(false), oe2 = k(false), se2 = R(() => i2.sketches.map((e3) => ({ name: e3.meta.name, id: e3.id, tags: e3.meta.tags }))), ce2 = (e3) => {
    let t3 = i2.sketches.find((t4) => t4.id === e3);
    i2.setCurrentSketchId(e3), oe2.value = false, a2.success(s2(`sketchEdit.switchSuccess`, { sketch: t3 == null ? void 0 : t3.meta.name }));
  }, de2 = async (e3) => {
    await i2.deleteSketch(e3);
  }, fe2 = k(false), me2 = k(0), he2 = k(false), { bearing: ge2, isTracking: _e2, isSupported: ve2, error: ye2, startTracking: be2 } = ar({ autoStart: true });
  O(ge2, (e3) => {
    me2.value = e3;
  }), Me(async () => {
  ...
  let xe2 = k(null);
  setInterval(() => {
    xe2.value = o2.getLastKalmanGain();
  });
  let Ce2 = 0, we2 = (e3) => {
    var _a2;
  ...
  }), (e3, n3) => (P(), W(`div`, oo, [V(`div`, so, [z(Fe, { name: `map-load` }, { default: E(() => [fe2.value ? (P(), W(`div`, co, [z(ja, { ref_key: `mapContainerRef`, ref: c2, "style-url": `https://api.maptiler.com/maps/basic-v2/style.json?key=dCeXFrS9lgSF8hm5C6nm`, "geojson-source": p2.value, "on-map-init": Ee2, "on-map-touch-start": De2, "on-map-touch-end": Oe2, "on-map-click": ke2 }, { default: E(() => {
    var _a2, _b, _c, _d, _e3;
    return [z(Ma), z(to, { locator: U(o2), "is-watching-current-location": g2.value, onToggle: Ie2 }, null, 8, [`locator`, `is-watching-current-location`]), z(eo, { "is-showing-building-layer": h2.value, onToggle: Le2 }, null, 8, [`is-showing-building-layer`]), z(Ua, { "active-draw-method": ((_a2 = m2.value) == null ? void 0 : _a2.activeDrawMethod.value) ?? `select`, "can-undo": (_b = m2.value) == null ? void 0 : _b.canUndo.value, "can-redo": (_c = m2.value) == null ? void 0 : _c.canRedo.value, onSetDrawMode: Ae2, onUndo: je2, onRedo: Ne2, onClearAll: Pe2 }, null, 8, [`active-draw-method`, `can-undo`, `can-redo`]), z(ao, { show: v2.value, x: y2.value, y: b2.value, name: ((_d = m2.value) == null ? void 0 : _d.selectedFeatureName.value) ?? ``, description: ((_e3 = m2.value) == null ? void 0 : _e3.selectedFeatureDescription.value) ?? ``, "onUpdate:show": n3[0] || (n3[0] = (e4) => v2.value = e4), "onUpdate:name": x2, "onUpdate:description": S2, onSave: C2 }, null, 8, [`show`, `x`, `y`, `name`, `description`]), z(U(le), { position: `bottom-left` }, { default: E(() => [z(U(Se), { trigger: `manual`, show: false }, { trigger: E(() => [V(`button`, { class: L([`btn-control`, { active: oe2.value }]), onClick: n3[1] || (n3[1] = (e4) => oe2.value = true), title: U(s2)(`sketchEdit.cartoSketchLibrary`) }, [z(U(G), { size: 24 }, { default: E(() => [z(U(qt))]), _: 1 })], 10, lo)]), _: 1 }), z(U(Se), { trigger: `manual`, show: ae2.value }, { trigger: E(() => [V(`button`, { class: L([`btn-control`, { active: T2.value }]), onClick: re2 }, [z(U(G), { size: 24 }, { default: E(() => [z(U(pe))]), _: 1 })], 2)]), default: E(() => [V(`span`, null, N(U(s2)(`trackerView.uiRouteCheckoutTip`)), 1)]), _: 1 }, 8, [`show`])]), _: 1 }), z(qa, { "is-watching-current-location": g2.value, "device-bearing": U(r2).isTrackingOrientation ? 0 : (me2.value - U(r2).bearing) % 360 }, null, 8, [`is-watching-current-location`, `device-bearing`]), F(``, true)];
  }), _: 1 }, 8, [`geojson-source`]), V(`div`, uo, [U(t2) ? (P(), A(sr, { key: 0, bearing: U(r2).bearing, "onUpdate:bearing": n3[2] || (n3[2] = (e4) => U(r2).bearing = e4), tracking: U(r2).isTrackingOrientation, onToggleTracking: Te2 }, null, 8, [`bearing`, `tracking`])) : F(``, true)])])) : (P(), W(`div`, fo, [z(U(En), { size: `large` }, { description: E(() => [z(U(ot), null, { default: E(() => [j(N(U(s2)(`trackerView.mapLoading`)), 1)]), _: 1 })]), _: 1 })]))]), _: 1 })]), z(dr, { show: f2.value, "onUpdate:show": n3[3] || (n3[3] = (e4) => f2.value = e4), types: [`application/json`, `text/plain`], onConfirm: w2.value }, null, 8, [`show`, `onConfirm`]), z(Ir, { show: T2.value, "onUpdate:show": n3[4] || (n3[4] = (e4) => T2.value = e4), "onUpdate:width": n3[5] || (n3[5] = (e4) => ne2.value = e4) }, { "bottom-floating": E(() => [z(U(ut), { theme: U(mt) }, { default: E(() => [d2.value.length > 1 ? (P(), A(U(xt), { key: 0, size: `large`, type: `success`, class: `drawer-floating-button`, onClick: te2 }, { default: E(() => [...n3[8] || (n3[8] = [j(` Follow `, -1)])]), _: 1 })) : F(``, true)]), _: 1 }, 8, [`theme`])]), _: 1 }, 8, [`show`]), z(Ja, { "is-recording": U(l2).isRecording, "record-timespan": U(l2).currentRouteRecordTimespan, "is-route-drawer-open": T2.value, onToggleRecording: U(_2) }, null, 8, [`is-recording`, `record-timespan`, `is-route-drawer-open`, `onToggleRecording`]), z($a, { "is-recording": U(l2).isRecording, "record-timespan": U(l2).currentRouteRecordTimespan, "is-route-drawer-open": T2.value, "current-location": U(o2).getLastKnownLocation() }, null, 8, [`is-recording`, `record-timespan`, `is-route-drawer-open`, `current-location`]), z(ue, { active: oe2.value, "onUpdate:active": n3[6] || (n3[6] = (e4) => oe2.value = e4), list: se2.value, "active-id": U(i2).currentSketchId || ``, onSelect: ce2, onRemove: de2 }, null, 8, [`active`, `list`, `active-id`])]));
