import { a as G, E as A, s as N, C as I, t as p, n as Y, L as j, g as k, o as U, b as Z, i as B, f as D, u as M } from "./index-Dc21CMAg.js";
...
function pe(e, t) {
  ...
  return (n) => {
    ...
    if (l == "openTag") {
      ...
      let i = P(c, S);
      return i ? { from: d, to: n.pos + (c.sliceString(n.pos, n.pos + 1) == ">" ? 1 : 0), options: [(($ = f[i]) === null || $ === void 0 ? void 0 : $.closeNameCompletion) || { label: i + ">", type: "type" }], validFor: b } : null;
    } else if (l == "attrName") {
      let i = f[T(c, S)];
      ...
      if (S && (m == null ? void 0 : m.text.length)) {
        let x = S.firstChild;
...
const w = j.define({ name: "xml", parser: $e.configure({ props: [B.add({ Element(e) {
