...
import { N as e, o as t } from "./Card-wTK5VWgg.js";
import { Xt as n, a as r, d as i, f as a, p as o, zt as s } from "./index-C4uc8sCV.js";
import { i as c, n as l, r as u } from "./core-CbJDfFWz.js";
...
const m = r(`settings`, () => {
  ...
  return s(e2, r2, { deep: true }), { settings: e2, init: t2 };
});
var h = class {
  constructor() {
    __publicField(this, "parser");
    __publicField(this, "platformContext");
    this.parser = new o(navigator.userAgent), this.platformContext = a();
  }
  get isMobile() {
  ...
  get browser() {
    return i() ? `Tauri` : this.platformContext.browser || ``;
  }
  get engine() {
