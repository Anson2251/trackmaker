import { At as e, Rt as t, St as n, Xt as r, Yt as i, Zt as a, gt as o, mt as s, ot as c, qt as l, tn as u, vt as d } from "./index-Vl7drdoJ.js";
...
function $e(e2) {
  ...
  }), a2 = c(() => i2.value > -1 && rt(n2.params, r2.value.params)), o2 = c(() => i2.value > -1 && i2.value === n2.matched.length - 1 && N(n2.params, r2.value.params));
  function s2(n3 = {}) {
    if (nt(n3)) {
      let n4 = t2[u(e2.replace) ? `replace` : `push`](u(e2.to)).catch(_);
      return e2.viewTransition && typeof document < `u` && `startViewTransition` in document && document.startViewTransition(() => n4), n4;
    }
    return Promise.resolve();
  }
  return { route: r2, href: c(() => r2.value.href), isActive: a2, isExactActive: o2, navigate: s2 };
}
function et(e2) {
  return e2.length === 1 ? e2[0] : e2;
}
var tt = s({ name: `RouterLink`, compatConfig: { MODE: 3 }, props: { to: { type: [String, Object], required: true }, replace: Boolean, activeClass: String, exactActiveClass: String, custom: Boolean, ariaCurrentValue: { type: String, default: `page` }, viewTransition: Boolean }, useLink: $e, setup(e2, { slots: t2 }) {
  let n2 = l($e(e2)), { options: r2 } = d(J), i2 = c(() => ({ [at(e2.activeClass, r2.linkActiveClass, `router-link-active`)]: n2.isActive, [at(e2.exactActiveClass, r2.linkExactActiveClass, `router-link-exact-active`)]: n2.isExactActive }));
  return () => {
    let r3 = t2.default && et(t2.default(n2));
    return e2.custom ? r3 : o(`a`, { "aria-current": n2.isExactActive ? e2.ariaCurrentValue : null, href: n2.href, onClick: n2.navigate, class: i2.value }, r3);
  };
} });
function nt(e2) {
...
var at = (e2, t2, n2) => e2 ?? t2 ?? n2, ot = s({ name: `RouterView`, inheritAttrs: false, props: { name: { type: String, default: `default` }, route: Object }, compatConfig: { MODE: 3 }, setup(n2, { attrs: r2, slots: a2 }) {
  let s2 = d(Oe), l2 = c(() => n2.route || s2.value), f2 = d(Ee, 0), p2 = c(() => {
    let e2 = u(f2), { matched: t2 } = l2.value, n3;
    for (; (n3 = t2[e2]) && !n3.components; ) e2++;
    return e2;
  }), m2 = c(() => l2.value.matched[p2.value]);
  e(Ee, c(() => p2.value + 1)), e(Te, m2), e(Oe, l2);
  let g2 = i();
  return t(() => [g2.value, m2.value, n2.name], ([e2, t2, n3], [r3, i2, a3]) => {
    t2 && (t2.instances[n3] = e2, i2 && i2 !== t2 && e2 && e2 === r3 && (t2.leaveGuards.size || (t2.leaveGuards = i2.leaveGuards), t2.updateGuards.size || (t2.updateGuards = i2.updateGuards))), e2 && t2 && (!i2 || !M(t2, i2) || !r3) && (t2.enterCallbacks[n3] || []).forEach((t3) => t3(e2));
  }, { flush: `post` }), () => {
    let e2 = l2.value, t2 = n2.name, i2 = m2.value, s3 = i2 && i2.components[t2];
    if (!s3) return st(a2.default, { Component: s3, route: e2 });
    let c2 = i2.props[t2], u2 = o(s3, h({}, c2 ? c2 === true ? e2.params : typeof c2 == `function` ? c2(e2) : c2 : null, r2, { onVnodeUnmounted: (e3) => {
      e3.component.isUnmounted && (i2.instances[t2] = null);
    }, ref: g2 }));
...
var ct = ot;
function lt(e2) {
  let t2 = We(e2.routes, e2), i2 = e2.parseQuery || Se, o2 = e2.stringifyQuery || Ce, s2 = e2.history, c2 = Y(), l2 = Y(), d2 = Y(), p2 = a(I), m2 = I;
  ...
  function ne2(e3, n2) {
    let r2, i3;
    return be(e3) ? (r2 = t2.getRecordMatcher(e3), i3 = n2) : i3 = e3, t2.addRoute(i3, r2);
  }
  function re2(e3) {
    let n2 = t2.getRecordMatcher(e3);
    n2 && t2.removeRoute(n2);
  }
  function ie2() {
  ...
  function b2(e3, n2) {
    if (n2 = h({}, n2 || p2.value), typeof e3 == `string`) {
      let r3 = j(i2, e3, n2.path), a3 = t2.resolve({ path: r3.path }, n2), o3 = s2.createHref(r3.fullPath);
      return h(r3, a3, { params: te2(a3.params), hash: k(r3.hash), redirectedFrom: void 0, href: o3 });
    }
    let r2;
    if (e3.path != null) r2 = h({}, e3, { path: j(i2, e3.path, n2.path).path });
    else {
      let t3 = h({}, e3.params);
      for (let e4 in t3) t3[e4] ?? delete t3[e4];
      r2 = h({}, e3, { params: y2(t3) }), n2.params = y2(n2.params);
    }
    let a2 = t2.resolve(r2, n2), c3 = e3.hash || ``;
    a2.params = ee2(te2(a2.params));
    let l3 = fe(o2, h({}, e3, { hash: ce(c3), path: a2.path })), u2 = s2.createHref(l3);
    return h({ fullPath: l3, hash: c3, query: o2 === Ce ? we(e3.query) : e3.query || {} }, a2, { redirectedFrom: void 0, href: u2 });
  }
  function x2(e3) {
    return typeof e3 == `string` ? j(i2, e3, p2.value.path) : h({}, e3);
  }
  function S2(e3, t3) {
  ...
  function oe2(e3, t3) {
    let n2 = e3.matched[e3.matched.length - 1];
    if (n2 && n2.redirect) {
      let { redirect: r2 } = n2, i3 = typeof r2 == `function` ? r2(e3, t3) : r2;
      return typeof i3 == `string` && (i3 = i3.includes(`?`) || i3.includes(`#`) ? i3 = x2(i3) : { path: i3 }, i3.params = {}), h({ query: e3.query, hash: e3.hash, params: i3.path == null ? e3.params : {} }, i3);
    }
  }
  function T2(e3, t3) {
    let n2 = m2 = b2(e3), r2 = p2.value, i3 = e3.state, a2 = e3.force, s3 = e3.replace === true, c3 = oe2(n2, r2);
    if (c3) return T2(h(x2(c3), { state: typeof c3 == `object` ? h({}, i3, c3.state) : i3, force: a2, replace: s3 }), t3 || n2);
    let l3 = n2;
    l3.redirectedFrom = t3;
    let u2;
    return !a2 && pe(o2, r2, n2) && (u2 = K(G.NAVIGATION_DUPLICATED, { to: l3, from: r2 }), z2(r2, r2, true, false)), (u2 ? Promise.resolve(u2) : D2(l3, r2)).catch((e4) => q(e4) ? q(e4, G.NAVIGATION_GUARD_REDIRECT) ? e4 : R2(e4) : F2(e4, l3, r2)).then((e4) => {
      if (e4) {
        if (q(e4, G.NAVIGATION_GUARD_REDIRECT)) return T2(h({ replace: s3 }, x2(e4.to), { state: typeof e4.to == `object` ? h({}, i3, e4.to.state) : i3, force: a2 }), t3 || l3);
      } else e4 = O2(l3, r2, true, s3, i3);
      return le2(l3, r2, e4), e4;
    });
  }
  function se2(e3, t3) {
    let n2 = S2(e3, t3);
  ...
  function D2(e3, t3) {
    let n2, [r2, i3, a2] = Ae(e3, t3);
    n2 = ke(r2.reverse(), `beforeRouteLeave`, e3, t3);
    for (let i4 of r2) i4.leaveGuards.forEach((r3) => {
      n2.push(X(r3, e3, t3));
    });
    let o3 = se2.bind(null, e3, t3);
    return n2.push(o3), W2(n2).then(() => {
      n2 = [];
      for (let r3 of c2.list()) n2.push(X(r3, e3, t3));
      return n2.push(o3), W2(n2);
    }).then(() => {
      n2 = ke(i3, `beforeRouteUpdate`, e3, t3);
      ...
      n2 = [];
      for (let r3 of a2) if (r3.beforeEnter) if (v(r3.beforeEnter)) for (let i4 of r3.beforeEnter) n2.push(X(i4, e3, t3));
      else n2.push(X(r3.beforeEnter, e3, t3));
      return n2.push(o3), W2(n2);
    }).then(() => (e3.matched.forEach((e4) => e4.enterCallbacks = {}), n2 = ke(a2, `beforeRouteEnter`, e3, t3, E2), n2.push(o3), W2(n2))).then(() => {
      n2 = [];
      for (let r3 of l2.list()) n2.push(X(r3, e3, t3));
      return n2.push(o3), W2(n2);
    }).catch((e4) => q(e4, G.NAVIGATION_CANCELLED) ? e4 : Promise.reject(e4));
  }
  function le2(e3, t3, n2) {
    d2.list().forEach((r2) => E2(() => r2(e3, t3, n2)));
  }
  function O2(e3, t3, n2, r2, i3) {
    let a2 = S2(e3, t3);
    if (a2) return a2;
    let o3 = t3 === I, c3 = f ? history.state : {};
    n2 && (r2 || o3 ? s2.replace(e3.fullPath, h({ scroll: o3 && c3 && c3.scroll }, i3)) : s2.push(e3.fullPath, i3)), p2.value = e3, z2(e3, t3, n2, o3), R2();
  }
  let A2;
  function de2() {
    A2 || (A2 = s2.listen((e3, t3, n2) => {
      if (!U2.listening) return;
      let r2 = b2(e3), i3 = oe2(r2, U2.currentRoute.value);
      if (i3) {
        T2(h(i3, { replace: true, force: true }), r2).catch(_);
        return;
      }
      m2 = r2;
      let a2 = p2.value;
      f && ve(_e(a2.fullPath, n2.delta), he()), D2(r2, a2).catch((e4) => q(e4, G.NAVIGATION_ABORTED | G.NAVIGATION_CANCELLED) ? e4 : q(e4, G.NAVIGATION_GUARD_REDIRECT) ? (T2(h(x2(e4.to), { force: true }), r2).then((e5) => {
        q(e5, G.NAVIGATION_ABORTED | G.NAVIGATION_DUPLICATED) && !n2.delta && n2.type === L.pop && s2.go(-1, false);
      }).catch(_), Promise.reject()) : (n2.delta && s2.go(-n2.delta, false), F2(e4, r2, a2))).then((e4) => {
        e4 || (e4 = O2(r2, a2, false)), e4 && (n2.delta && !q(e4, G.NAVIGATION_CANCELLED) ? s2.go(-n2.delta, false) : n2.type === L.pop && q(e4, G.NAVIGATION_ABORTED | G.NAVIGATION_DUPLICATED) && s2.go(-1, false)), le2(r2, a2, e4);
      }).catch(_);
    }));
  }
  let M2 = Y(), N2 = Y(), P2;
  function F2(e3, t3, n2) {
    R2(e3);
    let r2 = N2.list();
    return r2.length ? r2.forEach((r3) => r3(e3, t3, n2)) : console.error(e3), Promise.reject(e3);
  }
  function me2() {
  ...
  function R2(e3) {
    return P2 || (P2 = !e3, de2(), M2.list().forEach(([t3, n2]) => e3 ? n2(e3) : t3()), M2.reset()), e3;
  }
  function z2(t3, r2, i3, a2) {
    let { scrollBehavior: o3 } = e2;
    if (!f || !o3) return Promise.resolve();
    let s3 = !i3 && ye(_e(t3.fullPath, 0)) || (a2 || !i3) && history.state && history.state.scroll || null;
    return n().then(() => o3(t3, r2, s3)).then((e3) => e3 && ge(e3)).catch((e3) => F2(e3, t3, r2));
  }
  let B2 = (e3) => s2.go(e3), V2, H2 = /* @__PURE__ */ new Set(), U2 = { currentRoute: p2, listening: true, addRoute: ne2, removeRoute: re2, clearRoutes: t2.clearRoutes, hasRoute: ae2, getRoutes: ie2, resolve: b2, options: e2, push: C2, replace: w2, go: B2, back: () => B2(-1), forward: () => B2(1), beforeEach: c2.add, beforeResolve: l2.add, afterEach: d2.add, onError: N2.add, isReady: me2, install(e3) {
    e3.component(`RouterLink`, tt), e3.component(`RouterView`, ct), e3.config.globalProperties.$router = U2, Object.defineProperty(e3.config.globalProperties, `$route`, { enumerable: true, get: () => u(p2) }), f && !V2 && p2.value === I && (V2 = true, C2(s2.location).catch((e4) => {
    }));
    let t3 = {};
    for (let e4 in I) Object.defineProperty(t3, e4, { get: () => p2.value[e4], enumerable: true });
    e3.provide(J, U2), e3.provide(De, r(t3)), e3.provide(Oe, p2);
    let n2 = e3.unmount;
    H2.add(e3), e3.unmount = function() {
      H2.delete(e3), H2.size < 1 && (m2 = I, A2 && A2(), A2 = null, p2.value = I, V2 = false, P2 = false), n2();
    };
  } };
  function W2(e3) {
