import { D as e, M as t, S as n, at as r, f as i, g as a, k as o, l as s, ot as c, u as l, ut as u, v as d, vt as f } from "./Card-Bg4yt5PU.js";
import { $ as p, G as m, N as h, O as g, Q as _, T as v, W as ee, Z as y, m as b, tt as x } from "./light-D-u69n34.js";
import { At as S, Bt as C, Dt as w, J as T, Jt as E, Lt as D, Qt as te, Rt as O, Tt as ne, Z as k, Zt as A, gt as j, mt as M, nn as re, ot as N, tt as P, vt as ie } from "./index-BXOrb7c0.js";
import { t as F } from "./fade-in-scale-up.cssr-B_Z8jf_c.js";
import { t as ae } from "./use-locale-CjFwo8gM.js";
import { t as oe } from "./light-BeU7yaA4.js";
import { t as se } from "./Tooltip-ukJ_2waB.js";
...
const tt = h && `loading` in document.createElement(`img`);
function nt(e2 = {}) {
  let { root: t2 = null } = e2;
...
var ft = r([r(`body >`, [c(`image-container`, `position: fixed;`)]), c(`image-preview-container`, `
 ...
 `)])]), $ = 32, pt = M({ name: `ImagePreview`, props: Object.assign(Object.assign({}, ut), { src: String, show: { type: Boolean, default: void 0 }, defaultShow: Boolean, "onUpdate:show": [Function, Array], onUpdateShow: [Function, Array], onNext: Function, onPrev: Function, onClose: [Function, Array] }), setup(t2) {
  let { src: n2 } = te(t2), { mergedClsPrefixRef: r2 } = d(t2), o2 = i(`Image`, `-image`, ft, oe, t2, r2), s2 = null, c2 = E(null), l2 = E(null), u2 = E(false), { localeRef: f2 } = ae(`Image`), p2 = E(t2.defaultShow), h2 = m(A(t2, `show`), p2);
  function g2() {
    let { value: e2 } = l2;
    if (!s2 || !e2) return;
  ...
  D(h2, (e2) => {
    e2 ? _(`keydown`, document, v2) : y(`keydown`, document, v2);
  }), ne(() => {
    y(`keydown`, document, v2);
  });
  let S2 = 0, C2 = 0, w2 = 0, T2 = 0, O2 = 0, k2 = 0, M2 = 0, P2 = 0, F2 = false;
  function ce2(e2) {
    let { clientX: t3, clientY: n3 } = e2;
    w2 = t3 - S2, T2 = n3 - C2, x(J2);
  }
  function le2(e2) {
  ...
  function ue2(e2) {
    ...
    F2 = true, S2 = r3 - w2, C2 = i2 - T2, O2 = w2, k2 = T2, M2 = r3, P2 = i2, J2(), _(`mousemove`, document, ce2), _(`mouseup`, document, L2);
  }
  ...
  function Y2() {
    if (h2.value) {
      let { onClose: n3 } = t2;
      n3 && e(n3), b2(false), p2.value = false;
    }
  }
  function _e2() {
  ...
  return Object.assign({ clsPrefix: r2, previewRef: c2, previewWrapperRef: l2, previewSrc: n2, mergedShow: h2, appear: ee(), displayed: u2, previewedImgProps: R2 == null ? void 0 : R2.previewedImgPropsRef, handleWheel: xe2, handlePreviewMousedown: ue2, handlePreviewDblclick: de2, syncTransformOrigin: g2, handleAfterLeave: () => {
  ...
  return j(P, null, (_a = (e2 = this.$slots).default) == null ? void 0 : _a.call(e2), j(v, { show: this.mergedShow }, { default: () => {
    var e3;
    ...
    } })), [[g, { enabled: this.mergedShow }]])) : null;
  } }));
} });
...
var ht = M({ name: `ImageGroup`, props: Object.assign(Object.assign({}, ut), { srcList: Array, current: Number, defaultCurrent: { type: Number, default: 0 }, show: { type: Boolean, default: void 0 }, defaultShow: Boolean, onUpdateShow: [Function, Array], "onUpdate:show": [Function, Array], onUpdateCurrent: [Function, Array], "onUpdate:current": [Function, Array] }), setup(t2) {
  let { mergedClsPrefixRef: n2 } = d(t2), r2 = `c${p()}`, i2 = E(null), a2 = E(t2.defaultShow), s2 = m(A(t2, `show`), a2), c2 = E(/* @__PURE__ */ new Map()), l2 = N(() => {
    if (t2.srcList) {
  ...
  let g2 = E(t2.defaultCurrent), _2 = m(A(t2, `current`), g2), v2 = (n3) => {
    if (n3 !== _2.value) {
      let { onUpdateCurrent: r3, "onUpdate:current": i3 } = t2;
      r3 && e(r3, n3), i3 && e(i3, n3), g2.value = n3;
    }
  }, ee2 = N(() => u2.value[_2.value]), y2 = (e2) => {
    let t3 = u2.value.indexOf(e2);
    t3 !== _2.value && v2(t3);
  }, b2 = N(() => l2.value.get(ee2.value));
  function x2(n3) {
  ...
  let w2 = N(() => {
    ...
    }, t3 = e2(_2.value + 1, f2() - 1);
    return t3 === void 0 ? e2(0, _2.value - 1) : t3;
  }), T2 = N(() => {
    let e2 = (e3, t4) => {
      for (let n3 = e3; n3 >= t4; n3--) {
        let e4 = u2.value[n3];
    ...
    return t3 === void 0 ? e2(f2() - 1, _2.value + 1) : t3;
  });
  function D2(e2) {
    var n3, r3;
    e2 === 1 ? (T2.value !== void 0 && v2(w2.value), (n3 = t2.onPreviewNext) == null || n3.call(t2)) : (w2.value !== void 0 && v2(T2.value), (r3 = t2.onPreviewPrev) == null || r3.call(t2));
  }
  return S(mt, { mergedClsPrefixRef: n2, registerImageUrl: h2, setThumbnailEl: (e2) => {
    var t3;
    (t3 = i2.value) == null || t3.setThumbnailEl(e2);
  }, toggleShow: (e2) => {
    x2(true), y2(e2);
  }, groupId: r2, renderToolbarRef: A(t2, `renderToolbar`) }), { mergedClsPrefix: n2, previewInstRef: i2, mergedShow: s2, src: b2, onClose: C2, next: () => {
    D2(1);
  }, prev: () => {
    D2(-1);
  } };
