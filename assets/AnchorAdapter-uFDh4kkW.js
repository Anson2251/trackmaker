import { E as e, M as t, S as n, at as r, ct as i, f as a, g as o, lt as s, ot as c, p as l, ut as u, v as d } from "./Card-wTK5VWgg.js";
import { Q as f, Y as p, it as m, p as h, y as g } from "./light-DcazuQOY.js";
import { $t as _, Ct as v, Et as y, Ot as b, Xt as x, _t as S, ht as C, jt as w, st as T, yt as E, zt as D } from "./index-C4uc8sCV.js";
import { n as O, r as k } from "./use-locale-DV3hbGtr.js";
import { t as A } from "./attribute-CvS_LNHW.js";
import { t as j } from "./light-B-J6tIen.js";
function M(e2) {
...
var R = C({ name: `Affix`, props: I, setup(e2) {
  let { mergedClsPrefixRef: t2 } = d(e2);
  l(`-affix`, N, t2);
  let n2 = null, r2 = x(false), i2 = x(false), a2 = x(null), o2 = x(null), s2 = T(() => i2.value || r2.value), c2 = T(() => e2.triggerTop ?? e2.offsetTop ?? e2.top), u2 = T(() => e2.top ?? e2.triggerTop ?? e2.offsetTop), f2 = T(() => e2.bottom ?? e2.triggerBottom ?? e2.offsetBottom), p2 = T(() => e2.triggerBottom ?? e2.offsetBottom ?? e2.bottom), h2 = x(null), g2 = () => {
  ...
  function v2() {
    ...
    let l2 = F(n2), u3 = e3.getBoundingClientRect(), d2 = u3.top - l2.top, f3 = l2.bottom - u3.bottom, m2 = c2.value, g3 = p2.value;
    m2 !== void 0 && d2 <= m2 ? (r2.value = true, o2.value = t3 - (m2 - d2)) : (r2.value = false, o2.value = null), g3 !== void 0 && f3 <= g3 ? (i2.value = true, a2.value = t3 + g3 - f3) : (i2.value = false, a2.value = null);
  }
  return b(() => {
    g2();
  }), y(() => {
    n2 && n2.removeEventListener(`scroll`, _2);
  }), { selfRef: h2, affixed: s2, mergedClsPrefix: t2, mergedstyle: T(() => {
    let e3 = {};
  ...
  return S(`div`, { ref: `selfRef`, class: [`${e2}-affix`, { [`${e2}-affix--affixed`]: this.affixed, [`${e2}-affix--absolute-positioned`]: this.position === `absolute` }], style: this.mergedstyle }, this.$slots);
} });
const z = t(`n-anchor`);
var B = C({ name: `AnchorLink`, props: { title: String, href: String }, slots: Object, setup(e2, { slots: t2 }) {
  let r2 = x(null), i2 = E(z), a2 = _(e2, `href`), o2 = f(() => a2.value && a2.value === i2.activeHref.value);
  O(z, `collectedLinkHrefs`, a2), k(z, `titleEls`, () => r2.value), D(o2, (e3) => {
  ...
  return () => {
    ...
    return S(`div`, { class: [`${a3}-anchor-link`, o2.value && `${a3}-anchor-link--active`] }, S(`a`, { ref: r2, class: [`${a3}-anchor-link__title`], href: e2.href, title: A(e2.title), onClick: s2 }, { default: () => n(t2.title, () => [e2.title]) }), (_a = t2.default) == null ? void 0 : _a.call(t2));
  };
} });
function V(e2, t2) {
...
var W = C({ name: `BaseAnchor`, props: Object.assign(Object.assign({}, H), { mergedClsPrefix: { type: String, required: true } }), setup(e2) {
  let t2 = [], n2 = [], r2 = x(null), i2 = x(null), a2 = x(null), o2 = x(null), s2 = false, c2 = T(() => e2.type === `block`), l2 = T(() => !c2.value && e2.showRail);
  function u2() {
  ...
  function d2(e3, t3 = true) {
    ...
    let { offsetHeight: c3, offsetWidth: l3 } = e3, { top: u3, left: d3 } = e3.getBoundingClientRect(), { top: f3, left: p2 } = s3.getBoundingClientRect(), m3 = u3 - f3, h3 = d3 - p2;
  ...
  return w(z, { activeHref: r2, mergedClsPrefix: _(e2, `mergedClsPrefix`), updateBarPosition: d2, setActiveHref: S2, collectedLinkHrefs: t2, titleEls: n2 }), b(() => {
    document.addEventListener(`scroll`, g2, true), S2(window.location.hash), C2(false);
  }), p(() => {
    S2(window.location.hash), C2(false);
  }), y(() => {
  ...
  }), { selfRef: o2, barRef: a2, slotRef: i2, setActiveHref: S2, activeHref: r2, isBlockType: c2, mergedShowRail: l2 };
}, render() {
  var _a;
  let { mergedClsPrefix: e2, mergedShowRail: t2, isBlockType: n2, $slots: r2 } = this, i2 = S(`div`, { class: [`${e2}-anchor`, n2 && `${e2}-anchor--block`, t2 && `${e2}-anchor--show-rail`], ref: `selfRef` }, t2 && this.showBackground ? S(`div`, { ref: `slotRef`, class: `${e2}-anchor-link-background` }) : null, t2 ? S(`div`, { class: `${e2}-anchor-rail` }, S(`div`, { ref: `barRef`, class: [`${e2}-anchor-rail__bar`, this.activeHref !== null && `${e2}-anchor-rail__bar--active`] })) : null, (_a = r2.default) == null ? void 0 : _a.call(r2));
  return this.internalScrollable ? S(h, null, { default: () => i2 }) : i2;
} }), G = c(`anchor`, `
 position: relative;
`, [u(`block`, `
 ...
 `)])])]), K = C({ name: `Anchor`, props: Object.assign(Object.assign(Object.assign(Object.assign({}, a.props), { affix: Boolean }), I), H), setup(e2, { slots: t2 }) {
  let { mergedClsPrefixRef: n2, inlineThemeDisabled: r2 } = d(e2), i2 = a(`Anchor`, `-anchor`, G, j, e2, n2), s2 = x(null), c2 = T(() => {
  ...
  }, renderAnchor: () => (l2 == null ? void 0 : l2.onRender(), S(W, Object.assign({ ref: s2, style: r2 ? void 0 : c2.value, class: l2 == null ? void 0 : l2.themeClass.value }, g(e2, U), { mergedClsPrefix: n2.value }), t2)) };
}, render() {
  return this.affix ? S(R, Object.assign({}, g(this, L)), { default: this.renderAnchor }) : this.renderAnchor();
} });
export {
  B as n,
  K as t
