import { S as e, at as t, ct as n, l as r, ot as i, p as a, u as o } from "./Card-BhZanKs1.js";
import { Zt as s, gt as c, mt as l } from "./index-CkQURd6u.js";
import { C as u, T as d, w as f } from "./core-BTtElCLw.js";
...
`, [t(`>`, [n(`clear`, `
 ...
 `, [f({ originalTransform: `translateX(-50%) translateY(-50%)`, left: `50%`, top: `50%` })])])]), g = l({ name: `BaseClear`, props: { clsPrefix: { type: String, required: true }, show: Boolean, onClear: Function }, setup(e2) {
  return a(`-base-clear`, h, s(e2, `clsPrefix`)), { handleMouseDown(e3) {
    e3.preventDefault();
  } };
}, render() {
  let { clsPrefix: t2 } = this;
  return c(`div`, { class: `${t2}-base-clear` }, c(d, null, { default: () => {
    var _a;
    var n2;
  ...
  return () => {
    let { clsPrefix: r2 } = t2;
    return c(u, { clsPrefix: r2, class: `${r2}-base-suffix`, strokeWidth: 24, scale: 0.85, show: t2.loading }, { default: () => t2.showArrow ? c(g, { clsPrefix: r2, show: t2.showClear, onClear: t2.onClear }, { placeholder: () => c(o, { clsPrefix: r2, class: `${r2}-base-suffix__arrow` }, { default: () => e(n2.default, () => [c(p, null)]) }) }) : null });
  };
} });
export {
  g as n,
