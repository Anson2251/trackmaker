import { D as e, E as t, L as n, M as r, N as i, P as a, R as o, a as s, at as c, b as l, c as u, ct as d, d as f, dt as p, f as m, g as h, gt as g, h as _, lt as v, m as y, o as b, ot as x, s as S, u as C, ut as w, v as T } from "./Card-wTK5VWgg.js";
import { J as ee, K as te, Q as E, T as D, X as O, a as ne, c as re, f as ie, g as ae, n as oe, nt as se, r as ce, s as le, y as ue } from "./light-DcazuQOY.js";
import { $t as de, At as k, Bt as fe, Et as pe, J as me, Jt as he, Ot as ge, Pt as _e, St as ve, Tt as ye, Vt as A, Xt as j, Yt as be, Z as xe, _t as M, a as Se, an as Ce, cn as we, ct as N, dt as Te, ht as P, it as Ee, jt as F, kt as De, lt as Oe, mt as I, nn as L, nt as ke, on as Ae, pt as je, rn as Me, rt as Ne, st as R, t as Pe, ut as Fe, yt as z, zt as Ie } from "./index-C4uc8sCV.js";
import { a as Le, n as Re, t as ze } from "./vue-router-DrjvI5Sn.js";
import { a as Be, i as Ve, o as He, r as Ue, t as We } from "./interface-Xd0kpMGt.js";
import { A as Ge, B as Ke, C as qe, D as Je, E as Ye, F as Xe, H as Ze, L as Qe, M as $e, N as et, O as tt, S as nt, T as rt, V as it, _ as at, a as ot, b as st, d as ct, g as lt, j as ut, n as dt, p as ft, s as pt, t as mt, v as ht, x as gt, y as _t } from "./sketch-store-9vGlGD5C.js";
import { n as vt } from "./vue-i18n-BmCNrBEx.js";
import { A as yt, B as bt, C as xt, D as St, E as Ct, F as wt, G as Tt, H as Et, I as Dt, K as Ot, L as kt, M as At, N as jt, O as Mt, P as Nt, R as Pt, S as Ft, T as It, U as Lt, V as Rt, W as zt, _ as Bt, a as Vt, b as Ht, c as Ut, d as Wt, f as Gt, g as Kt, i as qt, j as Jt, k as Yt, l as Xt, m as Zt, n as Qt, o as $t, p as en, q as tn, r as nn, t as rn, u as an, v as on, w as sn, x as cn } from "./light-JWLB23nK.js";
import { t as ln } from "./src-CEwt1Saz.js";
import { C as un, O as B, T as dn, b as fn, c as pn, f as mn, g as hn, l as gn, o as _n, t as vn, v as yn, w as bn, x as xn, y as Sn } from "./core-CbJDfFWz.js";
import { r as Cn } from "./light-DsJhCZoU.js";
import { i as wn, n as Tn, r as En, t as Dn } from "./Warning-K65bQFBL.js";
import { n as On } from "./light-BUxPVHlh.js";
import { t as kn } from "./fade-in-height-expand.cssr-OlKElAPL.js";
import { n as An } from "./light-B-J6tIen.js";
import { i as jn, n as Mn, t as Nn } from "./platform-AaRxPU_D.js";
import { t as Pn } from "./PerformantEllipsis-Du1-qbTc.js";
import { a as Fn, n as In, r as Ln } from "./light-DB6RNQmt.js";
import { n as Rn } from "./light-Ca1mwIGX.js";
import { n as zn } from "./light-BJk0FjVD.js";
import { n as Bn } from "./light-27ybxbZP.js";
var Vn = { xmlns: `http://www.w3.org/2000/svg`, "xmlns:xlink": `http://www.w3.org/1999/xlink`, viewBox: `0 0 24 24` }, Hn = P({ name: `Menu`, render: function(e2, t2) {
  return k(), Te(`svg`, Vn, t2[0] || (t2[0] = [N(`g`, { fill: `none`, stroke: `currentColor`, "stroke-width": `2`, "stroke-linecap": `round`, "stroke-linejoin": `round` }, [N(`path`, { d: `M4 8h16` }), N(`path`, { d: `M4 16h16` })], -1)]));
} }), Un = 0, Wn = typeof window < `u` && window.matchMedia !== void 0, V = j(null), H, U;
function Gn(e2) {
  e2.matches && (V.value = `dark`);
}
function Kn(e2) {
  e2.matches && (V.value = `light`);
}
function qn() {
  H = window.matchMedia(`(prefers-color-scheme: dark)`), U = window.matchMedia(`(prefers-color-scheme: light)`), H.matches ? V.value = `dark` : U.matches ? V.value = `light` : V.value = null, H.addEventListener ? (H.addEventListener(`change`, Gn), U.addEventListener(`change`, Kn)) : H.addListener && (H.addListener(Gn), U.addListener(Kn));
}
function Jn() {
  `removeEventListener` in H ? (H.removeEventListener(`change`, Gn), U.removeEventListener(`change`, Kn)) : `removeListener` in H && (H.removeListener(Gn), U.removeListener(Kn)), H = void 0, U = void 0;
}
var Yn = true;
function Xn() {
  return Wn ? (Un === 0 && qn(), Yn && (Yn = O()) && (ye(() => {
    Un += 1;
  }), pe(() => {
    --Un, Un === 0 && Jn();
  })), be(V)) : be(V);
}
var Zn = P({ name: `ChevronDownFilled`, render() {
...
var K = Object.assign(Object.assign({ name: `common` }, y), { baseColor: W.neutralBase, primaryColor: W.primaryDefault, primaryColorHover: W.primaryHover, primaryColorPressed: W.primaryActive, primaryColorSuppl: W.primarySuppl, infoColor: W.infoDefault, infoColorHover: W.infoHover, infoColorPressed: W.infoActive, infoColorSuppl: W.infoSuppl, successColor: W.successDefault, successColorHover: W.successHover, successColorPressed: W.successActive, successColorSuppl: W.successSuppl, warningColor: W.warningDefault, warningColorHover: W.warningHover, warningColorPressed: W.warningActive, warningColorSuppl: W.warningSuppl, errorColor: W.errorDefault, errorColorHover: W.errorHover, errorColorPressed: W.errorActive, errorColorSuppl: W.errorSuppl, textColorBase: W.neutralTextBase, textColor1: G(W.alpha1), textColor2: G(W.alpha2), textColor3: G(W.alpha3), textColorDisabled: G(W.alpha4), placeholderColor: G(W.alpha4), placeholderColorDisabled: G(W.alpha5), iconColor: G(W.alpha4), iconColorDisabled: G(W.alpha5), iconColorHover: G(Number(W.alpha4) * 1.25), iconColorPressed: G(Number(W.alpha4) * 0.8), opacity1: W.alpha1, opacity2: W.alpha2, opacity3: W.alpha3, opacity4: W.alpha4, opacity5: W.alpha5, dividerColor: G(W.alphaDivider), borderColor: G(W.alphaBorder), closeIconColorHover: G(Number(W.alphaClose)), closeIconColor: G(Number(W.alphaClose)), closeIconColorPressed: G(Number(W.alphaClose)), closeColorHover: `rgba(255, 255, 255, .12)`, closeColorPressed: `rgba(255, 255, 255, .08)`, clearColor: G(W.alpha4), clearColorHover: o(G(W.alpha4), { alpha: 1.25 }), clearColorPressed: o(G(W.alpha4), { alpha: 0.8 }), scrollbarColor: G(W.alphaScrollbar), scrollbarColorHover: G(W.alphaScrollbarHover), scrollbarWidth: `5px`, scrollbarHeight: `5px`, scrollbarBorderRadius: `5px`, progressRailColor: G(W.alphaProgressRail), railColor: G(W.alphaRail), popoverColor: W.neutralPopover, tableColor: W.neutralCard, cardColor: W.neutralCard, modalColor: W.neutralModal, bodyColor: W.neutralBody, tagColor: tr(W.alphaTag), avatarColor: G(W.alphaAvatar), invertedColor: W.neutralBase, inputColor: G(W.alphaInput), codeColor: G(W.alphaCode), tabColor: G(W.alphaTab), actionColor: G(W.alphaAction), tableHeaderColor: G(W.alphaAction), hoverColor: G(W.alphaPending), tableColorHover: G(W.alphaTablePending), tableColorStriped: G(W.alphaTableStriped), pressedColor: G(W.alphaPressed), opacityDisabled: W.alphaDisabled, inputColorDisabled: G(W.alphaDisabledInput), buttonColor2: `rgba(255, 255, 255, .08)`, buttonColor2Hover: `rgba(255, 255, 255, .12)`, buttonColor2Pressed: `rgba(255, 255, 255, .08)`, boxShadow1: `0 1px 2px -2px rgba(0, 0, 0, .24), 0 3px 6px 0 rgba(0, 0, 0, .18), 0 5px 12px 4px rgba(0, 0, 0, .12)`, boxShadow2: `0 3px 6px -4px rgba(0, 0, 0, .24), 0 6px 12px 0 rgba(0, 0, 0, .16), 0 9px 18px 8px rgba(0, 0, 0, .10)`, boxShadow3: `0 6px 16px -9px rgba(0, 0, 0, .08), 0 9px 28px 0 rgba(0, 0, 0, .05), 0 12px 48px 16px rgba(0, 0, 0, .03)` }), q = { name: `Scrollbar`, common: K, self: ae }, J = { name: `Empty`, common: K, self: fn }, nr = { name: `InternalSelectMenu`, common: K, peers: { Scrollbar: q, Empty: J }, self: yn }, Y = { name: `Popover`, common: K, peers: { Scrollbar: q }, self: ie }, rr = { name: `Tag`, common: K, self(e2) {
  ...
  return Object.assign(Object.assign({}, On), { fontSize: v2, lineHeight: t2, titleFontWeight: r2, borderRadius: n2, border: `1px solid ${a2}`, color: o2, titleTextColor: s2, iconColor: c2, contentTextColor: c2, closeBorderRadius: n2, closeColorHover: l2, closeColorPressed: u2, closeIconColor: d2, closeIconColorHover: f2, closeIconColorPressed: p2, borderInfo: `1px solid ${i(m2, { alpha: 0.35 })}`, colorInfo: i(m2, { alpha: 0.25 }), titleTextColorInfo: s2, iconColorInfo: m2, contentTextColorInfo: c2, closeColorHoverInfo: l2, closeColorPressedInfo: u2, closeIconColorInfo: d2, closeIconColorHoverInfo: f2, closeIconColorPressedInfo: p2, borderSuccess: `1px solid ${i(h2, { alpha: 0.35 })}`, colorSuccess: i(h2, { alpha: 0.25 }), titleTextColorSuccess: s2, iconColorSuccess: h2, contentTextColorSuccess: c2, closeColorHoverSuccess: l2, closeColorPressedSuccess: u2, closeIconColorSuccess: d2, closeIconColorHoverSuccess: f2, closeIconColorPressedSuccess: p2, borderWarning: `1px solid ${i(g2, { alpha: 0.35 })}`, colorWarning: i(g2, { alpha: 0.25 }), titleTextColorWarning: s2, iconColorWarning: g2, contentTextColorWarning: c2, closeColorHoverWarning: l2, closeColorPressedWarning: u2, closeIconColorWarning: d2, closeIconColorHoverWarning: f2, closeIconColorPressedWarning: p2, borderError: `1px solid ${i(_2, { alpha: 0.35 })}`, colorError: i(_2, { alpha: 0.25 }), titleTextColorError: s2, iconColorError: _2, contentTextColorError: c2, closeColorHoverError: l2, closeColorPressedError: u2, closeIconColorError: d2, closeIconColorHoverError: f2, closeIconColorPressedError: p2 });
} }, or = { name: `Anchor`, common: K, self: An };
function sr(e2) {
  let { textColor2: t2, textColor3: n2, textColorDisabled: r2, primaryColor: a2, primaryColorHover: o2, inputColor: s2, inputColorDisabled: c2, warningColor: l2, warningColorHover: u2, errorColor: d2, errorColorHover: f2, borderRadius: p2, lineHeight: m2, fontSizeTiny: h2, fontSizeSmall: g2, fontSizeMedium: _2, fontSizeLarge: v2, heightTiny: y2, heightSmall: b2, heightMedium: x2, heightLarge: S2, clearColor: C2, clearColorHover: w2, clearColorPressed: T2, placeholderColor: ee2, placeholderColorDisabled: te2, iconColor: E2, iconColorDisabled: D2, iconColorHover: O2, iconColorPressed: ne2, fontWeight: re2 } = e2;
  return Object.assign(Object.assign({}, Qe), { fontWeight: re2, countTextColorDisabled: r2, countTextColor: n2, heightTiny: y2, heightSmall: b2, heightMedium: x2, heightLarge: S2, fontSizeTiny: h2, fontSizeSmall: g2, fontSizeMedium: _2, fontSizeLarge: v2, lineHeight: m2, lineHeightTextarea: m2, borderRadius: p2, iconSize: `16px`, groupLabelColor: s2, textColor: t2, textColorDisabled: r2, textDecorationColor: t2, groupLabelTextColor: t2, caretColor: a2, placeholderColor: ee2, placeholderColorDisabled: te2, color: s2, colorDisabled: c2, colorFocus: i(a2, { alpha: 0.1 }), groupLabelBorder: `1px solid #0000`, border: `1px solid #0000`, borderHover: `1px solid ${o2}`, borderDisabled: `1px solid #0000`, borderFocus: `1px solid ${o2}`, boxShadowFocus: `0 0 8px 0 ${i(a2, { alpha: 0.3 })}`, loadingColor: a2, loadingColorWarning: l2, borderWarning: `1px solid ${l2}`, borderHoverWarning: `1px solid ${u2}`, colorFocusWarning: i(l2, { alpha: 0.1 }), borderFocusWarning: `1px solid ${u2}`, boxShadowFocusWarning: `0 0 8px 0 ${i(l2, { alpha: 0.3 })}`, caretColorWarning: l2, loadingColorError: d2, borderError: `1px solid ${d2}`, borderHoverError: `1px solid ${f2}`, colorFocusError: i(d2, { alpha: 0.1 }), borderFocusError: `1px solid ${f2}`, boxShadowFocusError: `0 0 8px 0 ${i(d2, { alpha: 0.3 })}`, caretColorError: d2, clearColor: C2, clearColorHover: w2, clearColorPressed: T2, iconColor: E2, iconColorDisabled: D2, iconColorHover: O2, iconColorPressed: ne2, suffixTextColor: t2 });
}
var X = f({ name: `Input`, common: K, peers: { Scrollbar: q }, self: sr }), cr = { name: `AutoComplete`, common: K, peers: { InternalSelectMenu: nr, Input: X }, self: tn }, lr = { name: `Avatar`, common: K, self: Ot }, ur = { name: `AvatarGroup`, common: K, peers: { Avatar: lr }, self: Tt }, dr = { name: `BackTop`, common: K, self(e2) {
  let { popoverColor: t2, textColor2: n2, primaryColorHover: r2, primaryColorPressed: i2 } = e2;
  return Object.assign(Object.assign({}, zt), { color: t2, textColor: n2, iconColor: n2, iconColorHover: r2, iconColorPressed: i2, boxShadow: `0 2px 8px 0px rgba(0, 0, 0, .12)`, boxShadowHover: `0 2px 12px 0px rgba(0, 0, 0, .18)`, boxShadowPressed: `0 2px 12px 0px rgba(0, 0, 0, .18)` });
} }, fr = { name: `Badge`, common: K, self(e2) {
...
} }, pr = { name: `Breadcrumb`, common: K, self: Lt }, Z = { name: `Button`, common: K, self(e2) {
  let t2 = mn(e2);
...
} }, mr = { name: `Calendar`, common: K, peers: { Button: Z }, self: Et }, hr = { name: `Card`, common: K, self(e2) {
...
} }, gr = { name: `Carousel`, common: K, self: Rt }, Q = { name: `Checkbox`, common: K, self(e2) {
  let { cardColor: t2 } = e2, n2 = bt(e2);
  return n2.color = `#0000`, n2.checkMarkColor = t2, n2;
} }, _r = { name: `Cascader`, common: K, peers: { InternalSelectMenu: nr, InternalSelection: ir, Scrollbar: q, Checkbox: Q, Empty: Sn }, self: Pt }, vr = { name: `Code`, common: K, self(e2) {
...
} }, yr = { name: `Collapse`, common: K, self: Cn }, br = { name: `CollapseTransition`, common: K, self: kt }, xr = { name: `ColorPicker`, common: K, peers: { Input: X, Button: Z }, self: Xe }, Sr = { name: `Popselect`, common: K, peers: { Popover: Y, InternalSelectMenu: nr } }, Cr = { name: `Select`, common: K, peers: { InternalSelection: ir, InternalSelectMenu: nr }, self: pn }, wr = { name: `Pagination`, common: K, peers: { Select: Cr, Input: X, Popselect: Sr }, self(e2) {
  let { primaryColor: t2, opacity3: n2 } = e2, r2 = i(t2, { alpha: Number(n2) }), a2 = wt(e2);
  return a2.itemBorderActive = `1px solid ${r2}`, a2.itemBorderDisabled = `1px solid #0000`, a2;
} }, Tr = { name: `Dropdown`, common: K, peers: { Popover: Y }, self(e2) {
  let { primaryColorSuppl: t2, primaryColor: n2, popoverColor: r2 } = e2, a2 = Nt(e2);
...
} }, Er = { name: `Tooltip`, common: K, peers: { Popover: Y }, self(e2) {
  let { borderRadius: t2, boxShadow2: n2, popoverColor: r2, textColor2: i2 } = e2;
  return Object.assign(Object.assign({}, ne), { borderRadius: t2, boxShadow: n2, color: r2, textColor: i2 });
} }, Dr = { name: `Ellipsis`, common: K, peers: { Tooltip: Er } }, Or = { name: `Radio`, common: K, self(e2) {
  ...
  return Object.assign(Object.assign({}, jn), { labelLineHeight: g2, buttonHeightSmall: p2, buttonHeightMedium: m2, buttonHeightLarge: h2, fontSizeSmall: u2, fontSizeMedium: d2, fontSizeLarge: f2, boxShadow: `inset 0 0 0 1px ${t2}`, boxShadowActive: `inset 0 0 0 1px ${n2}`, boxShadowFocus: `inset 0 0 0 1px ${n2}, 0 0 0 2px ${i(n2, { alpha: 0.3 })}`, boxShadowHover: `inset 0 0 0 1px ${n2}`, boxShadowDisabled: `inset 0 0 0 1px ${t2}`, color: `#0000`, colorDisabled: o2, colorActive: `#0000`, textColor: s2, textColorDisabled: a2, dotColorActive: n2, dotColorDisabled: t2, buttonBorderColor: t2, buttonBorderColorActive: n2, buttonBorderColorHover: n2, buttonColor: `#0000`, buttonColorActive: n2, buttonTextColor: s2, buttonTextColorActive: r2, buttonTextColorHover: n2, opacityDisabled: c2, buttonBoxShadowFocus: `inset 0 0 0 1px ${n2}, 0 0 0 2px ${i(n2, { alpha: 0.3 })}`, buttonBoxShadowHover: `inset 0 0 0 1px ${n2}`, buttonBoxShadow: `inset 0 0 0 1px #0000`, buttonBorderRadius: l2 });
} }, kr = { name: `DataTable`, common: K, peers: { Button: Z, Checkbox: Q, Radio: Or, Pagination: wr, Scrollbar: q, Empty: J, Popover: Y, Ellipsis: Dr, Dropdown: Tr }, self(e2) {
  let t2 = jt(e2);
  return t2.boxShadowAfter = `inset 12px 0 8px -12px rgba(0, 0, 0, .36)`, t2.boxShadowBefore = `inset -12px 0 8px -12px rgba(0, 0, 0, .36)`, t2;
} }, Ar = { name: `Icon`, common: K, self: Fn }, jr = { name: `TimePicker`, common: K, peers: { Scrollbar: q, Button: Z, Input: X }, self: Jt }, Mr = { name: `DatePicker`, common: K, peers: { Input: X, Button: Z, TimePicker: jr, Scrollbar: q }, self(e2) {
  let { popoverColor: t2, hoverColor: n2, primaryColor: r2 } = e2, o2 = yt(e2);
  return o2.itemColorDisabled = a(t2, n2), o2.itemColorIncluded = i(r2, { alpha: 0.15 }), o2.itemColorHover = a(t2, n2), o2;
} }, Nr = { name: `Descriptions`, common: K, self: Yt }, Pr = { name: `Dialog`, common: K, peers: { Button: Z }, self: Ge }, Fr = { name: `Modal`, common: K, peers: { Scrollbar: q, Dialog: Pr, Card: hr }, self: rt };
const Ir = Object.assign(Object.assign({}, tt), { onAfterEnter: Function, onAfterLeave: Function, transformOrigin: String, blockScroll: { type: Boolean, default: true }, closeOnEsc: { type: Boolean, default: true }, onEsc: Function, autoFocus: { type: Boolean, default: true }, internalStyle: [String, Object], maskClosable: { type: Boolean, default: true }, zIndex: Number, onPositiveClick: Function, onNegativeClick: Function, onClose: Function, onMaskClick: Function, draggable: [Boolean, Object] }), Lr = P({ name: `DialogEnvironment`, props: Object.assign(Object.assign({}, Ir), { internalKey: { type: String, required: true }, to: [String, Object], onInternalAfterLeave: { type: Function, required: true } }), setup(e2) {
  let t2 = j(true);
  function n2() {
  ...
  return M(_t, { show: u2, onUpdateShow: t2, onMaskClick: a2, onEsc: o2, to: s2, zIndex: c2, maskClosable: l2, onAfterEnter: this.onAfterEnter, onAfterLeave: i2, closeOnEsc: this.closeOnEsc, blockScroll: this.blockScroll, autoFocus: this.autoFocus, transformOrigin: this.transformOrigin, draggable: this.draggable, internalAppear: true, internalDialog: true }, { default: ({ draggableClass: t3 }) => M(Ye, Object.assign({}, ue(this.$props, Je), { titleClass: Me([this.titleClass, t3]), style: this.internalStyle, onClose: r2, onNegativeClick: n2, onPositiveClick: e2 })) });
} }), Rr = P({ name: `DialogProvider`, props: { injectionKey: String, to: [String, Object] }, setup() {
  let e2 = j([]), t2 = {};
  function n2(n3 = {}) {
    let r3 = se(), i3 = he(Object.assign(Object.assign({}, n3), { key: r3, destroy: () => {
      var e3;
  ...
  return F(ut, o2), F($e, { clickedRef: Ke(64), clickedPositionRef: it() }), F(et, e2), Object.assign(Object.assign({}, o2), { dialogList: e2, dialogInstRefs: t2, handleAfterLeave: i2 });
}, render() {
  var _a2;
  var e2;
  return M(ke, null, [this.dialogList.map((e3) => M(Lr, Ue(e3, [`destroy`, `style`], { internalStyle: e3.style, to: this.to, ref: (t2) => {
...
var zr = { name: `LoadingBar`, common: K, self(e2) {
  let { primaryColor: t2 } = e2;
  return { colorError: `red`, colorLoading: t2, height: `2px` };
} }, Br = { name: `Message`, common: K, self: Mt };
...
var Hr = c([x(`message-wrapper`, `
 ...
 display: flex;
 `, [kn({ overflow: `visible`, originalTransition: `transform .3s var(--n-bezier)`, enterToProps: { transform: `scale(1)` }, leaveToProps: { transform: `scale(0.85)` } })]), x(`message`, `
 ...
 `)])]), Ur = { info: () => M(En, null), success: () => M(Tn, null), warning: () => M(Dn, null), error: () => M(wn, null), default: () => null }, Wr = P({ name: `Message`, props: Object.assign(Object.assign({}, Vr), { render: Function }), setup(e2) {
  ...
  s2 == null ? void 0 : s2();
  let f2;
  return M(`div`, { class: [`${i2}-message-wrapper`, o2], onMouseenter: this.onMouseenter, onMouseleave: this.onMouseleave, style: [{ alignItems: this.placement.startsWith(`top`) ? `flex-start` : `flex-end` }, a2] }, e2 ? e2(this.$props) : M(`div`, { class: [`${i2}-message ${i2}-message--${t2}-type`, this.rtlEnabled && `${i2}-message--rtl`] }, (f2 = Gr(c2, t2, i2)) && d2 ? M(`div`, { class: `${i2}-message__icon ${i2}-message__icon--${t2}-type` }, M(dn, null, { default: () => f2 })) : null, M(`div`, { class: `${i2}-message__content` }, B(r2)), n2 ? M(u, { clsPrefix: i2, class: `${i2}-message__close`, onClick: l2, absolute: true }) : null));
} });
function Gr(e2, t2, n2) {
  if (typeof e2 == `function`) return e2();
  {
    let e3 = t2 === `loading` ? M(un, { clsPrefix: n2, strokeWidth: 24, scale: 0.85 }) : Ur[t2]();
    return e3 ? M(C, { clsPrefix: n2, key: t2 }, { default: () => e3 }) : null;
  }
}
var Kr = P({ name: `MessageEnvironment`, props: Object.assign(Object.assign({}, Vr), { duration: { type: Number, default: 3e3 }, onAfterLeave: Function, onLeave: Function, internalKey: { type: String, required: true }, onInternalAfterLeave: Function, onHide: Function, onAfterHide: Function }), setup(e2) {
  ...
  return M(S, { appear: true, onAfterLeave: this.handleAfterLeave, onLeave: this.onLeave }, { default: () => [this.show ? M(Wr, { content: this.content, type: this.type, icon: this.icon, showIcon: this.showIcon, closable: this.closable, onClose: this.handleClose, onMouseenter: this.keepAliveOnHover ? this.handleMouseenter : void 0, onMouseleave: this.keepAliveOnHover ? this.handleMouseleave : void 0 }) : null] });
} }), qr = P({ name: `MessageProvider`, props: Object.assign(Object.assign({}, m.props), { to: [String, Object], duration: { type: Number, default: 3e3 }, keepAliveOnHover: Boolean, max: Number, placement: { type: String, default: `top` }, closable: Boolean, containerClass: String, containerStyle: [String, Object] }), setup(e2) {
  ...
  F(ht, { props: e2, mergedClsPrefixRef: t2 }), F(at, i2);
  function a2(t3, i3) {
    let a3 = se(), o3 = he(Object.assign(Object.assign({}, i3), { content: t3, key: a3, destroy: () => {
      var e3;
  ...
  var _a2;
  var e2;
  return M(ke, null, (_a2 = (e2 = this.$slots).default) == null ? void 0 : _a2.call(e2), this.messageList.length ? M(Ee, { to: this.to ?? `body` }, M(`div`, { class: [`${this.mergedClsPrefix}-message-container`, `${this.mergedClsPrefix}-message-container--${this.placement}`, this.containerClass], key: `message-container`, style: this.containerStyle }, this.messageList.map((e3) => M(Kr, Object.assign({ ref: (t2) => {
    t2 && (this.messageRefs[e3.key] = t2);
  }, internalKey: e3.key, onInternalAfterLeave: this.handleAfterLeave }, Ue(e3, [`destroy`], void 0), { duration: e3.duration === void 0 ? this.duration : e3.duration, keepAliveOnHover: e3.keepAliveOnHover === void 0 ? this.keepAliveOnHover : e3.keepAliveOnHover, closable: e3.closable === void 0 ? this.closable : e3.closable }))))) : null);
} });
const Jr = P({ name: `ModalEnvironment`, props: Object.assign(Object.assign({}, st), { internalKey: { type: String, required: true }, onInternalAfterLeave: { type: Function, required: true } }), setup(e2) {
  let t2 = j(true);
  function n2() {
    let { onInternalAfterLeave: t3, internalKey: n3, onAfterLeave: r3 } = e2;
    t3 && t3(n3), r3 && r3();
  ...
  return M(_t, Object.assign({}, this.$props, { show: i2, onUpdateShow: e2, onMaskClick: n2, onEsc: r2, onAfterLeave: t2, internalAppear: true, internalModal: true }), this.$slots);
} }), Yr = P({ name: `ModalProvider`, props: { to: [String, Object] }, setup() {
  let e2 = j([]), t2 = {};
  function n2(n3 = {}) {
    let r3 = se(), i3 = he(Object.assign(Object.assign({}, n3), { key: r3, destroy: () => {
      var e3;
  ...
  return F(gt, a2), F(nt, { clickedRef: Ke(64), clickedPositionRef: it() }), F(qe, e2), Object.assign(Object.assign({}, a2), { modalList: e2, modalInstRefs: t2, handleAfterLeave: r2 });
}, render() {
  var _a2;
  var e2;
  return M(ke, null, [this.modalList.map((e3) => M(Jr, Ue(e3, [`destroy`, `render`], { to: e3.to ?? this.to, ref: (t2) => {
...
var Xr = { name: `Notification`, common: K, peers: { Scrollbar: q }, self: Ct }, Zr = { name: `Divider`, common: K, self: Rn }, Qr = { name: `Drawer`, common: K, peers: { Scrollbar: q }, self: lt }, $r = { name: `DynamicInput`, common: K, peers: { Input: X, Button: Z }, self() {
  return It;
} }, ei = { name: `Space`, self() {
  return zn;
} }, ti = { name: `DynamicTags`, common: K, peers: { Input: X, Button: Z, Tag: rr, Space: ei }, self() {
  return { inputWidth: `64px` };
} }, ni = { name: `Element`, common: K }, ri = { name: `Flex`, self() {
  return ft;
} }, ii = { name: `ButtonGroup`, common: K }, ai = { name: `Form`, common: K, self: ct }, oi = { name: `GradientText`, common: K, self(e2) {
...
} }, si = { name: `InputNumber`, common: K, peers: { Button: Z, Input: X }, self(e2) {
  let { textColorDisabled: t2 } = e2;
  return { iconColorDisabled: t2 };
} }, ci = { name: `InputOtp`, common: K, peers: { Input: X }, self: sn }, li = { name: `Layout`, common: K, peers: { Scrollbar: q }, self(e2) {
...
} }, ui = { name: `Row`, common: K }, di = { name: `List`, common: K, self: oe }, fi = { name: `Log`, common: K, peers: { Scrollbar: q, Code: vr }, self(e2) {
...
} }, pi = { name: `Mention`, common: K, peers: { InternalSelectMenu: nr, Input: X }, self(e2) {
  let { boxShadow2: t2 } = e2;
  return { menuBoxShadow: t2 };
} }, mi = { name: `Menu`, common: K, peers: { Tooltip: Er, Dropdown: Tr }, self(e2) {
  let { primaryColor: t2, primaryColorSuppl: n2 } = e2, r2 = xt(e2);
...
const hi = { name: `PageHeader`, common: K, self: cn };
var gi = { name: `Popconfirm`, common: K, peers: { Button: Z, Popover: Y }, self: pt }, _i = { name: `Progress`, common: K, self(e2) {
  let t2 = Ht(e2);
  ...
  return Object.assign(Object.assign({}, an), { itemHeightSmall: o2, itemHeightMedium: o2, itemHeightLarge: a2, fontSizeSmall: i2, fontSizeMedium: r2, fontSizeLarge: n2, borderRadius: s2, dividerColor: b2, borderColor: `#0000`, listColor: c2, headerColor: l2, titleTextColor: u2, titleTextColorDisabled: d2, extraTextColor: p2, extraTextColorDisabled: d2, itemTextColor: f2, itemTextColorDisabled: d2, itemColorPending: m2, titleFontWeight: t2, closeColorHover: h2, closeColorPressed: g2, closeIconColor: _2, closeIconColorHover: v2, closeIconColorPressed: y2 });
} }, Ai = { name: `Tree`, common: K, peers: { Checkbox: Q, Scrollbar: q, Empty: J }, self(e2) {
  let { primaryColor: t2 } = e2, n2 = Xt(e2);
  return n2.nodeColorActive = i(t2, { alpha: 0.15 }), n2;
} }, ji = { name: `TreeSelect`, common: K, peers: { Tree: Ai, Empty: J, InternalSelection: ir } }, Mi = { name: `Typography`, common: K, self: In }, Ni = { name: `Upload`, common: K, peers: { Button: Z, Progress: _i }, self(e2) {
  let { errorColor: t2 } = e2, n2 = Ut(e2);
  return n2.itemColorHoverError = i(t2, { alpha: 0.09 }), n2;
} }, Pi = { name: `Watermark`, common: K, self(e2) {
  let { fontFamily: t2 } = e2;
  return { fontFamily: t2 };
} }, Fi = { name: `FloatButton`, common: K, self(e2) {
  ...
  return null;
} }), Li = { name: `Heatmap`, common: K, self(e2) {
  let t2 = $t(e2);
...
} }, Ri = { name: `IconWrapper`, common: K, self: Vt };
const zi = { name: `Image`, common: K, peers: { Tooltip: Er }, self: (e2) => {
  let { textColor2: t2 } = e2;
  return { toolbarIconColor: t2, toolbarColor: `rgba(0, 0, 0, .35)`, toolbarBoxShadow: `none`, toolbarBorderRadius: `24px` };
} };
var Bi = { name: `Transfer`, common: K, peers: { Checkbox: Q, Scrollbar: q, Input: X, Empty: J, Button: Z }, self(e2) {
...
} }, Vi = { name: `Marquee`, common: K, self: nn };
...
var Gi = [c(`&::before`, `background-color: var(--n-item-color-hover);`), d(`arrow`, `
 ...
 overflow: hidden;
 padding: 0;
 `, [kn({ duration: `.2s` })])]), x(`menu-item-group`, [x(`menu-item-group-title`, `
 margin-top: 6px;
 color: var(--n-group-text-color);
 cursor: default;
 font-size: .93em;
...
var Ji = P({ name: `MenuOptionContent`, props: { collapsed: Boolean, disabled: Boolean, title: [String, Function], icon: Function, extra: [String, Function], showArrow: Boolean, childActive: Boolean, hover: Boolean, paddingLeft: Number, selected: Boolean, maxIconSize: { type: Number, required: true }, activeIconSize: { type: Number, required: true }, iconMarginRight: { type: Number, required: true }, clsPrefix: { type: String, required: true }, onClick: Function, tmNode: { type: Object, required: true }, isEllipsisPlaceholder: Boolean }, setup(e2) {
  let { props: t2 } = z(Hi);
  ...
  let { clsPrefix: e2, tmNode: t2, menuProps: { renderIcon: n2, renderLabel: r2, renderExtra: i2, expandIcon: a2 } } = this, o2 = n2 ? n2(t2.rawNode) : B(this.icon);
  return M(`div`, { onClick: (e3) => {
    var t3;
    (t3 = this.onClick) == null || t3.call(this, e3);
  }, role: `none`, class: [`${e2}-menu-item-content`, { [`${e2}-menu-item-content--selected`]: this.selected, [`${e2}-menu-item-content--collapsed`]: this.collapsed, [`${e2}-menu-item-content--child-active`]: this.childActive, [`${e2}-menu-item-content--disabled`]: this.disabled, [`${e2}-menu-item-content--hover`]: this.hover }], style: this.style }, o2 && M(`div`, { class: `${e2}-menu-item-content__icon`, style: this.iconStyle, role: `none` }, [o2]), M(`div`, { class: `${e2}-menu-item-content-header`, role: `none` }, this.isEllipsisPlaceholder ? this.title : r2 ? r2(t2.rawNode) : B(this.title), this.extra || i2 ? M(`span`, { class: `${e2}-menu-item-content-header__extra` }, ` `, i2 ? i2(t2.rawNode) : B(this.extra)) : null), this.showArrow ? M(C, { ariaHidden: true, class: `${e2}-menu-item-content__arrow`, clsPrefix: e2 }, { default: () => a2 ? a2(t2.rawNode) : M(Zn, null) }) : null);
} }), Yi = 8;
function Xi(e2) {
  let t2 = z(Hi), { props: n2, mergedCollapsedRef: r2 } = t2, i2 = z(Ui, null), a2 = z(Wi, null), o2 = R(() => n2.mode === `horizontal`), s2 = R(() => o2.value ? n2.dropdownPlacement : `tmNodes` in e2 ? `right-start` : `right`), c2 = R(() => Math.max(n2.collapsedIconSize ?? n2.iconSize, n2.iconSize));
...
var Qi = P({ name: `MenuDivider`, setup() {
  let { mergedClsPrefixRef: e2, isHorizontalRef: t2 } = z(Hi);
  return () => t2.value ? null : M(`div`, { class: `${e2.value}-menu-divider` });
} });
const $i = Object.assign(Object.assign({}, Zi), { tmNode: { type: Object, required: true }, disabled: Boolean, icon: Function, onClick: Function }), ea = t($i), ta = P({ name: `MenuOption`, props: $i, setup(e2) {
  let t2 = Xi(e2), { NSubmenu: n2, NMenu: r2, NMenuOptionGroup: i2 } = t2, { props: a2, mergedClsPrefixRef: o2, mergedCollapsedRef: s2 } = r2, c2 = n2 ? n2.mergedDisabledRef : i2 ? i2.mergedDisabledRef : { value: false }, l2 = R(() => c2.value || e2.disabled);
  function u2(t3) {
    let { onClick: n3 } = e2;
    n3 && n3(t3);
  }
  ...
  return { mergedClsPrefix: o2, dropdownPlacement: t2.dropdownPlacement, paddingLeft: t2.paddingLeft, iconMarginRight: t2.iconMarginRight, maxIconSize: t2.maxIconSize, activeIconSize: t2.activeIconSize, mergedTheme: r2.mergedThemeRef, menuProps: a2, dropdownEnabled: E(() => e2.root && s2.value && a2.mode !== `horizontal` && !l2.value), selected: E(() => r2.mergedValueRef.value === e2.internalKey), mergedDisabled: l2, handleClick: d2 };
}, render() {
  ...
  return M(`div`, Object.assign({}, a2, { role: `menuitem`, class: [`${e2}-menu-item`, a2 == null ? void 0 : a2.class] }), M(ce, { theme: t2.peers.Tooltip, themeOverrides: t2.peerOverrides.Tooltip, trigger: `hover`, placement: this.dropdownPlacement, disabled: !this.dropdownEnabled || this.title === void 0, internalExtraClass: [`menu-tooltip`] }, { default: () => r2 ? r2(n2.rawNode) : B(this.title), trigger: () => M(Ji, { tmNode: n2, clsPrefix: e2, paddingLeft: this.paddingLeft, iconMarginRight: this.iconMarginRight, maxIconSize: this.maxIconSize, activeIconSize: this.activeIconSize, selected: this.selected, title: this.title, extra: this.extra, disabled: this.mergedDisabled, icon: this.icon, onClick: this.handleClick }) }));
} }), na = Object.assign(Object.assign({}, Zi), { tmNode: { type: Object, required: true }, tmNodes: { type: Array, required: true } }), ra = t(na), ia = P({ name: `MenuOptionGroup`, props: na, setup(e2) {
  let t2 = Xi(e2), { NSubmenu: n2 } = t2, r2 = R(() => (n2 == null ? void 0 : n2.mergedDisabledRef.value) ? true : e2.tmNode.disabled);
  F(Wi, { paddingLeftRef: t2.paddingLeft, mergedDisabledRef: r2 });
  ...
  return function() {
    ...
    return M(`div`, { class: `${n3}-menu-item-group`, role: `group` }, M(`div`, Object.assign({}, s2, { class: [`${n3}-menu-item-group-title`, s2 == null ? void 0 : s2.class], style: [(s2 == null ? void 0 : s2.style) || ``, r3 === void 0 ? `` : `padding-left: ${r3}px;`] }), B(e2.title), e2.extra ? M(ke, null, ` `, B(e2.extra)) : null), M(`div`, null, e2.tmNodes.map((e3) => sa(e3, a2))));
  };
} });
function aa(e2) {
...
function sa(e2, t2) {
  ...
  return e2.children ? e2.isGroup ? M(ia, ue(c2, ra, { tmNode: e2, tmNodes: e2.children, key: a2 })) : M(ua, ue(c2, la, { key: a2, rawNodes: n2[t2.childrenField], tmNodes: e2.children, tmNode: e2 })) : M(ta, ue(c2, ea, { key: a2, tmNode: e2 }));
}
const ca = Object.assign(Object.assign({}, Zi), { rawNodes: { type: Array, default: () => [] }, tmNodes: { type: Array, default: () => [] }, tmNode: { type: Object, required: true }, disabled: Boolean, icon: Function, onClick: Function, domId: String, virtualChildActive: { type: Boolean, default: void 0 }, isEllipsisPlaceholder: Boolean }), la = t(ca), ua = P({ name: `Submenu`, props: ca, setup(e2) {
  let t2 = Xi(e2), { NMenu: n2, NSubmenu: r2 } = t2, { props: i2, mergedCollapsedRef: a2, mergedThemeRef: o2 } = n2, s2 = R(() => {
    let { disabled: t3 } = e2;
    return (r2 == null ? void 0 : r2.mergedDisabledRef.value) || i2.disabled ? true : t3;
  }), c2 = j(false);
  F(Ui, { paddingLeftRef: t2.paddingLeft, mergedDisabledRef: s2 }), F(Wi, null);
  function l2() {
    let { onClick: t3 } = e2;
    t3 && t3();
  }
...
var da = P({ name: `Menu`, inheritAttrs: false, props: Object.assign(Object.assign({}, m.props), { options: { type: Array, default: () => [] }, collapsed: { type: Boolean, default: void 0 }, collapsedWidth: { type: Number, default: 48 }, iconSize: { type: Number, default: 20 }, collapsedIconSize: { type: Number, default: 24 }, rootIndent: Number, indent: { type: Number, default: 32 }, labelField: { type: String, default: `label` }, keyField: { type: String, default: `key` }, childrenField: { type: String, default: `children` }, disabledField: { type: String, default: `disabled` }, defaultExpandAll: Boolean, defaultExpandedKeys: Array, expandedKeys: Array, value: [String, Number], defaultValue: { type: [String, Number], default: null }, mode: { type: String, default: `vertical` }, watchProps: { type: Array, default: void 0 }, disabled: Boolean, show: { type: Boolean, default: true }, inverted: Boolean, "onUpdate:expandedKeys": [Function, Array], onUpdateExpandedKeys: [Function, Array], onUpdateValue: [Function, Array], "onUpdate:value": [Function, Array], expandIcon: Function, renderIcon: Function, renderLabel: Function, renderExtra: Function, dropdownProps: Object, accordion: Boolean, nodeProps: Function, dropdownPlacement: { type: String, default: `bottom` }, responsive: Boolean, items: Array, onOpenNamesChange: [Function, Array], onSelect: [Function, Array], onExpandedNamesChange: [Function, Array], expandedNames: Array, defaultExpandedNames: Array }), setup(t2) {
  let { mergedClsPrefixRef: n2, inlineThemeDisabled: r2 } = T(t2), i2 = m(`Menu`, `-menu`, qi, Ft, t2, n2), a2 = z(We, null), o2 = R(() => {
    ...
    return xn(t2.items || t2.options, { getIgnored(e3) {
      return aa(e3);
    }, getChildren(e3) {
      return e3[n3];
    }, getDisabled(e3) {
  ...
  }), c2 = R(() => new Set(s2.value.treeNodes.map((e2) => e2.key))), { watchProps: l2 } = t2, u2 = j(null);
  (l2 == null ? void 0 : l2.includes(`defaultValue`)) ? fe(() => {
    u2.value = t2.defaultValue;
  }) : u2.value = t2.defaultValue;
  let d2 = ee(de(t2, `value`), u2), f2 = j([]), p2 = () => {
  ...
  (l2 == null ? void 0 : l2.includes(`defaultExpandedKeys`)) ? fe(p2) : p2();
  let g2 = te(t2, [`expandedNames`, `expandedKeys`]), _2 = ee(g2, f2), v2 = R(() => s2.value.treeNodes), y2 = R(() => s2.value.getPath(d2.value).keyPath);
  F(Hi, { props: t2, mergedCollapsedRef: o2, mergedThemeRef: i2, mergedValueRef: d2, mergedExpandedKeysRef: _2, activePathRef: y2, mergedClsPrefixRef: n2, isHorizontalRef: R(() => t2.mode === `horizontal`), invertedRef: de(t2, `inverted`), doSelect: b2, toggleExpand: S2 });
  function b2(n3, r3) {
  ...
  }), E2 = r2 ? h(`menu`, R(() => t2.inverted ? `a` : `b`), w2, t2) : void 0, D2 = se(), O2 = j(null), ne2 = j(null), re2 = true, ie2 = () => {
    var e2;
    re2 ? re2 = false : (e2 = O2.value) == null || e2.sync({ showAllItemsBeforeCalculate: true });
  };
  function ae2() {
  ...
  let oe2 = j(-1);
  function ce2(e2) {
    oe2.value = t2.options.length - e2;
  }
  function le2(e2) {
    e2 || (oe2.value = -1);
  }
  let ue2 = R(() => {
    ...
    return xn([ue2.value], { getIgnored(e3) {
      return aa(e3);
    }, getChildren(t3) {
      return t3[e2];
    }, getDisabled(e3) {
  ...
  }), pe2 = R(() => xn([{}]).treeNodes[0]);
  function me2() {
    var _a2;
    if (oe2.value === -1) return M(ua, { root: true, level: 0, key: `__ellpisisGroupPlaceholder__`, internalKey: `__ellpisisGroupPlaceholder__`, title: `\xB7\xB7\xB7`, tmNode: pe2.value, domId: D2, isEllipsisPlaceholder: true });
    let e2 = k2.value.treeNodes[0], t3 = y2.value;
    return M(ua, { level: 0, root: true, key: `__ellpisisGroup__`, internalKey: `__ellpisisGroup__`, title: `\xB7\xB7\xB7`, virtualChildActive: !!((_a2 = e2.children) == null ? void 0 : _a2.some((e3) => t3.includes(e3.key))), tmNode: e2, domId: D2, rawNodes: e2.rawNode.children || [], tmNodes: e2.children || [], isEllipsisPlaceholder: true });
  }
  return { mergedClsPrefix: n2, controlledExpandedKeys: g2, uncontrolledExpanededKeys: f2, mergedExpandedKeys: _2, uncontrolledValue: u2, mergedValue: d2, activePath: y2, tmNodes: v2, mergedTheme: i2, mergedCollapsed: o2, cssVars: r2 ? void 0 : w2, themeClass: E2 == null ? void 0 : E2.themeClass, overflowRef: O2, counterRef: ne2, updateCounter: () => {
  }, onResize: ie2, onUpdateOverflow: le2, onUpdateCount: ce2, renderCounter: me2, getCounter: ae2, onRender: E2 == null ? void 0 : E2.onRender, showOption: C2, deriveResponsiveState: ie2 };
}, render() {
  let { mergedClsPrefix: e2, mode: t2, themeClass: n2, onRender: r2 } = this;
  r2 == null ? void 0 : r2();
  let i2 = () => this.tmNodes.map((e3) => sa(e3, this.$props)), a2 = t2 === `horizontal` && this.responsive, o2 = () => M(`div`, ve(this.$attrs, { role: t2 === `horizontal` ? `menubar` : `menu`, class: [`${e2}-menu`, n2, `${e2}-menu--${t2}`, a2 && `${e2}-menu--responsive`, this.mergedCollapsed && `${e2}-menu--collapsed`], style: this.cssVars }), a2 ? M(ln, { ref: `overflowRef`, onUpdateOverflow: this.onUpdateOverflow, getCounter: this.getCounter, onUpdateCount: this.onUpdateCount, updateCounter: this.updateCounter, style: { width: `100%`, display: `flex`, overflow: `hidden` } }, { default: i2, counter: this.renderCounter }) : i2());
  return a2 ? M(D, { onResize: this.onResize }, { default: o2 }) : o2();
} });
const fa = { name: `dark`, common: K, Alert: ar, Anchor: or, AutoComplete: cr, Avatar: lr, AvatarGroup: ur, BackTop: dr, Badge: fr, Breadcrumb: pr, Button: Z, ButtonGroup: ii, Calendar: mr, Card: hr, Carousel: gr, Cascader: _r, Checkbox: Q, Code: vr, Collapse: yr, CollapseTransition: br, ColorPicker: xr, DataTable: kr, DatePicker: Mr, Descriptions: Nr, Dialog: Pr, Divider: Zr, Drawer: Qr, Dropdown: Tr, DynamicInput: $r, DynamicTags: ti, Element: ni, Empty: J, Ellipsis: Dr, Equation: { name: `Equation`, common: K, self: Qt }, Flex: ri, Form: ai, GradientText: oi, Heatmap: Li, Icon: Ar, IconWrapper: Ri, Image: zi, Input: X, InputNumber: si, InputOtp: ci, LegacyTransfer: Bi, Layout: li, List: di, LoadingBar: zr, Log: fi, Menu: mi, Mention: pi, Message: Br, Modal: Fr, Notification: Xr, PageHeader: hi, Pagination: wr, Popconfirm: gi, Popover: Y, Popselect: Sr, Progress: _i, QrCode: { name: `QrCode`, common: K, self: (e2) => ({ borderRadius: e2.borderRadius }) }, Radio: Or, Rate: vi, Result: yi, Row: ui, Scrollbar: q, Select: Cr, Skeleton: { name: `Skeleton`, common: K, self(e2) {
...
} }, Slider: bi, Space: ei, Spin: xi, Statistic: Si, Steps: Ci, Switch: wi, Table: Ti, Tabs: Ei, Tag: rr, Thing: Di, TimePicker: jr, Timeline: Oi, Tooltip: Er, Transfer: ki, Tree: Ai, TreeSelect: ji, Typography: Mi, Upload: Ni, Watermark: Pi, Split: { name: `Split`, common: K }, FloatButton: Fi, FloatButtonGroup: { name: `FloatButtonGroup`, common: K, self(e2) {
...
var ma = { key: 0, class: `title-bar` }, ha = Pe(P({ __name: `TitleBar`, setup(e2) {
  let t2 = pa(), n2 = R(() => t2.text || ``);
  return (e3, t3) => n2.value ? (k(), Te(`div`, ma, [I(L(Pn), null, { default: A(() => [I(L(dt), { depth: 3 }, { default: A(() => [je(Ce(n2.value), 1)]), _: 1 })]), _: 1 })])) : Fe(``, true);
} }), [[`__scopeId`, `data-v-36e35087`]]), ga = { key: 0, class: `nav-bar` }, _a = { class: `software-info-menu` }, va = { style: { width: `100%` } }, ya = { style: { "max-width": `8em` } }, ba = { key: 1, class: `nav-bar` }, xa = { style: { "max-width": `50vw` } }, Sa = { class: `main-layout` }, Ca = Pe(P({ __name: `AppLayout`, setup(e2) {
  xe((e3) => ({ v7525ec9e: f2.value ? `column` : `row` }));
  let t2 = Le(), n2 = Mn(), r2 = new Nn(), { t: i2, locale: a2 } = vt();
  function o2(e3) {
    return () => M(Ln, null, { default: () => M(e3) });
  }
  n2.settings.interfaceLanguage = n2.settings.interfaceLanguage ?? a2.value, a2.value = n2.settings.interfaceLanguage, Ie(() => n2.settings.interfaceLanguage, (e3) => {
    e3 && (a2.value = e3);
  });
  let s2 = [{ label: () => M(ze, { to: `/tracker` }, { default: () => i2(`router.tracker`) }), key: `tracker`, icon: o2(Be) }, { label: () => M(ze, { to: `/sketch-centre` }, { default: () => i2(`router.sketchCentre`) }), key: `sketch-centre`, icon: o2(Ze) }], c2 = [{ label: () => M(ze, { to: `/settings` }, { default: () => i2(`router.settings`) }), key: `settings`, icon: o2(Ve) }, { label: () => M(ze, { to: `/about` }, { default: () => i2(`router.about`) }), key: `about`, icon: o2(He) }], l2 = R(() => t2.path.slice(1)), { width: u2, height: d2 } = vn(), f2 = R(() => u2.value > d2.value);
  return (e3, t3) => (k(), Te(`div`, { class: Me([`app-layout`, f2.value ? `app-layout-horizontal` : `app-layout-vertical`]) }, [f2.value ? (k(), Te(`div`, ga, [I(L(da), { options: s2, "default-value": `tracker`, value: l2.value, mode: f2.value ? `vertical` : `horizontal` }, null, 8, [`value`, `mode`]), N(`div`, _a, [N(`div`, va, [I(L(da), { options: c2, mode: f2.value ? `vertical` : `horizontal`, value: l2.value }, null, 8, [`mode`, `value`])]), N(`div`, ya, [I(ha)])])])) : (k(), Te(`div`, ba, [I(L(re), { trigger: L(r2).isMobile ? `click` : `hover`, style: { padding: `2px 0`, transform: `translateX(2px)` }, placement: `bottom-start` }, { trigger: A(() => [I(L(gn), { style: { width: `48px` } }, { icon: A(() => [I(L(Ln), null, { default: A(() => [I(L(Hn))]), _: 1 })]), _: 1 })]), default: A(() => [I(L(da), { options: s2.concat(c2), "default-value": `tracker`, value: l2.value, "dropdown-placement": `top-start`, mode: `vertical` }, null, 8, [`options`, `value`])]), _: 1 }, 8, [`trigger`]), N(`div`, xa, [I(ha)])])), N(`div`, Sa, [I(L(Re), null, { default: A(({ Component: e4 }) => [I(me, { name: `slide-fade`, mode: `out-in` }, { default: A(() => [(k(), Oe(Ne, null, [(k(), Oe(_e(e4), { key: l2.value }))], 1024))]), _: 2 }, 1024)]), _: 1 })])], 2));
} }), [[`__scopeId`, `data-v-00577205`]]), wa = Ae(((e2, t2) => {
...
}))(), 1), Ea = P({ __name: `App`, setup(e2) {
  let t2 = Mn(), n2 = window.GeolocationManager, r2 = Xn(), i2 = R(() => t2.settings.theme === `system` ? r2.value : t2.settings.theme), a2 = R(() => i2.value === `dark` ? fa : rn), o2 = { common: { fontFamily: `Barlow, -apple-system, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"` } };
  return F(`applicationDarkThemeEnabled`, i2), F(`platformInfo`, new Nn()), F(`settings`, t2), F(`noSleep`, new Ta.default()), F(`geolocation`, n2), ge(() => t2.init()), (e3, t3) => (k(), Oe(L(Dt), { theme: a2.value, abstract: true, "inline-theme-disabled": true, "theme-overrides": o2 }, { default: A(() => [I(L(Rr), null, { default: A(() => [I(L(Yr), null, { default: A(() => [I(L(qr), { placement: `bottom-right` }, { default: A(() => [I(Ca), I(L(Ii))]), _: 1 })]), _: 1 })]), _: 1 })]), _: 1 }, 8, [`theme`]));
} });
export {
  Ea as default
};
