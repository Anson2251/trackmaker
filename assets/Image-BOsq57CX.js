import { D as e, M as t, S as n, at as r, f as i, g as a, k as o, l as s, ot as c, u as l, ut as u, v as d, vt as f } from "./Card-wTK5VWgg.js";
import { I as p, J as m, O as h, _ as g, et as _, it as ee, j as v, nt as y, q as te, r as b, tt as x } from "./light-DcazuQOY.js";
import { $t as S, Bt as C, Et as w, Ht as T, J as E, Ot as D, Q as O, Xt as k, _t as A, en as ne, ht as j, in as re, jt as M, nt as N, st as P, yt as ie, zt as ae } from "./index-C4uc8sCV.js";
import { t as F } from "./fade-in-scale-up.cssr-DAO-aMlH.js";
import { t as oe } from "./use-locale-DV3hbGtr.js";
import { t as se } from "./light-DsJhCZoU.js";
...
function st() {
  return A(`svg`, { viewBox: `0 0 20 20`, fill: `none`, xmlns: `http://www.w3.org/2000/svg` }, A(`path`, { d: `M6 5C5.75454 5 5.55039 5.17688 5.50806 5.41012L5.5 5.5V14.5C5.5 14.7761 5.72386 15 6 15C6.24546 15 6.44961 14.8231 6.49194 14.5899L6.5 14.5V5.5C6.5 5.22386 6.27614 5 6 5ZM13.8536 5.14645C13.68 4.97288 13.4106 4.9536 13.2157 5.08859L13.1464 5.14645L8.64645 9.64645C8.47288 9.82001 8.4536 10.0894 8.58859 10.2843L8.64645 10.3536L13.1464 14.8536C13.3417 15.0488 13.6583 15.0488 13.8536 14.8536C14.0271 14.68 14.0464 14.4106 13.9114 14.2157L13.8536 14.1464L9.70711 10L13.8536 5.85355C14.0488 5.65829 14.0488 5.34171 13.8536 5.14645Z`, fill: `currentColor` }));
}
function ct() {
  return A(`svg`, { viewBox: `0 0 20 20`, fill: `none`, xmlns: `http://www.w3.org/2000/svg` }, A(`path`, { d: `M13.5 5C13.7455 5 13.9496 5.17688 13.9919 5.41012L14 5.5V14.5C14 14.7761 13.7761 15 13.5 15C13.2545 15 13.0504 14.8231 13.0081 14.5899L13 14.5V5.5C13 5.22386 13.2239 5 13.5 5ZM5.64645 5.14645C5.82001 4.97288 6.08944 4.9536 6.28431 5.08859L6.35355 5.14645L10.8536 9.64645C11.0271 9.82001 11.0464 10.0894 10.9114 10.2843L10.8536 10.3536L6.35355 14.8536C6.15829 15.0488 5.84171 15.0488 5.64645 14.8536C5.47288 14.68 5.4536 14.4106 5.58859 14.2157L5.64645 14.1464L9.79289 10L5.64645 5.85355C5.45118 5.65829 5.45118 5.34171 5.64645 5.14645Z`, fill: `currentColor` }));
}
function lt() {
  return A(`svg`, { viewBox: `0 0 20 20`, fill: `none`, xmlns: `http://www.w3.org/2000/svg` }, A(`path`, { d: `M4.089 4.216l.057-.07a.5.5 0 0 1 .638-.057l.07.057L10 9.293l5.146-5.147a.5.5 0 0 1 .638-.057l.07.057a.5.5 0 0 1 .057.638l-.057.07L10.707 10l5.147 5.146a.5.5 0 0 1 .057.638l-.057.07a.5.5 0 0 1-.638.057l-.07-.057L10 10.707l-5.146 5.147a.5.5 0 0 1-.638.057l-.07-.057a.5.5 0 0 1-.057-.638l.057-.07L9.293 10L4.146 4.854a.5.5 0 0 1-.057-.638l.057-.07l-.057.07z`, fill: `currentColor` }));
}
...
var ft = r([r(`body >`, [c(`image-container`, `position: fixed;`)]), c(`image-preview-container`, `
 ...
 `)])]), $ = 32, pt = j({ name: `ImagePreview`, props: Object.assign(Object.assign({}, ut), { src: String, show: { type: Boolean, default: void 0 }, defaultShow: Boolean, "onUpdate:show": [Function, Array], onUpdateShow: [Function, Array], onNext: Function, onPrev: Function, onClose: [Function, Array] }), setup(t2) {
  let { src: n2 } = ne(t2), { mergedClsPrefixRef: r2 } = d(t2), o2 = i(`Image`, `-image`, ft, se, t2, r2), s2 = null, c2 = k(null), l2 = k(null), u2 = k(false), { localeRef: f2 } = oe(`Image`), p2 = k(t2.defaultShow), h2 = m(S(t2, `show`), p2);
  function g2() {
    let { value: e2 } = l2;
    if (!s2 || !e2) return;
  ...
  ae(h2, (e2) => {
    e2 ? x(`keydown`, document, v2) : _(`keydown`, document, v2);
  }), w(() => {
    _(`keydown`, document, v2);
  });
  let C2 = 0, T2 = 0, E2 = 0, D2 = 0, O2 = 0, j2 = 0, M2 = 0, N2 = 0, F2 = false;
  function ce2(e2) {
    let { clientX: t3, clientY: n3 } = e2;
    E2 = t3 - C2, D2 = n3 - T2, ee(J2);
  }
  function le2(e2) {
  ...
  function ue2(e2) {
    ...
    F2 = true, C2 = r3 - E2, T2 = i2 - D2, O2 = E2, j2 = D2, M2 = r3, N2 = i2, J2(), x(`mousemove`, document, ce2), x(`mouseup`, document, L2);
  }
  ...
  function Y2() {
    if (h2.value) {
      let { onClose: n3 } = t2;
      n3 && e(n3), y2(false), p2.value = false;
    }
  }
  function _e2() {
  ...
  function ye2(e2, n3) {
    if (t2.showToolbarTooltip) {
      let { value: t3 } = o2;
      return A(b, { to: false, theme: t3.peers.Tooltip, themeOverrides: t3.peerOverrides.Tooltip, keepAliveOnHover: false }, { default: () => f2.value[n3], trigger: () => e2 });
    } else return e2;
  }
  let X2 = P(() => {
  ...
  return Object.assign({ clsPrefix: r2, previewRef: c2, previewWrapperRef: l2, previewSrc: n2, mergedShow: h2, appear: te(), displayed: u2, previewedImgProps: R2 == null ? void 0 : R2.previewedImgPropsRef, handleWheel: xe2, handlePreviewMousedown: ue2, handlePreviewDblclick: de2, syncTransformOrigin: g2, handleAfterLeave: () => {
  ...
  }, zoomIn: q2, zoomOut: he2, handleDownloadClick: ge2, rotateCounterclockwise: W2, rotateClockwise: me2, handleSwitchPrev: fe2, handleSwitchNext: pe2, withTooltip: ye2, resizeToOrignalImageSize: _e2, cssVars: be2 ? void 0 : X2, themeClass: Z2 == null ? void 0 : Z2.themeClass, onRender: Z2 == null ? void 0 : Z2.onRender, doUpdateShow: y2, close: Y2 }, ve2);
}, render() {
  var _a;
  var e2;
  let { clsPrefix: t2, renderToolbar: n2, withTooltip: r2 } = this, i2 = r2(A(l, { clsPrefix: t2, onClick: this.handleSwitchPrev }, { default: st }), `tipPrevious`), a2 = r2(A(l, { clsPrefix: t2, onClick: this.handleSwitchNext }, { default: ct }), `tipNext`), o2 = r2(A(l, { clsPrefix: t2, onClick: this.rotateCounterclockwise }, { default: () => A(Qe, null) }), `tipCounterclockwise`), s2 = r2(A(l, { clsPrefix: t2, onClick: this.rotateClockwise }, { default: () => A(Ze, null) }), `tipClockwise`), c2 = r2(A(l, { clsPrefix: t2, onClick: this.resizeToOrignalImageSize }, { default: () => A(Xe, null) }), `tipOriginalSize`), u2 = r2(A(l, { clsPrefix: t2, onClick: this.zoomOut }, { default: () => A(et, null) }), `tipZoomOut`), d2 = r2(A(l, { clsPrefix: t2, onClick: this.handleDownloadClick }, { default: () => A(Ye, null) }), `tipDownload`), f2 = r2(A(l, { clsPrefix: t2, onClick: () => this.close() }, { default: lt }), `tipClose`), p2 = r2(A(l, { clsPrefix: t2, onClick: this.zoomIn }, { default: () => A($e, null) }), `tipZoomIn`);
  return A(N, null, (_a = (e2 = this.$slots).default) == null ? void 0 : _a.call(e2), A(h, { show: this.mergedShow }, { default: () => {
    var e3;
    return this.mergedShow || this.displayed ? ((e3 = this.onRender) == null || e3.call(this), T(A(`div`, { ref: `containerRef`, class: [`${t2}-image-preview-container`, this.themeClass], style: this.cssVars, onWheel: this.handleWheel }, A(E, { name: `fade-in-transition`, appear: this.appear }, { default: () => this.mergedShow ? A(`div`, { class: `${t2}-image-preview-overlay`, onClick: () => this.close() }) : null }), this.showToolbar ? A(E, { name: `fade-in-transition`, appear: this.appear }, { default: () => this.mergedShow ? A(`div`, { class: `${t2}-image-preview-toolbar` }, n2 ? n2({ nodes: { prev: i2, next: a2, rotateCounterclockwise: o2, rotateClockwise: s2, resizeToOriginalSize: c2, zoomOut: u2, zoomIn: p2, download: d2, close: f2 } }) : A(N, null, this.onPrev ? A(N, null, i2, a2) : null, o2, s2, c2, u2, p2, d2, f2)) : null }) : null, A(E, { name: `fade-in-scale-up-transition`, onAfterLeave: this.handleAfterLeave, appear: this.appear, onEnter: this.syncTransformOrigin, onBeforeLeave: this.syncTransformOrigin }, { default: () => {
      let { previewedImgProps: e4 = {} } = this;
      return T(A(`div`, { class: `${t2}-image-preview-wrapper`, ref: `previewWrapperRef` }, A(`img`, Object.assign({}, e4, { draggable: false, onMousedown: this.handlePreviewMousedown, onDblclick: this.handlePreviewDblclick, class: [`${t2}-image-preview`, e4.class], key: this.previewSrc, src: this.previewSrc, ref: `previewRef`, onDragstart: this.handleDragStart }))), [[O, this.mergedShow]]);
    } })), [[v, { enabled: this.mergedShow }]])) : null;
  } }));
} });
const mt = t(`n-image-group`);
var ht = j({ name: `ImageGroup`, props: Object.assign(Object.assign({}, ut), { srcList: Array, current: Number, defaultCurrent: { type: Number, default: 0 }, show: { type: Boolean, default: void 0 }, defaultShow: Boolean, onUpdateShow: [Function, Array], "onUpdate:show": [Function, Array], onUpdateCurrent: [Function, Array], "onUpdate:current": [Function, Array] }), setup(t2) {
  let { mergedClsPrefixRef: n2 } = d(t2), r2 = `c${y()}`, i2 = k(null), a2 = k(t2.defaultShow), s2 = m(S(t2, `show`), a2), c2 = k(/* @__PURE__ */ new Map()), l2 = P(() => {
    if (t2.srcList) {
    ...
    return c2.value;
  }), u2 = P(() => Array.from(l2.value.keys())), f2 = () => u2.value.length;
  function p2(e2, n3) {
  ...
  let h2 = k(t2.defaultCurrent), g2 = m(S(t2, `current`), h2), _2 = (n3) => {
    if (n3 !== g2.value) {
      let { onUpdateCurrent: r3, "onUpdate:current": i3 } = t2;
      r3 && e(r3, n3), i3 && e(i3, n3), h2.value = n3;
    }
  }, ee2 = P(() => u2.value[g2.value]), v2 = (e2) => {
    let t3 = u2.value.indexOf(e2);
    t3 !== g2.value && _2(t3);
  }, te2 = P(() => l2.value.get(ee2.value));
  function b2(n3) {
  ...
  function T2(e2) {
    var n3, r3;
    e2 === 1 ? (w2.value !== void 0 && _2(C2.value), (n3 = t2.onPreviewNext) == null || n3.call(t2)) : (C2.value !== void 0 && _2(w2.value), (r3 = t2.onPreviewPrev) == null || r3.call(t2));
  }
  return M(mt, { mergedClsPrefixRef: n2, registerImageUrl: p2, setThumbnailEl: (e2) => {
    var t3;
    (t3 = i2.value) == null || t3.setThumbnailEl(e2);
  }, toggleShow: (e2) => {
    b2(true), v2(e2);
  }, groupId: r2, renderToolbarRef: S(t2, `renderToolbar`) }), { mergedClsPrefix: n2, previewInstRef: i2, mergedShow: s2, src: te2, onClose: x2, next: () => {
    T2(1);
  }, prev: () => {
    T2(-1);
  } };
}, render() {
  return A(pt, { theme: this.theme, themeOverrides: this.themeOverrides, ref: `previewInstRef`, onPrev: this.prev, onNext: this.next, src: this.src, show: this.mergedShow, showToolbar: this.showToolbar, showToolbarTooltip: this.showToolbarTooltip, renderToolbar: this.renderToolbar, onClose: this.onClose }, this.$slots);
} });
const gt = Object.assign({ alt: String, height: [String, Number], imgProps: Object, previewedImgProps: Object, lazy: Boolean, intersectionObserverOptions: Object, objectFit: { type: String, default: `fill` }, previewSrc: String, fallbackSrc: String, width: [String, Number], src: String, previewDisabled: Boolean, loadDescription: String, onError: Function, onLoad: Function }, ut);
var _t = 0, vt = j({ name: `Image`, props: gt, slots: Object, inheritAttrs: false, setup(e2) {
  let t2 = k(null), n2 = k(false), r2 = k(null), i2 = ie(mt, null), { mergedClsPrefixRef: a2 } = i2 || d(e2), o2 = P(() => e2.previewSrc || e2.src), s2 = k(false), c2 = _t++, l2 = () => {
  ...
  let h2 = k(false);
  return M(dt, { previewedImgPropsRef: S(e2, `previewedImgProps`) }), Object.assign({ mergedClsPrefix: a2, groupId: i2 == null ? void 0 : i2.groupId, previewInstRef: r2, imageRef: t2, mergedPreviewSrc: o2, showError: n2, shouldStartLoading: f2, loaded: h2, mergedOnClick: (e3) => {
    p2(e3);
