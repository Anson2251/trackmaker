...
import { d as z, c as Xe, o as Qe, a as Z, J as hn, h as v, b as k, q as x, i as B, j, F as gn, t as lt, k as Rt, a2 as et, w as ut, p as H, I as we, Y as ct, G as Ye, f as ce, x as je, T as vn, a5 as bn, g as yn, a6 as U, L as wn, Z as _n, $ as P, a0 as O } from "./index-BhqEYxnh.js";
import { i as xn, m as A, n as _, o as L, B as be, l as D, aP as Sn, K as Ae, J as Ge, aF as Cn, V as Rn, w as dt, u as kn, q as kt, aj as zn, E as In, C as ft, p as Mn, t as He, L as An, v as Tn, P as pt, G as E, X as mt, T as zt } from "./light-DWUXhvof.js";
import { w as Bn, R as En, j as Fn, l as Pn } from "./text-BRqaL8bp.js";
import { N as ht, a as On } from "./Suffix-D3ZX_qii.js";
import { u as jn } from "./use-locale-CoYDN08a.js";
import { u as Dn } from "./light-CNImsYXp.js";
import { m as ae } from "./index-DcIceZdo.js";
const Nn = { xmlns: "http://www.w3.org/2000/svg", "xmlns:xlink": "http://www.w3.org/1999/xlink", viewBox: "0 0 24 24" }, Fr = z({ name: "Route", render: function(t, o) {
...
} }), Ln = { xmlns: "http://www.w3.org/2000/svg", "xmlns:xlink": "http://www.w3.org/1999/xlink", viewBox: "0 0 24 24" }, Pr = z({ name: "Trash", render: function(t, o) {
...
} }), $n = { xmlns: "http://www.w3.org/2000/svg", "xmlns:xlink": "http://www.w3.org/1999/xlink", viewBox: "0 0 24 24" }, Or = z({ name: "Upload", render: function(t, o) {
...
const gt = z({ name: "InputWordCount", setup(e, { slots: t }) {
  ...
  const y = j(() => {
    ...
    if (V.value || e.readonly || !e.clearable || !Le.value && !Y.value) return false;
    ...
    if (e.type === "textarea") {
      ...
      if (!ge) return;
      if (h.minRows) {
        const ve = Math.max(h.minRows, 1), Ve = `${X + Q + ee * ve}px`;
        ge.style.minHeight = Ve;
      }
      if (h.maxRows) {
  ...
  function ke(r, i = 0, h = "input") {
    ...
    if (Ue(R), r instanceof InputEvent && !r.isComposing && (d.value = false), e.type === "textarea") {
      const { value: S } = F;
    ...
    Vt.$forceUpdate(), M || we(I.restoreCursor);
  }
  function no(r) {
  ...
  function ho() {
    V.value || $e.value === "click" && (he.value = !he.value);
  }
  function go(r) {
    if (V.value) return;
    r.preventDefault();
  ...
  function at() {
    var r, i, h;
    V.value || (e.passivelyActivated ? (r = p.value) === null || r === void 0 || r.focus() : ((i = f.value) === null || i === void 0 || i.focus(), (h = b.value) === null || h === void 0 || h.focus()));
  }
  function wo() {
    var r;
  ...
  function xo() {
    V.value || (f.value ? f.value.focus() : b.value && b.value.focus());
  }
  function So() {
    const { value: r } = p;
...
`);
  ...
  }), H(It, { mergedValueRef: N, maxlengthRef: Ut, mergedClsPrefixRef: t, countGraphemesRef: lt(e, "countGraphemes") });
...
const Wr = z({ name: "MglCustomControl", props: { position: { type: String, validator: (e) => fe.indexOf(e) !== -1 }, class: { type: String, default: "maplibregl-ctrl maplibregl-ctrl-group" } }, slots: Object, setup(e, { slots: t }) {
  ...
  return null;
} }), Ur = z({ name: "MglFullscreenControl", props: { position: { type: String, validator: (e) => fe.indexOf(e) !== -1 }, container: { type: Object, default: null } }, setup(e) {
  ...
  return null;
} }), Gr = z({ name: "MglNavigationControl", props: { position: { type: String, validator: (e) => fe.indexOf(e) !== -1 }, showCompass: { type: Boolean, default: true }, showZoom: { type: Boolean, default: true }, visualizePitch: Boolean }, setup(e) {
...
const rr = Object.values(Tt), Hr = z({ name: "MglScaleControl", props: { position: { type: String, validator: (e) => fe.indexOf(e) !== -1 }, maxWidth: { type: Number, default: 100 }, unit: { type: String, default: "metric", validator: (e) => rr.indexOf(e) !== -1 } }, setup(e) {
...
const Zr = z({ name: "MglGeoJsonSource", props: { sourceId: { type: String, required: true }, data: { type: [Object, String], required: true }, maxzoom: Number, attribution: String, buffer: Number, tolerance: Number, cluster: Boolean, clusterRadius: Number, clusterMaxZoom: Number, clusterMinPoints: Number, clusterProperties: Object, lineMetrics: Boolean, generateId: Boolean, promoteId: [Object, String], filter: [Array, String, Object] }, slots: Object, setup(e, { slots: t }) {
...
const Kr = z({ name: "MglLineLayer", props: K(), emits: [...W], setup(e) {
  return q("line", e);
} });
...
class Et {
  ...
  get routes() {
    return U(this.routesInternal);
  }
  set routes(t) {
    this.routesInternal = U(t);
  }
  findRoute(t) {
...
class Be {
  ...
  setPoints(t) {
    this.points = U(t), this.updateModificationTime();
  }
  appendPoint(t) {
    this.points.push(U(t)), this.updateModificationTime();
  }
  getPoints() {
  ...
  exportToStorage() {
    return U({ id: this.id, meta: this.meta, properties: this.properties, points: this.points });
  }
}
function hr(e) {
...
async function kr(e, t, o = {}) {
  ...
  try {
    ...
    return Rr({ x: s[0], y: s[1] }, { x: p[0], y: p[1] });
  } catch (s) {
