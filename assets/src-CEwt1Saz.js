import { j as e } from "./Card-wTK5VWgg.js";
import { A as t, k as n } from "./light-DcazuQOY.js";
import { Ct as r, Nt as i, Ot as a, Xt as o, _t as s, ht as c } from "./index-C4uc8sCV.js";
var l = `v-hidden`, u = n(`[v-hidden]`, { display: `none!important` }), d = c({ name: `Overflow`, props: { getCounter: Function, getTail: Function, updateCounter: Function, onUpdateCount: Function, onUpdateOverflow: Function }, setup(n2, { slots: r2 }) {
  let i2 = o(null), s2 = o(null);
  function c2(e2) {
    let { value: t2 } = i2, { getCounter: a2, getTail: o2 } = n2, c3;
    if (c3 = a2 === void 0 ? s2.value : a2(), !t2 || !c3) return;
    ...
    let d3 = t2.offsetWidth, f = [], p = r2.tail ? o2 == null ? void 0 : o2() : null, m = p ? p.offsetWidth : 0, h = false, g = t2.children.length - (r2.tail ? 1 : 0);
  ...
  let d2 = e();
  return u.mount({ id: `vueuc/overflow`, head: true, anchorMetaName: t, ssr: d2 }), a(() => c2({ showAllItemsBeforeCalculate: false })), { selfRef: i2, counterRef: s2, sync: c2 };
}, render() {
  let { $slots: e2 } = this;
  return r(() => this.sync({ showAllItemsBeforeCalculate: false })), s(`div`, { class: `v-overflow`, ref: `selfRef` }, [i(e2, `default`), e2.counter ? e2.counter() : s(`span`, { style: { display: `inline-block` }, ref: `counterRef` }), e2.tail ? e2.tail() : null]);
} });
export {
  d as t
};
