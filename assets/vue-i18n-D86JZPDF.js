import { L as Qe, i as ea, Z as gn, b as Ae, j as oe, e as ta, B as Et, k as na, l as aa, b1 as ra, X as la, d as vt, h as Ln, F as Nn, u as sa, aQ as ca } from "./index-B7M3Zrzb.js";
function oa(e, t) {
...
function nl(e, t, ...n) {
  ...
  (!w(r.globalInstall) || r.globalInstall) && ([l ? "i18n" : on.name, "I18nT"].forEach((s) => e.component(s, on)), [un.name, "I18nN"].forEach((s) => e.component(s, un)), [fn.name, "I18nD"].forEach((s) => e.component(s, fn))), e.directive("t", tl(t));
}
function al(e, t, n) {
  return { beforeCreate() {
    const r = Qe();
