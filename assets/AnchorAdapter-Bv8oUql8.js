import { E as e, M as t, S as n, at as r, ct as i, f as a, g as o, lt as s, ot as c, p as l, ut as u, v as d } from "./Card-BhZanKs1.js";
import { Q as f, Y as p, it as m, p as h, y as g } from "./light-12JaccNJ.js";
import { At as _, Dt as v, Jt as y, Lt as b, St as x, Tt as S, Zt as C, gt as w, mt as T, ot as E, vt as D } from "./index-CkQURd6u.js";
import { n as O, r as k, t as A } from "./attribute-CdVL_oFh.js";
import { t as j } from "./light-D0CHWkZT.js";
function M(e2) {
...
var R = T({ name: `Affix`, props: I, setup(e2) {
  ...
  l(`-affix`, N, t2);
  let n2 = null, r2 = y(false), i2 = y(false), a2 = y(null), o2 = y(null), s2 = E(() => i2.value || r2.value), c2 = E(() => e2.triggerTop ?? e2.offsetTop ?? e2.top), u2 = E(() => e2.top ?? e2.triggerTop ?? e2.offsetTop), f2 = E(() => e2.bottom ?? e2.triggerBottom ?? e2.offsetBottom), p2 = E(() => e2.triggerBottom ?? e2.offsetBottom ?? e2.bottom), h2 = y(null), g2 = () => {
...
var B = T({ name: `AnchorLink`, props: { title: String, href: String }, slots: Object, setup(e2, { slots: t2 }) {
  let r2 = y(null), i2 = D(z), a2 = C(e2, `href`), o2 = f(() => a2.value && a2.value === i2.activeHref.value);
