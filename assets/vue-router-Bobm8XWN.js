import { Bt as e, Et as t, Jt as n, Mt as r, Ot as i, an as a, dn as o, gt as s, on as c, rn as l, sn as u, wt as d } from "./index-DTVnoW_1.js";
...
function $e(e2) {
  let t2 = i(J), n2 = i(De), r2 = s(() => {
    let n3 = o(e2.to);
    return t2.resolve(n3);
  }), a2 = s(() => {
    let { matched: e3 } = r2.value, { length: t3 } = e3, i2 = e3[t3 - 1], a3 = n2.matched;
    if (!i2 || !a3.length) return -1;
    let o2 = a3.findIndex(M.bind(null, i2));
    if (o2 > -1) return o2;
    let s2 = it(e3[t3 - 2]);
    return t3 > 1 && it(i2) === s2 && a3[a3.length - 1].path !== s2 ? a3.findIndex(M.bind(null, e3[t3 - 2])) : o2;
  }), c2 = s(() => a2.value > -1 && rt(n2.params, r2.value.params)), l2 = s(() => a2.value > -1 && a2.value === n2.matched.length - 1 && N(n2.params, r2.value.params));
  function u2(n3 = {}) {
    if (nt(n3)) {
      let n4 = t2[o(e2.replace) ? `replace` : `push`](o(e2.to)).catch(_);
      return e2.viewTransition && typeof document < `u` && `startViewTransition` in document && document.startViewTransition(() => n4), n4;
    }
    return Promise.resolve();
  }
  return { route: r2, href: s(() => r2.value.href), isActive: c2, isExactActive: l2, navigate: u2 };
}
function et(e2) {
  return e2.length === 1 ? e2[0] : e2;
}
var tt = d({ name: `RouterLink`, compatConfig: { MODE: 3 }, props: { to: { type: [String, Object], required: true }, replace: Boolean, activeClass: String, exactActiveClass: String, custom: Boolean, ariaCurrentValue: { type: String, default: `page` }, viewTransition: Boolean }, useLink: $e, setup(e2, { slots: n2 }) {
  let r2 = l($e(e2)), { options: a2 } = i(J), o2 = s(() => ({ [at(e2.activeClass, a2.linkActiveClass, `router-link-active`)]: r2.isActive, [at(e2.exactActiveClass, a2.linkExactActiveClass, `router-link-exact-active`)]: r2.isExactActive }));
  return () => {
    let i2 = n2.default && et(n2.default(r2));
    return e2.custom ? i2 : t(`a`, { "aria-current": r2.isExactActive ? e2.ariaCurrentValue : null, href: r2.href, onClick: r2.navigate, class: o2.value }, i2);
  };
} });
function nt(e2) {
...
var at = (e2, t2, n2) => e2 ?? t2 ?? n2, ot = d({ name: `RouterView`, inheritAttrs: false, props: { name: { type: String, default: `default` }, route: Object }, compatConfig: { MODE: 3 }, setup(r2, { attrs: c2, slots: l2 }) {
  let u2 = i(Oe), d2 = s(() => r2.route || u2.value), f2 = i(Ee, 0), p2 = s(() => {
    let e2 = o(f2), { matched: t2 } = d2.value, n2;
    for (; (n2 = t2[e2]) && !n2.components; ) e2++;
    return e2;
  }), m2 = s(() => d2.value.matched[p2.value]);
  e(Ee, s(() => p2.value + 1)), e(Te, m2), e(Oe, d2);
  let g2 = a();
  return n(() => [g2.value, m2.value, r2.name], ([e2, t2, n2], [r3, i2, a2]) => {
    t2 && (t2.instances[n2] = e2, i2 && i2 !== t2 && e2 && e2 === r3 && (t2.leaveGuards.size || (t2.leaveGuards = i2.leaveGuards), t2.updateGuards.size || (t2.updateGuards = i2.updateGuards))), e2 && t2 && (!i2 || !M(t2, i2) || !r3) && (t2.enterCallbacks[n2] || []).forEach((t3) => t3(e2));
  }, { flush: `post` }), () => {
    let e2 = d2.value, n2 = r2.name, i2 = m2.value, a2 = i2 && i2.components[n2];
    if (!a2) return st(l2.default, { Component: a2, route: e2 });
    let o2 = i2.props[n2], s2 = t(a2, h({}, o2 ? o2 === true ? e2.params : typeof o2 == `function` ? o2(e2) : o2 : null, c2, { onVnodeUnmounted: (e3) => {
      e3.component.isUnmounted && (i2.instances[n2] = null);
    }, ref: g2 }));
    return st(l2.default, { Component: s2, route: e2 }) || s2;
  };
} });
function st(e2, t2) {
  if (!e2) return null;
...
var ct = ot;
function lt(e2) {
  let t2 = We(e2.routes, e2), n2 = e2.parseQuery || Se, i2 = e2.stringifyQuery || Ce, a2 = e2.history, s2 = Y(), l2 = Y(), d2 = Y(), p2 = u(I), m2 = I;
  ...
  function ne2(e3, n3) {
    let r2, i3;
    return be(e3) ? (r2 = t2.getRecordMatcher(e3), i3 = n3) : i3 = e3, t2.addRoute(i3, r2);
  }
  function re2(e3) {
  ...
  function b2(e3, r2) {
    if (r2 = h({}, r2 || p2.value), typeof e3 == `string`) {
      let i3 = j(n2, e3, r2.path), o3 = t2.resolve({ path: i3.path }, r2), s4 = a2.createHref(i3.fullPath);
      return h(i3, o3, { params: te2(o3.params), hash: k(i3.hash), redirectedFrom: void 0, href: s4 });
    }
    let o2;
    if (e3.path != null) o2 = h({}, e3, { path: j(n2, e3.path, r2.path).path });
    else {
      let t3 = h({}, e3.params);
      for (let e4 in t3) t3[e4] ?? delete t3[e4];
      o2 = h({}, e3, { params: y2(t3) }), r2.params = y2(r2.params);
    }
    let s3 = t2.resolve(o2, r2), c2 = e3.hash || ``;
    s3.params = ee2(te2(s3.params));
    let l3 = fe(i2, h({}, e3, { hash: ce(c2), path: s3.path })), u2 = a2.createHref(l3);
    return h({ fullPath: l3, hash: c2, query: i2 === Ce ? we(e3.query) : e3.query || {} }, s3, { redirectedFrom: void 0, href: u2 });
  }
  function x2(e3) {
  ...
  function T2(e3, t3) {
    let n3 = m2 = b2(e3), r2 = p2.value, a3 = e3.state, o2 = e3.force, s3 = e3.replace === true, c2 = oe2(n3, r2);
    if (c2) return T2(h(x2(c2), { state: typeof c2 == `object` ? h({}, a3, c2.state) : a3, force: o2, replace: s3 }), t3 || n3);
    let l3 = n3;
    l3.redirectedFrom = t3;
    let u2;
    return !o2 && pe(i2, r2, n3) && (u2 = K(G.NAVIGATION_DUPLICATED, { to: l3, from: r2 }), z2(r2, r2, true, false)), (u2 ? Promise.resolve(u2) : D2(l3, r2)).catch((e4) => q(e4) ? q(e4, G.NAVIGATION_GUARD_REDIRECT) ? e4 : R2(e4) : F2(e4, l3, r2)).then((e4) => {
      if (e4) {
        if (q(e4, G.NAVIGATION_GUARD_REDIRECT)) return T2(h({ replace: s3 }, x2(e4.to), { state: typeof e4.to == `object` ? h({}, a3, e4.to.state) : a3, force: o2 }), t3 || l3);
      } else e4 = O2(l3, r2, true, s3, a3);
  ...
  function D2(e3, t3) {
    let n3, [r2, i3, a3] = Ae(e3, t3);
    n3 = ke(r2.reverse(), `beforeRouteLeave`, e3, t3);
    ...
    return n3.push(o2), W2(n3).then(() => {
      ...
      n3 = ke(i3, `beforeRouteUpdate`, e3, t3);
      ...
      n3 = [];
      for (let r3 of a3) if (r3.beforeEnter) if (v(r3.beforeEnter)) for (let i4 of r3.beforeEnter) n3.push(X(i4, e3, t3));
      else n3.push(X(r3.beforeEnter, e3, t3));
      return n3.push(o2), W2(n3);
    }).then(() => (e3.matched.forEach((e4) => e4.enterCallbacks = {}), n3 = ke(a3, `beforeRouteEnter`, e3, t3, E2), n3.push(o2), W2(n3))).then(() => {
      n3 = [];
      for (let r3 of l2.list()) n3.push(X(r3, e3, t3));
      return n3.push(o2), W2(n3);
    }).catch((e4) => q(e4, G.NAVIGATION_CANCELLED) ? e4 : Promise.reject(e4));
  }
  function le2(e3, t3, n3) {
    d2.list().forEach((r2) => E2(() => r2(e3, t3, n3)));
  }
  function O2(e3, t3, n3, r2, i3) {
    let o2 = S2(e3, t3);
    if (o2) return o2;
    let s3 = t3 === I, c2 = f ? history.state : {};
    n3 && (r2 || s3 ? a2.replace(e3.fullPath, h({ scroll: s3 && c2 && c2.scroll }, i3)) : a2.push(e3.fullPath, i3)), p2.value = e3, z2(e3, t3, n3, s3), R2();
  }
  let A2;
  function de2() {
    A2 || (A2 = a2.listen((e3, t3, n3) => {
      ...
      m2 = r2;
      let o2 = p2.value;
      f && ve(_e(o2.fullPath, n3.delta), he()), D2(r2, o2).catch((e4) => q(e4, G.NAVIGATION_ABORTED | G.NAVIGATION_CANCELLED) ? e4 : q(e4, G.NAVIGATION_GUARD_REDIRECT) ? (T2(h(x2(e4.to), { force: true }), r2).then((e5) => {
        q(e5, G.NAVIGATION_ABORTED | G.NAVIGATION_DUPLICATED) && !n3.delta && n3.type === L.pop && a2.go(-1, false);
      }).catch(_), Promise.reject()) : (n3.delta && a2.go(-n3.delta, false), F2(e4, r2, o2))).then((e4) => {
        e4 || (e4 = O2(r2, o2, false)), e4 && (n3.delta && !q(e4, G.NAVIGATION_CANCELLED) ? a2.go(-n3.delta, false) : n3.type === L.pop && q(e4, G.NAVIGATION_ABORTED | G.NAVIGATION_DUPLICATED) && a2.go(-1, false)), le2(r2, o2, e4);
      }).catch(_);
    }));
  }
  let M2 = Y(), N2 = Y(), P2;
  ...
  function z2(t3, n3, i3, a3) {
    let { scrollBehavior: o2 } = e2;
    if (!f || !o2) return Promise.resolve();
    let s3 = !i3 && ye(_e(t3.fullPath, 0)) || (a3 || !i3) && history.state && history.state.scroll || null;
    return r().then(() => o2(t3, n3, s3)).then((e3) => e3 && ge(e3)).catch((e3) => F2(e3, t3, n3));
  }
  let B2 = (e3) => a2.go(e3), V2, H2 = /* @__PURE__ */ new Set(), U2 = { currentRoute: p2, listening: true, addRoute: ne2, removeRoute: re2, clearRoutes: t2.clearRoutes, hasRoute: ae2, getRoutes: ie2, resolve: b2, options: e2, push: C2, replace: w2, go: B2, back: () => B2(-1), forward: () => B2(1), beforeEach: s2.add, beforeResolve: l2.add, afterEach: d2.add, onError: N2.add, isReady: me2, install(e3) {
    e3.component(`RouterLink`, tt), e3.component(`RouterView`, ct), e3.config.globalProperties.$router = U2, Object.defineProperty(e3.config.globalProperties, `$route`, { enumerable: true, get: () => o(p2) }), f && !V2 && p2.value === I && (V2 = true, C2(a2.location).catch((e4) => {
    }));
    let t3 = {};
    for (let e4 in I) Object.defineProperty(t3, e4, { get: () => p2.value[e4], enumerable: true });
    e3.provide(J, U2), e3.provide(De, c(t3)), e3.provide(Oe, p2);
    let n3 = e3.unmount;
