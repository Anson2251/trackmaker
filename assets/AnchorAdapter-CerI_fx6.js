import { E as e, M as t, S as n, at as r, ct as i, f as a, g as o, lt as s, ot as c, p as l, ut as u, v as d } from "./Card-kwg1fWHx.js";
import { Q as f, Y as p, it as m, p as h, y as g } from "./light-30G_vb0E.js";
import { At as _, Dt as v, Qt as y, Rt as b, St as x, Tt as S, Yt as C, gt as w, mt as T, ot as E, vt as D } from "./index-Vl7drdoJ.js";
import { n as O, r as k } from "./use-locale-BZ9gy2BI.js";
import { t as A } from "./attribute-CYcHpVst.js";
import { t as j } from "./light-Dw7Q2po3.js";
function M(e2) {
...
var R = T({ name: `Affix`, props: I, setup(e2) {
  ...
  l(`-affix`, N, t2);
  let n2 = null, r2 = C(false), i2 = C(false), a2 = C(null), o2 = C(null), s2 = E(() => i2.value || r2.value), c2 = E(() => e2.triggerTop ?? e2.offsetTop ?? e2.top), u2 = E(() => e2.top ?? e2.triggerTop ?? e2.offsetTop), f2 = E(() => e2.bottom ?? e2.triggerBottom ?? e2.offsetBottom), p2 = E(() => e2.triggerBottom ?? e2.offsetBottom ?? e2.bottom), h2 = C(null), g2 = () => {
...
var B = T({ name: `AnchorLink`, props: { title: String, href: String }, slots: Object, setup(e2, { slots: t2 }) {
  let r2 = C(null), i2 = D(z), a2 = y(e2, `href`), o2 = f(() => a2.value && a2.value === i2.activeHref.value);
...
var W = T({ name: `BaseAnchor`, props: Object.assign(Object.assign({}, H), { mergedClsPrefix: { type: String, required: true } }), setup(e2) {
  let t2 = [], n2 = [], r2 = C(null), i2 = C(null), a2 = C(null), o2 = C(null), s2 = false, c2 = E(() => e2.type === `block`), l2 = E(() => !c2.value && e2.showRail);
  function u2() {
  ...
  let f2, m2 = false, h2 = false, g2 = () => {
    if (h2) m2 = true;
      ...
      if (s2) return;
      T2(true), h2 = true, clearTimeout(f2), f2 = setTimeout(() => {
  ...
  return _(z, { activeHref: r2, mergedClsPrefix: y(e2, `mergedClsPrefix`), updateBarPosition: d2, setActiveHref: w2, collectedLinkHrefs: t2, titleEls: n2 }), v(() => {
  ...
  return this.internalScrollable ? w(h, null, { default: () => i2 }) : i2;
} }), G = c(`anchor`, `
 position: relative;
`, [u(`block`, `
 ...
 `)])])]), K = T({ name: `Anchor`, props: Object.assign(Object.assign(Object.assign(Object.assign({}, a.props), { affix: Boolean }), I), H), setup(e2, { slots: t2 }) {
  let { mergedClsPrefixRef: n2, inlineThemeDisabled: r2 } = d(e2), i2 = a(`Anchor`, `-anchor`, G, j, e2, n2), s2 = C(null), c2 = E(() => {
  ...
  }, renderAnchor: () => (l2 == null ? void 0 : l2.onRender(), w(W, Object.assign({ ref: s2, style: r2 ? void 0 : c2.value, class: l2 == null ? void 0 : l2.themeClass.value }, g(e2, U), { mergedClsPrefix: n2.value }), t2)) };
}, render() {
  return this.affix ? w(R, Object.assign({}, g(this, L)), { default: this.renderAnchor }) : this.renderAnchor();
} });
export {
  B as n,
  K as t
