...
const nO = new i((O, $) => {
  ...
  for (let Q = false, t = 0, a = 0; ; a++) {
    let { next: n } = O;
    if (o(n) || n == l || n == m || Q && y(n)) !Q && (n != l || a > 0) && (Q = true), t === a && n == l && t++, O.advance();
