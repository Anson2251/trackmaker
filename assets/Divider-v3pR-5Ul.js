import { ct as e, f as t, g as n, lt as r, ot as i, ut as a, v as o } from "./Card-wTK5VWgg.js";
import { _t as s, ht as c, nt as l, st as u } from "./index-C4uc8sCV.js";
import { t as d } from "./light-Ca1mwIGX.js";
var f = i(`divider`, `
 position: relative;
 display: flex;
 width: 100%;
...
`, [a(`vertical`, `
 ...
 `), a(`dashed`, [e(`line`, { backgroundColor: `var(--n-color)` })]), r(`dashed`, [e(`line`, { borderColor: `var(--n-color)` })]), r(`vertical`, { backgroundColor: `var(--n-color)` })]), p = c({ name: `Divider`, props: Object.assign(Object.assign({}, t.props), { titlePlacement: { type: String, default: `center` }, dashed: Boolean, vertical: Boolean }), setup(e2) {
  let { mergedClsPrefixRef: r2, inlineThemeDisabled: i2 } = o(e2), a2 = t(`Divider`, `-divider`, f, d, e2, r2), s2 = u(() => {
