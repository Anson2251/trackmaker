...
const qo = Object.assign(Object.assign({}, oo), { rawNodes: { type: Array, default: () => [] }, tmNodes: { type: Array, default: () => [] }, tmNode: { type: Object, required: true }, disabled: Boolean, icon: Function, onClick: Function, domId: String, virtualChildActive: { type: Boolean, default: void 0 }, isEllipsisPlaceholder: Boolean }), ul = Xe(qo), $e = Q({ name: "Submenu", props: qo, setup(e) {
  ...
  sA((x) => ({ v133e17ef: f.value ? "column" : "row" }));
  ...
  const n = [{ label: () => v(Se, { to: "/tracker" }, { default: () => t("router.tracker").value }), key: "tracker", icon: l(ht) }, { label: () => v(Se, { to: "/sketch-centre" }, { default: () => t("router.sketchCentre").value }), key: "sketch-centre", icon: l(pt) }], c = [{ label: () => v(Se, { to: "/settings" }, { default: () => t("router.settings").value }), key: "settings", icon: l(gt) }, { label: () => v(Se, { to: "/about" }, { default: () => t("router.about").value }), key: "about", icon: l(vt) }], a = E(() => o.path.slice(1)), { width: m, height: h } = ct(), f = E(() => m.value > h.value);
...
} }), Pl = fo(zl, [["__scopeId", "data-v-0fdf21f3"]]);
var Ve, ho;
function Rl() {
