...
let mo = true;
function bt() {
  return vt ? (Be === 0 && Ct(), mo && (mo = uA()) && (Co(() => {
    Be += 1;
  }), AA(() => {
    Be -= 1, Be === 0 && ft();
  })), ro(me)) : ro(me);
}
const xt = O({ name: "ChevronDownFilled", render() {
...
} }, kt = { name: "Anchor", common: u, self: xA };
function Et(e) {
...
const $ = IA({ name: "Input", common: u, peers: { Scrollbar: V }, self: Et }), wt = { name: "AutoComplete", common: u, peers: { InternalSelectMenu: xe, Input: $ }, self: BA }, Ho = { name: "Avatar", common: u, self: yA }, Dt = { name: "AvatarGroup", common: u, peers: { Avatar: Ho }, self: kA }, zt = { name: "BackTop", common: u, self(e) {
...
} }, Rt = { name: "Breadcrumb", common: u, self: wA }, G = { name: "Button", common: u, self(e) {
  const o = DA(e);
...
} }, Mt = { name: "Calendar", common: u, peers: { Button: G }, self: zA }, Qo = { name: "Card", common: u, self(e) {
...
} }, Ht = { name: "Carousel", common: u, self: RA }, ve = { name: "Checkbox", common: u, self(e) {
  const { cardColor: o } = e, A = MA(e);
  return A.color = "#0000", A.checkMarkColor = o, A;
} }, Qt = { name: "Cascader", common: u, peers: { InternalSelectMenu: xe, InternalSelection: qe, Scrollbar: V, Checkbox: ve, Empty: QA }, self: HA }, Oo = { name: "Code", common: u, self(e) {
...
} }, Ot = { name: "Collapse", common: u, self: OA }, Tt = { name: "CollapseTransition", common: u, self: TA }, Ft = { name: "ColorPicker", common: u, peers: { Input: $, Button: G }, self: FA }, To = { name: "Popselect", common: u, peers: { Popover: ge, InternalSelectMenu: xe } }, Fo = { name: "Select", common: u, peers: { InternalSelection: qe, InternalSelectMenu: xe }, self: LA }, Lo = { name: "Pagination", common: u, peers: { Select: Fo, Input: $, Popselect: To }, self(e) {
...
} }, Lt = { name: "DataTable", common: u, peers: { Button: G, Checkbox: ve, Radio: jo, Pagination: Lo, Scrollbar: V, Empty: pe, Popover: ge, Ellipsis: Vo, Dropdown: Ue }, self(e) {
  const o = ZA(e);
  return o.boxShadowAfter = "inset 12px 0 8px -12px rgba(0, 0, 0, .36)", o.boxShadowBefore = "inset -12px 0 8px -12px rgba(0, 0, 0, .36)", o;
} }, Vt = { name: "Icon", common: u, self: GA }, No = { name: "TimePicker", common: u, peers: { Scrollbar: V, Button: G, Input: $ }, self: $A }, jt = { name: "DatePicker", common: u, peers: { Input: $, Button: G, TimePicker: No, Scrollbar: V }, self(e) {
...
} }, Nt = { name: "Descriptions", common: u, self: KA }, Wo = { name: "Dialog", common: u, peers: { Button: G }, self: JA }, Wt = { name: "Modal", common: u, peers: { Scrollbar: V, Dialog: Wo, Card: Qo }, self: XA }, Zt = he("n-modal-provider"), Gt = he("n-modal-api"), $t = he("n-modal-reactive-list"), Yt = Object.assign(Object.assign({}, UA), { onAfterEnter: Function, onAfterLeave: Function, transformOrigin: String, blockScroll: { type: Boolean, default: true }, closeOnEsc: { type: Boolean, default: true }, onEsc: Function, autoFocus: { type: Boolean, default: true }, internalStyle: [String, Object], maskClosable: { type: Boolean, default: true }, zIndex: Number, onPositiveClick: Function, onNegativeClick: Function, onClose: Function, onMaskClick: Function, draggable: [Boolean, Object] }), Kt = O({ name: "DialogEnvironment", props: Object.assign(Object.assign({}, Yt), { internalKey: { type: String, required: true }, to: [String, Object], onInternalAfterLeave: { type: Function, required: true } }), setup(e) {
  const o = Z(true);
  function A() {
...
} }), Jt = { injectionKey: String, to: [String, Object] }, Xt = O({ name: "DialogProvider", props: Jt, setup() {
  const e = Z([]), o = {};
  function A(c = {}) {
  ...
  var e, o;
  return v(De, null, [this.dialogList.map((A) => v(Kt, Ke(A, ["destroy", "style"], { internalStyle: A.style, to: this.to, ref: (t) => {
...
} }), qt = { name: "LoadingBar", common: u, self(e) {
  const { primaryColor: o } = e;
  return { colorError: "red", colorLoading: o, height: "2px" };
} }, Ut = { name: "Message", common: u, self: rr }, Zo = { icon: Function, type: { type: String, default: "info" }, content: [String, Number, Function], showIcon: { type: Boolean, default: true }, closable: Boolean, keepAliveOnHover: Boolean, onClose: Function, onMouseenter: Function, onMouseleave: Function }, _t = w([E("message-wrapper", `
 margin: var(--n-margin);
 z-index: 0;
 ...
 justify-content: flex-end;
 align-items: flex-end;
 `)])]), en = { info: () => v(mr, null), success: () => v(ur, null), warning: () => v(dr, null), error: () => v(cr, null), default: () => null }, on = O({ name: "Message", props: Object.assign(Object.assign({}, Zo), { render: Function }), setup(e) {
  const { inlineThemeDisabled: o, mergedRtlRef: A } = Je(e), { props: t, mergedClsPrefixRef: r } = re(ko), i = ar("Message", A, r), l = Pe("Message", "-message", _t, sr, t, r), c = D(() => {
  ...
  c == null ? void 0 : c();
  let m;
  return v("div", { class: [`${r}-message-wrapper`, l], onMouseenter: this.onMouseenter, onMouseleave: this.onMouseleave, style: [{ alignItems: this.placement.startsWith("top") ? "flex-start" : "flex-end" }, i] }, e ? e(this.$props) : v("div", { class: [`${r}-message ${r}-message--${o}-type`, this.rtlEnabled && `${r}-message--rtl`] }, (m = An(n, o, r)) && a ? v("div", { class: `${r}-message__icon ${r}-message__icon--${o}-type` }, v(nr, null, { default: () => m })) : null, v("div", { class: `${r}-message__content` }, ue(t)), A ? v(lr, { clsPrefix: r, class: `${r}-message__close`, onClick: s, absolute: true }) : null));
} });
function An(e, o, A) {
  if (typeof e == "function") return e();
  {
    const t = o === "loading" ? v(ir, { clsPrefix: A, strokeWidth: 24, scale: 0.85 }) : en[o]();
    return t ? v(wo, { clsPrefix: A, key: o }, { default: () => t }) : null;
  }
}
const rn = O({ name: "MessageEnvironment", props: Object.assign(Object.assign({}, Zo), { duration: { type: Number, default: 3e3 }, onAfterLeave: Function, onLeave: Function, internalKey: { type: String, required: true }, onInternalAfterLeave: Function, onHide: Function, onAfterHide: Function }), setup(e) {
  let o = null;
  const A = Z(true);
  bo(() => {
    t();
  ...
  return v(Do, { appear: true, onAfterLeave: this.handleAfterLeave, onLeave: this.onLeave }, { default: () => [this.show ? v(on, { content: this.content, type: this.type, icon: this.icon, showIcon: this.showIcon, closable: this.closable, onClose: this.handleClose, onMouseenter: this.keepAliveOnHover ? this.handleMouseenter : void 0, onMouseleave: this.keepAliveOnHover ? this.handleMouseleave : void 0 }) : null] });
} }), tn = Object.assign(Object.assign({}, Pe.props), { to: [String, Object], duration: { type: Number, default: 3e3 }, keepAliveOnHover: Boolean, max: Number, placement: { type: String, default: "top" }, closable: Boolean, containerClass: String, containerStyle: [String, Object] }), nn = O({ name: "MessageProvider", props: tn, setup(e) {
...
} }), ln = O({ name: "ModalEnvironment", props: Object.assign(Object.assign({}, pr), { internalKey: { type: String, required: true }, onInternalAfterLeave: { type: Function, required: true } }), setup(e) {
  const o = Z(true);
  function A() {
    const { onInternalAfterLeave: a, internalKey: m, onAfterLeave: h } = e;
    a && a(m), h && h();
...
} }), an = { to: [String, Object] }, sn = O({ name: "ModalProvider", props: an, setup() {
  const e = Z([]), o = {};
  function A(l = {}) {
  ...
  return L(Gt, i), L(Zt, { clickedRef: Bo(64), clickedPositionRef: So() }), L($t, e), Object.assign(Object.assign({}, i), { modalList: e, modalInstRefs: o, handleAfterLeave: t });
}, render() {
  var e, o;
  return v(De, null, [this.modalList.map((A) => {
    var t;
    return v(ln, Ke(A, ["destroy", "render"], { to: (t = A.to) !== null && t !== void 0 ? t : this.to, ref: (r) => {
...
} }), cn = { name: "Notification", common: u, peers: { Scrollbar: V }, self: gr }, dn = { name: "Divider", common: u, self: vr }, un = { name: "Drawer", common: u, peers: { Scrollbar: V }, self: Cr }, mn = { name: "DynamicInput", common: u, peers: { Input: $, Button: G }, self() {
  return fr;
} }, Go = { name: "Space", self() {
  return br;
} }, hn = { name: "DynamicTags", common: u, peers: { Input: $, Button: G, Tag: Mo, Space: Go }, self() {
  return { inputWidth: "64px" };
} }, pn = { name: "Element", common: u }, gn = { name: "Flex", self() {
  return xr;
} }, vn = { name: "ButtonGroup", common: u }, Cn = { name: "Form", common: u, self: Ir }, fn = { name: "GradientText", common: u, self(e) {
...
} }, bn = { name: "InputNumber", common: u, peers: { Button: G, Input: $ }, self(e) {
  const { textColorDisabled: o } = e;
  return { iconColorDisabled: o };
} }, xn = { name: "InputOtp", common: u, peers: { Input: $ }, self: Sr }, In = { name: "Layout", common: u, peers: { Scrollbar: V }, self(e) {
...
} }, Sn = { name: "Row", common: u }, Bn = { name: "List", common: u, self: Br }, yn = { name: "Log", common: u, peers: { Scrollbar: V, Code: Oo }, self(e) {
...
} }, kn = { name: "Mention", common: u, peers: { InternalSelectMenu: xe, Input: $ }, self(e) {
  const { boxShadow2: o } = e;
  return { menuBoxShadow: o };
} }, En = { name: "Menu", common: u, peers: { Tooltip: Re, Dropdown: Ue }, self(e) {
...
} }, wn = { name: "PageHeader", common: u, self: kr }, Dn = { name: "Popconfirm", common: u, peers: { Button: G, Popover: ge }, self: Er }, $o = { name: "Progress", common: u, self(e) {
  const o = wr(e);
...
} }, Mn = { name: "Spin", common: u, self: Pr }, Hn = { name: "Statistic", common: u, self: Rr }, Qn = { name: "Steps", common: u, self: Mr }, On = { name: "Switch", common: u, self(e) {
...
} }, Tn = { name: "Table", common: u, self: Qr }, Fn = { name: "Tabs", common: u, self(e) {
  const o = Or(e), { inputColor: A } = e;
  return o.colorSegment = A, o.tabColorSegment = A, o;
} }, Ln = { name: "Thing", common: u, self: Tr }, Vn = { name: "Timeline", common: u, self(e) {
...
} }, jn = { name: "Transfer", common: u, peers: { Checkbox: ve, Scrollbar: V, Input: $, Empty: pe, Button: G }, self(e) {
...
} }, Nn = { name: "TreeSelect", common: u, peers: { Tree: Yo, Empty: pe, InternalSelection: qe } }, Wn = { name: "Typography", common: u, self: jr }, Zn = { name: "Upload", common: u, peers: { Button: G, Progress: $o }, self(e) {
  const { errorColor: o } = e, A = Nr(e);
  return A.itemColorHoverError = C(o, { alpha: 0.09 }), A;
} }, Gn = { name: "Watermark", common: u, self(e) {
  const { fontFamily: o } = e;
  return { fontFamily: o };
} }, $n = { name: "FloatButton", common: u, self(e) {
  ...
  Co(() => {
    Ne(() => {
      var i, l;
      const { textColor2: c, fontSize: n, fontFamily: s, bodyColor: a, cubicBezierEaseInOut: m, lineHeight: h } = e ? Zr({}, ((i = e.mergedThemeRef.value) === null || i === void 0 ? void 0 : i.common) || io, (l = e.mergedThemeOverridesRef.value) === null || l === void 0 ? void 0 : l.common) : io;
  ...
  return null;
} }), Kn = { name: "Heatmap", common: u, self(e) {
  const o = Gr(e);
...
} }, Jn = { name: "IconWrapper", common: u, self: $r }, Xn = { name: "Image", common: u, peers: { Tooltip: Re }, self: (e) => {
  const { textColor2: o } = e;
  return { toolbarIconColor: o, toolbarColor: "rgba(0, 0, 0, .35)", toolbarBoxShadow: "none", toolbarBorderRadius: "24px" };
} }, qn = he("n-layout-sider"), Un = { name: "Transfer", common: u, peers: { Checkbox: ve, Scrollbar: V, Input: $, Empty: pe, Button: G }, self(e) {
...
} }, _n = { name: "Marquee", common: u, self: Kr }, Ie = he("n-menu"), Ko = he("n-submenu"), _e = he("n-menu-item-group"), ho = [w("&::before", "background-color: var(--n-item-color-hover);"), B("arrow", `
...
const oo = { internalKey: { type: [String, Number], required: true }, root: Boolean, isGroup: Boolean, level: { type: Number, required: true }, title: [String, Function], extra: [String, Function] }, ol = O({ name: "MenuDivider", setup() {
  const e = re(Ie), { mergedClsPrefixRef: o, isHorizontalRef: A } = e;
  return () => A.value ? null : v("div", { class: `${o.value}-menu-divider` });
} }), Xo = Object.assign(Object.assign({}, oo), { tmNode: { type: Object, required: true }, disabled: Boolean, icon: Function, onClick: Function }), Al = Xe(Xo), rl = O({ name: "MenuOption", props: Xo, setup(e) {
...
} }), qo = Object.assign(Object.assign({}, oo), { tmNode: { type: Object, required: true }, tmNodes: { type: Array, required: true } }), tl = Xe(qo), nl = O({ name: "MenuOptionGroup", props: qo, setup(e) {
...
function Ao(e, o) {
  ...
  if (Ge(A)) return ll(A) ? v(ol, Object.assign({ key: e.key }, A.props)) : null;
  ...
  return e.children ? e.isGroup ? v(nl, ke(n, tl, { tmNode: e, tmNodes: e.children, key: i })) : v($e, ke(n, al, { key: i, rawNodes: A[o.childrenField], tmNodes: e.children, tmNode: e })) : v(rl, ke(n, Al, { key: i, tmNode: e }));
}
const Uo = Object.assign(Object.assign({}, oo), { rawNodes: { type: Array, default: () => [] }, tmNodes: { type: Array, default: () => [] }, tmNode: { type: Object, required: true }, disabled: Boolean, icon: Function, onClick: Function, domId: String, virtualChildActive: { type: Boolean, default: void 0 }, isEllipsisPlaceholder: Boolean }), al = Xe(Uo), $e = O({ name: "Submenu", props: Uo, setup(e) {
  ...
  const { mergedClsPrefixRef: o, inlineThemeDisabled: A } = Je(e), t = Pe("Menu", "-menu", el, et, e, o), r = re(qn, null), i = D(() => {
    var f;
    const { collapsed: k } = e;
...
} }), sl = { name: "QrCode", common: u, self: (e) => ({ borderRadius: e.borderRadius }) }, cl = { name: "Skeleton", common: u, self(e) {
...
} }, dl = { name: "Split", common: u }, ul = { name: "Equation", common: u, self: ot }, ml = { name: "FloatButtonGroup", common: u, self(e) {
...
} }, hl = { name: "dark", common: u, Alert: yt, Anchor: kt, AutoComplete: wt, Avatar: Ho, AvatarGroup: Dt, BackTop: zt, Badge: Pt, Breadcrumb: Rt, Button: G, ButtonGroup: vn, Calendar: Mt, Card: Qo, Carousel: Ht, Cascader: Qt, Checkbox: ve, Code: Oo, Collapse: Ot, CollapseTransition: Tt, ColorPicker: Ft, DataTable: Lt, DatePicker: jt, Descriptions: Nt, Dialog: Wo, Divider: dn, Drawer: un, Dropdown: Ue, DynamicInput: mn, DynamicTags: hn, Element: pn, Empty: pe, Ellipsis: Vo, Equation: ul, Flex: gn, Form: Cn, GradientText: fn, Heatmap: Kn, Icon: Vt, IconWrapper: Jn, Image: Xn, Input: $, InputNumber: bn, InputOtp: xn, LegacyTransfer: Un, Layout: In, List: Bn, LoadingBar: qt, Log: yn, Menu: En, Mention: kn, Message: Ut, Modal: Wt, Notification: cn, PageHeader: wn, Pagination: Lo, Popconfirm: Dn, Popover: ge, Popselect: To, Progress: $o, QrCode: sl, Radio: jo, Rate: zn, Result: Pn, Row: Sn, Scrollbar: V, Select: Fo, Skeleton: cl, Slider: Rn, Space: Go, Spin: Mn, Statistic: Hn, Steps: Qn, Switch: On, Table: Tn, Tabs: Fn, Tag: Mo, Thing: Ln, TimePicker: No, Timeline: Vn, Tooltip: Re, Transfer: jn, Tree: Yo, TreeSelect: Nn, Typography: Wn, Upload: Zn, Watermark: Gn, Split: dl, FloatButton: $n, FloatButtonGroup: ml, Marquee: _n }, pl = { key: 0, class: "nav-bar" }, gl = { class: "software-info-menu" }, vl = { style: { width: "100%" } }, Cl = { key: 0, style: { width: "100%", "text-align": "center", padding: "4px" } }, fl = { key: 1, class: "nav-bar" }, bl = { key: 0, style: { width: "100%", "text-align": "center", padding: "4px" } }, xl = { class: "main-layout" }, Il = O({ __name: "AppLayout", setup(e) {
  lA((I) => ({ dba89f70: S.value ? "column" : "row" }));
  const o = At(), A = zo(), t = new Po(), { t: r, locale: i } = ut();
  function l(I) {
  ...
  const c = [{ label: () => v(Se, { to: "/tracker" }, { default: () => r("router.tracker") }), key: "tracker", icon: l(at) }, { label: () => v(Se, { to: "/sketch-centre" }, { default: () => r("router.sketchCentre") }), key: "sketch-centre", icon: l(it) }], n = [{ label: () => v(Se, { to: "/settings" }, { default: () => r("router.settings") }), key: "settings", icon: l(st) }, { label: () => v(Se, { to: "/about" }, { default: () => r("router.about") }), key: "about", icon: l(ht) }], s = D(() => o.path.slice(1)), a = `aa26a46
`, m = false, { width: h, height: b } = rt(), S = D(() => h.value > b.value);
  return (I, z) => (ee(), ce("div", { class: fo(["app-layout", S.value ? "app-layout-horizontal" : "app-layout-vertical"]) }, [S.value ? (ee(), ce("div", pl, [F(H(Le), { options: c, "default-value": "tracker", value: s.value, mode: S.value ? "vertical" : "horizontal" }, null, 8, ["value", "mode"]), oe("div", gl, [oe("div", vl, [F(H(Le), { options: n, mode: S.value ? "vertical" : "horizontal", value: s.value }, null, 8, ["mode", "value"])]), H(a) ? (ee(), ce("div", Cl, [F(H(co), { depth: "3" }, { default: K(() => [lo(ao(m ? "DEV MODE" : "Commit:" + H(a).toLocaleUpperCase()), 1)]), _: 1 })])) : no("", true)])])) : (ee(), ce("div", fl, [F(H(nt), { trigger: H(t).isMobile ? "click" : "hover", style: { padding: "2px 0", transform: "translateX(2px)" }, placement: "bottom-start" }, { trigger: K(() => [F(H(tt), { style: { width: "48px" } }, { icon: K(() => [F(H(uo), null, { default: K(() => [F(H(gt))]), _: 1 })]), _: 1 })]), default: K(() => [F(H(Le), { options: c.concat(n), "default-value": "tracker", value: s.value, "dropdown-placement": "top-start", mode: "vertical" }, null, 8, ["options", "value"])]), _: 1 }, 8, ["trigger"]), H(a) ? (ee(), ce("div", bl, [F(H(co), { depth: "3" }, { default: K(() => [lo(ao(m ? "DEV MODE" : "Commit:" + H(a).toLocaleUpperCase()), 1)]), _: 1 })])) : no("", true)])), oe("div", xl, [F(H(lt), null, { default: K(({ Component: M }) => [F(iA, { name: "slide-fade", mode: "out-in" }, { default: K(() => [(ee(), We(sA, null, [(ee(), We(cA(M), { key: s.value }))], 1024))]), _: 2 }, 1024)]), _: 1 })])], 2));
} }), Sl = dA(Il, [["__scopeId", "data-v-ee060632"]]);
function Bl(e) {
...
var El = kl();
const wl = Bl(El), Rl = O({ __name: "App", setup(e) {
  const o = zo(), A = window.GeolocationManager, t = bt(), r = D(() => (o.settings.theme === "system" ? t.value : o.settings.theme) === "dark" ? hl : ct), i = { common: { fontFamily: 'Barlow, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"' } };
  return L("platformInfo", new Po()), L("settings", o), L("noSleep", new wl()), L("geolocation", A), bo(() => o.init()), (l, c) => (ee(), We(H(dt), { theme: r.value, abstract: true, "inline-theme-disabled": true, "theme-overrides": i }, { default: K(() => [F(H(Xt), null, { default: K(() => [F(H(sn), null, { default: K(() => [F(H(nn), { placement: "bottom-right" }, { default: K(() => [F(Sl), F(H(Yn))]), _: 1 })]), _: 1 })]), _: 1 })]), _: 1 }, 8, ["theme"]));
} });
export {
  Rl as default
};
