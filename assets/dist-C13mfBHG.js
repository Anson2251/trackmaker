import { A as e, C as t, I as n, M as r, N as i, et as a, g as o, i as s, n as c, r as l, s as u, u as d, wt as f, y as p } from "./dist-CQp5Y4zm.js";
import { n as m } from "./dist-DYp_OIFV.js";
import "./dist-CjAScDBv.js";
import "./dist-Doi9LDAp.js";
var h = 1, g = 2, _ = 3, v = 155, y = 4, b = 156;
function x(e2) {
...
var S = new c((e2) => {
  ...
  for (; ; ) {
    ...
    if (n2 == 123) {
      ...
      if (n3 == 123) {
        ...
        for (; ; ) {
          let t3 = e2.peek(n4);
          if (t3 == 32 || t3 == 10) ++n4;
          else if (t3 == 35) for (++n4; ; ) {
            let t4 = e2.peek(n4);
            if (t4 < 0 || t4 == 10) break;
            n4++;
          }
          else if (t3 == 45 && r2 == 2) r2 = ++n4;
          else {
            e2.acceptToken(_, r2);
            return;
          }
    ...
    if (e2.advance(), n2 == 10) break;
  }
  e2.pos > t2 && e2.acceptToken(v);
});
function C(e2, t2, n2) {
  return new c((r2) => {
    let i2 = r2.pos;
    for (; ; ) {
      let { next: t3 } = r2;
      if (t3 == 123 && r2.peek(1) == 37) {
        let t4 = 2;
        for (; ; t4++) {
          let e3 = r2.peek(t4);
          if (e3 != 32 && e3 != 10) break;
        }
        let a2 = ``;
        for (; ; t4++) {
          let e3 = r2.peek(t4);
