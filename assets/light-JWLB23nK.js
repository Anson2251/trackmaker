import { A as e, D as t, M as n, N as r, P as i, _ as a, at as o, b as s, ct as c, d as l, dt as u, f as d, g as f, gt as p, ht as m, i as h, lt as g, o as _, ot as v, ut as y, v as b } from "./Card-wTK5VWgg.js";
import { D as x, H as S, J as ee, N as C, P as w, Q as T, R as E, X as D, c as O, d as k, et as A, h as j, i as M, l as N, m as te, o as ne, t as re, tt as P, u as ie, y as ae, z as oe } from "./light-DcazuQOY.js";
import { $t as F, Et as se, J as ce, Jt as le, Kt as ue, St as de, Tt as fe, Xt as I, Yt as pe, _t as L, ht as R, jt as z, nt as me, st as B, yt as V, zt as H } from "./index-C4uc8sCV.js";
import { I as U, P as he, c as ge, f as _e, h as ve, i as ye, k as be, l as xe, m as Se, o as Ce, r as we, u as Te, w as Ee } from "./sketch-store-9vGlGD5C.js";
import { n as De, t as Oe } from "./fade-in-scale-up.cssr-DAO-aMlH.js";
import { O as W, _ as G, a as ke, d as K, h as Ae, s as je, x as Me, y as q } from "./core-CbJDfFWz.js";
import { a as Ne, i as Pe, n as Fe, t as Ie } from "./light-DsJhCZoU.js";
import { t as Le } from "./light-BUxPVHlh.js";
import { t as Re } from "./light-B-J6tIen.js";
import { t as ze } from "./light-B0RSJa3-.js";
import { r as Be } from "./platform-AaRxPU_D.js";
import { i as Ve, r as He, t as Ue } from "./light-DB6RNQmt.js";
import { t as We } from "./light-Ca1mwIGX.js";
import { t as Ge } from "./light-BJk0FjVD.js";
import { t as Ke } from "./light-27ybxbZP.js";
function qe(e2 = {}, t2) {
  let n2 = le({ ctrl: false, command: false, win: false, shift: false, tab: false }), { keydown: r2, keyup: i2 } = e2, a2 = (e3) => {
    switch (e3.key) {
      case `Control`:
        n2.ctrl = true;
        break;
    ...
    (t2 === void 0 || t2.value) && (P(`keydown`, document, a2), P(`keyup`, document, o2)), t2 !== void 0 && H(t2, (e3) => {
...
var bt = { name: `CollapseTransition`, common: _, self: yt }, xt = R({ name: `ConfigProvider`, alias: [`App`], props: { abstract: Boolean, bordered: { type: Boolean, default: void 0 }, clsPrefix: String, locale: Object, dateLocale: Object, namespace: String, rtl: Array, tag: { type: String, default: `div` }, hljs: Object, katex: Object, theme: Object, themeOverrides: Object, componentOptions: Object, icons: Object, breakpoints: Object, preflightStyleDisabled: Boolean, styleMountTarget: Object, inlineThemeDisabled: { type: Boolean, default: void 0 }, as: { type: String, validator: () => (e(`config-provider`, "`as` is deprecated, please use `tag` instead."), true), default: void 0 } }, setup(e2) {
  ...
  return z(s, { mergedThemeHashRef: B(() => {
  ...
  var _a, _b;
  var e2, t2;
  return this.abstract ? (_a = (t2 = this.$slots).default) == null ? void 0 : _a.call(t2) : L(this.as || this.tag, { class: `${this.mergedClsPrefix || `n`}-config-provider` }, (_b = (e2 = this.$slots).default) == null ? void 0 : _b.call(e2));
} });
function St(e2) {
  let { boxShadow2: t2 } = e2;
  return { menuBoxShadow: t2 };
...
var Nt = R({ name: `DropdownDivider`, props: { clsPrefix: { type: String, required: true } }, render() {
  return L(`div`, { class: `${this.clsPrefix}-dropdown-divider` });
} }), Pt = R({ name: `DropdownGroupHeader`, props: { clsPrefix: { type: String, required: true }, tmNode: { type: Object, required: true } }, setup() {
  let { showIconRef: e2, hasSubmenuRef: t2 } = V(X), { renderLabelRef: n2, labelFieldRef: r2, nodePropsRef: i2, renderOptionRef: a2 } = V(Z);
  return { labelField: r2, showIcon: e2, hasSubmenu: t2, renderLabel: n2, nodeProps: i2, renderOption: a2 };
}, render() {
  let { clsPrefix: e2, hasSubmenu: t2, showIcon: n2, nodeProps: r2, renderLabel: i2, renderOption: a2 } = this, { rawNode: o2 } = this.tmNode, s2 = L(`div`, Object.assign({ class: `${e2}-dropdown-option` }, r2 == null ? void 0 : r2(o2)), L(`div`, { class: `${e2}-dropdown-option-body ${e2}-dropdown-option-body--group` }, L(`div`, { "data-dropdown-option": true, class: [`${e2}-dropdown-option-body__prefix`, n2 && `${e2}-dropdown-option-body__prefix--show-icon`] }, W(o2.icon)), L(`div`, { class: `${e2}-dropdown-option-body__label`, "data-dropdown-option": true }, i2 ? i2(o2) : W(o2.title ?? o2[this.labelField])), L(`div`, { class: [`${e2}-dropdown-option-body__suffix`, t2 && `${e2}-dropdown-option-body__suffix--has-submenu`], "data-dropdown-option": true })));
...
var Rt = R({ name: `DropdownOption`, props: { clsPrefix: { type: String, required: true }, tmNode: { type: Object, required: true }, parentKey: { type: [String, Number], default: null }, placement: { type: String, default: `right-start` }, props: Object, scrollable: Boolean }, setup(e2) {
  let t2 = V(Z), { hoverKeyRef: n2, keyboardKeyRef: r2, lastToggledSubmenuKeyRef: i2, pendingKeyPathRef: a2, activeKeyPathRef: o2, animatedRef: s2, mergedShowRef: c2, renderLabelRef: l2, renderIconRef: u2, labelFieldRef: d2, childrenFieldRef: f2, renderOptionRef: p2, nodePropsRef: m2, menuPropsRef: h2 } = t2, g2 = V(Mt, null), _2 = V(X), v2 = V(E), y2 = B(() => e2.tmNode.rawNode), b2 = B(() => {
    let { value: t3 } = f2;
  ...
  }), 300, B(() => r2.value === null && !s2.value)), ee2 = B(() => !!(g2 == null ? void 0 : g2.enteringSubmenuRef.value)), C2 = I(false);
  z(Mt, { enteringSubmenuRef: C2 });
  function w2() {
    C2.value = true;
  }
  function D2() {
  ...
  return { labelField: d2, renderLabel: l2, renderIcon: u2, siblingHasIcon: _2.showIconRef, siblingHasSubmenu: _2.hasSubmenuRef, menuProps: h2, popoverBody: v2, animated: s2, mergedShowSubmenu: B(() => S2.value && !ee2.value), rawNode: y2, hasSubmenu: b2, pending: T(() => {
  ...
  if (n2) {
    ...
    f2 = L(Vt, Object.assign({}, e3, { clsPrefix: r2, scrollable: this.scrollable, tmNodes: this.tmNode.children, parentKey: this.tmNode.key }));
  }
  let p2 = { class: [`${r2}-dropdown-option-body`, this.pending && `${r2}-dropdown-option-body--pending`, this.active && `${r2}-dropdown-option-body--active`, this.childActive && `${r2}-dropdown-option-body--child-active`, this.mergedDisabled && `${r2}-dropdown-option-body--disabled`], onMousemove: this.handleMouseMove, onMouseenter: this.handleMouseEnter, onMouseleave: this.handleMouseLeave, onClick: this.handleClick }, m2 = l2 == null ? void 0 : l2(t2), h2 = L(`div`, Object.assign({ class: [`${r2}-dropdown-option`, m2 == null ? void 0 : m2.class], "data-dropdown-option": true }, m2), L(`div`, de(p2, u2), [L(`div`, { class: [`${r2}-dropdown-option-body__prefix`, i2 && `${r2}-dropdown-option-body__prefix--show-icon`] }, [s2 ? s2(t2) : W(t2.icon)]), L(`div`, { "data-dropdown-option": true, class: `${r2}-dropdown-option-body__label` }, o2 ? o2(t2) : W(t2[this.labelField] ?? t2.title)), L(`div`, { "data-dropdown-option": true, class: [`${r2}-dropdown-option-body__suffix`, a2 && `${r2}-dropdown-option-body__suffix--has-submenu`] }, this.hasSubmenu ? L(He, null, { default: () => L(Ne, null) }) : null)]), this.hasSubmenu ? L(w, null, { default: () => [L(C, null, { default: () => L(`div`, { class: `${r2}-dropdown-offset-container` }, L(x, { show: this.mergedShowSubmenu, placement: this.placement, to: d2 && this.popoverBody || void 0, teleportDisabled: !d2 }, { default: () => L(`div`, { class: `${r2}-dropdown-menu-wrapper` }, e2 ? L(ce, { onBeforeEnter: this.handleSubmenuBeforeEnter, onAfterEnter: this.handleSubmenuAfterEnter, name: `fade-in-scale-up-transition`, appear: true }, { default: () => f2 }) : f2) })) })] }) : null);
  return c2 ? c2({ node: h2, option: t2 }) : h2;
} }), zt = R({ name: `NDropdownGroup`, props: { clsPrefix: { type: String, required: true }, tmNode: { type: Object, required: true }, parentKey: { type: [String, Number], default: null } }, render() {
  let { tmNode: t2, parentKey: n2, clsPrefix: r2 } = this, { children: i2 } = t2;
  return L(me, null, L(Pt, { clsPrefix: r2, tmNode: t2, key: t2.key }), i2 == null ? void 0 : i2.map((t3) => {
    let { rawNode: i3 } = t3;
    return i3.show === false ? null : It(i3) ? L(Nt, { clsPrefix: r2, key: t3.key }) : t3.isGroup ? (e(`dropdown`, "`group` node is not allowed to be put in `group` node."), null) : L(Rt, { clsPrefix: r2, tmNode: t3, parentKey: n2, key: t3.key });
  }));
} }), Bt = R({ name: `DropdownRenderOption`, props: { tmNode: { type: Object, required: true } }, render() {
  let { rawNode: { render: e2, props: t2 } } = this.tmNode;
  return L(`div`, t2, [e2 == null ? void 0 : e2()]);
} }), Vt = R({ name: `DropdownMenu`, props: { scrollable: Boolean, showArrow: Boolean, arrowStyle: [String, Object], clsPrefix: { type: String, required: true }, tmNodes: { type: Array, default: () => [] }, parentKey: { type: [String, Number], default: null } }, setup(e2) {
  let { renderIconRef: t2, childrenFieldRef: n2 } = V(Z);
  z(X, { showIconRef: B(() => {
    let n3 = t2.value;
  ...
  let r2 = I(null);
  return z(oe, null), z(S, null), z(E, r2), { bodyRef: r2 };
}, render() {
  let { parentKey: e2, clsPrefix: t2, scrollable: n2 } = this, r2 = this.tmNodes.map((r3) => {
    let { rawNode: i2 } = r3;
    return i2.show === false ? null : Lt(i2) ? L(Bt, { tmNode: r3, key: r3.key }) : It(i2) ? L(Nt, { clsPrefix: t2, key: r3.key }) : Ft(i2) ? L(zt, { clsPrefix: t2, tmNode: r3, parentKey: e2, key: r3.key }) : L(Rt, { clsPrefix: t2, tmNode: r3, parentKey: e2, key: r3.key, props: i2.props, scrollable: n2 });
  });
  return L(`div`, { class: [`${t2}-dropdown-menu`, n2 && `${t2}-dropdown-menu--scrollable`], ref: `bodyRef` }, n2 ? L(te, { contentClass: `${t2}-dropdown-menu__content` }, { default: () => r2 }) : r2, this.showArrow ? ie({ clsPrefix: t2, arrowStyle: this.arrowStyle, arrowClass: void 0, arrowWrapperClass: void 0, arrowWrapperStyle: void 0 }) : null);
} }), Ht = v(`dropdown-menu`, `
...
`, [Oe(), v(`dropdown-option`, `
 ...
 `)])]), Ut = { animated: { type: Boolean, default: true }, keyboard: { type: Boolean, default: true }, size: { type: String, default: `medium` }, inverted: Boolean, placement: { type: String, default: `bottom` }, onSelect: [Function, Array], options: { type: Array, default: () => [] }, menuProps: Function, showArrow: Boolean, renderLabel: Function, renderIcon: Function, renderOption: Function, nodeProps: Function, labelField: { type: String, default: `label` }, keyField: { type: String, default: `key` }, childrenField: { type: String, default: `children` }, value: [String, Number] }, Wt = Object.keys(N), Gt = R({ name: `Dropdown`, inheritAttrs: false, props: Object.assign(Object.assign(Object.assign({}, N), Ut), d.props), setup(e2) {
  ...
  }), a2 = B(() => i2.value.treeNodes), o2 = I(null), s2 = I(null), c2 = I(null), l2 = B(() => o2.value ?? s2.value ?? c2.value ?? null), p2 = B(() => i2.value.getPath(l2.value).keyPath), m2 = B(() => i2.value.getPath(e2.value).keyPath), h2 = T(() => e2.keyboard && r2.value);
  ...
  z(Z, { labelFieldRef: F(e2, `labelField`), childrenFieldRef: F(e2, `childrenField`), renderLabelRef: F(e2, `renderLabel`), renderIconRef: F(e2, `renderIcon`), hoverKeyRef: o2, keyboardKeyRef: s2, lastToggledSubmenuKeyRef: c2, pendingKeyPathRef: p2, activeKeyPathRef: m2, animatedRef: F(e2, `animated`), mergedShowRef: r2, nodePropsRef: F(e2, `nodeProps`), renderOptionRef: F(e2, `renderOption`), menuPropsRef: F(e2, `menuProps`), doSelect: y2, doUpdateShow: x2 }), H(r2, (t2) => {
    !e2.animated && !t2 && S2();
  });
  function y2(n3, r3) {
    let { onSelect: i3 } = e2;
  ...
  let e2 = (e3, t3, n3, r2, i2) => {
    ...
    return L(Vt, de(this.$attrs, l2, c2));
  ...
  return L(O, Object.assign({}, ae(this.$props, Wt), n2), { trigger: () => {
    var _a;
    var e3;
