import { D as e, E as t, L as n, M as r, N as i, P as a, R as o, a as s, at as c, b as l, c as u, ct as d, d as f, dt as p, f as m, g as h, gt as g, h as _, lt as v, m as y, o as b, ot as x, s as S, u as C, ut as w, v as T } from "./Card-CfqFSU60.js";
import { H as ee, J as E, K as D, Q as O, S as te, W as ne, a as re, g as ie, i as ae, l as oe, n as se, p as ce } from "./light-D7l_EYRp.js";
import { At as k, Dt as le, J as ue, Jt as A, Kt as de, Lt as fe, Nt as pe, Ot as me, Rt as he, Tt as ge, X as _e, Zt as ve, ct as ye, en as j, ft as be, gt as M, in as xe, kt as N, lt as Se, mt as P, nt as Ce, on as we, ot as F, pt as I, qt as Te, rn as Ee, rt as De, st as L, t as Oe, tn as ke, tt as Ae, ut as R, vt as z, wt as je, xt as Me, zt as B } from "./index-BS29D1DG.js";
import { a as Ne, n as Pe, t as Fe } from "./vue-router-DIM0RbJL.js";
import { n as Ie, r as Le, t as Re } from "./omit-Bi1z4VdF.js";
import { A as ze, B as Be, C as Ve, E as He, F as Ue, N as We, O as Ge, R as Ke, T as qe, _ as Je, b as Ye, d as Xe, g as Ze, h as Qe, i as $e, j as et, k as tt, l as nt, m as rt, o as it, t as at, v as ot, w as st, x as ct, y as lt, z as ut } from "./text-_nbSDoT0.js";
import { n as dt } from "./vue-i18n-BNUrasmw.js";
import { A as ft, B as pt, C as mt, D as ht, E as gt, F as _t, G as vt, H as yt, I as bt, K as xt, L as St, M as Ct, N as wt, O as Tt, P as Et, R as Dt, S as Ot, T as kt, U as At, V as jt, W as Mt, _ as Nt, a as Pt, b as Ft, c as It, d as Lt, f as Rt, g as zt, i as Bt, j as Vt, k as Ht, l as Ut, m as Wt, n as Gt, o as Kt, p as qt, q as Jt, r as Yt, t as Xt, u as Zt, v as Qt, w as $t, x as en } from "./light-BQxqghI0.js";
import { n as tn, t as nn } from "./core-CjRjcW9P.js";
import { C as rn, D as V, S as an, _ as on, a as sn, b as cn, c as ln, d as un, h as dn, s as fn, v as pn, w as mn, y as hn } from "./storage-DOGmZhnH.js";
import { r as gn } from "./light-BgP18l4Y.js";
import { i as _n, n as vn, r as yn, t as bn } from "./Warning-DSXDuHq5.js";
import { n as xn } from "./light-BQaaoUhl.js";
import { t as Sn } from "./fade-in-height-expand.cssr-Bp44Xfe4.js";
import { n as Cn } from "./light-Dw6CJAuq.js";
import { r as wn, t as Tn } from "./Tooltip-CfZT1Ddw.js";
import { i as En, n as Dn, t as On } from "./platform-Bq-UXwUZ.js";
import { a as kn, n as An, r as jn } from "./light-BDYeDyNz.js";
import { n as Mn } from "./light-DYeZ8uck.js";
import { n as Nn } from "./light-E2J33dPM.js";
import { n as Pn } from "./light-CM76U9Rl.js";
var Fn = { xmlns: `http://www.w3.org/2000/svg`, "xmlns:xlink": `http://www.w3.org/1999/xlink`, viewBox: `0 0 24 24` }, In = P({ name: `InfoCircle`, render: function(e2, t2) {
  return N(), R(`svg`, Fn, t2[0] || (t2[0] = [L(`g`, { fill: `none`, stroke: `currentColor`, "stroke-width": `2`, "stroke-linecap": `round`, "stroke-linejoin": `round` }, [L(`circle`, { cx: `12`, cy: `12`, r: `9` }), L(`path`, { d: `M12 8h.01` }), L(`path`, { d: `M11 12h1v4h1` })], -1)]));
} }), Ln = { xmlns: `http://www.w3.org/2000/svg`, "xmlns:xlink": `http://www.w3.org/1999/xlink`, viewBox: `0 0 24 24` }, Rn = P({ name: `Menu`, render: function(e2, t2) {
  return N(), R(`svg`, Ln, t2[0] || (t2[0] = [L(`g`, { fill: `none`, stroke: `currentColor`, "stroke-width": `2`, "stroke-linecap": `round`, "stroke-linejoin": `round` }, [L(`path`, { d: `M4 8h16` }), L(`path`, { d: `M4 16h16` })], -1)]));
} }), zn = 0, Bn = typeof window < `u` && window.matchMedia !== void 0, H = A(null), U, W;
function Vn(e2) {
...
var Gn = true;
function Kn() {
  return Bn ? (zn === 0 && Un(), Gn && (Gn = D()) && (je(() => {
    zn += 1;
  }), ge(() => {
    --zn, zn === 0 && Wn();
  })), Te(H)) : Te(H);
}
var qn = P({ name: `ChevronDownFilled`, render() {
...
var q = Object.assign(Object.assign({ name: `common` }, y), { baseColor: G.neutralBase, primaryColor: G.primaryDefault, primaryColorHover: G.primaryHover, primaryColorPressed: G.primaryActive, primaryColorSuppl: G.primarySuppl, infoColor: G.infoDefault, infoColorHover: G.infoHover, infoColorPressed: G.infoActive, infoColorSuppl: G.infoSuppl, successColor: G.successDefault, successColorHover: G.successHover, successColorPressed: G.successActive, successColorSuppl: G.successSuppl, warningColor: G.warningDefault, warningColorHover: G.warningHover, warningColorPressed: G.warningActive, warningColorSuppl: G.warningSuppl, errorColor: G.errorDefault, errorColorHover: G.errorHover, errorColorPressed: G.errorActive, errorColorSuppl: G.errorSuppl, textColorBase: G.neutralTextBase, textColor1: K(G.alpha1), textColor2: K(G.alpha2), textColor3: K(G.alpha3), textColorDisabled: K(G.alpha4), placeholderColor: K(G.alpha4), placeholderColorDisabled: K(G.alpha5), iconColor: K(G.alpha4), iconColorDisabled: K(G.alpha5), iconColorHover: K(Number(G.alpha4) * 1.25), iconColorPressed: K(Number(G.alpha4) * 0.8), opacity1: G.alpha1, opacity2: G.alpha2, opacity3: G.alpha3, opacity4: G.alpha4, opacity5: G.alpha5, dividerColor: K(G.alphaDivider), borderColor: K(G.alphaBorder), closeIconColorHover: K(Number(G.alphaClose)), closeIconColor: K(Number(G.alphaClose)), closeIconColorPressed: K(Number(G.alphaClose)), closeColorHover: `rgba(255, 255, 255, .12)`, closeColorPressed: `rgba(255, 255, 255, .08)`, clearColor: K(G.alpha4), clearColorHover: o(K(G.alpha4), { alpha: 1.25 }), clearColorPressed: o(K(G.alpha4), { alpha: 0.8 }), scrollbarColor: K(G.alphaScrollbar), scrollbarColorHover: K(G.alphaScrollbarHover), scrollbarWidth: `5px`, scrollbarHeight: `5px`, scrollbarBorderRadius: `5px`, progressRailColor: K(G.alphaProgressRail), railColor: K(G.alphaRail), popoverColor: G.neutralPopover, tableColor: G.neutralCard, cardColor: G.neutralCard, modalColor: G.neutralModal, bodyColor: G.neutralBody, tagColor: Zn(G.alphaTag), avatarColor: K(G.alphaAvatar), invertedColor: G.neutralBase, inputColor: K(G.alphaInput), codeColor: K(G.alphaCode), tabColor: K(G.alphaTab), actionColor: K(G.alphaAction), tableHeaderColor: K(G.alphaAction), hoverColor: K(G.alphaPending), tableColorHover: K(G.alphaTablePending), tableColorStriped: K(G.alphaTableStriped), pressedColor: K(G.alphaPressed), opacityDisabled: G.alphaDisabled, inputColorDisabled: K(G.alphaDisabledInput), buttonColor2: `rgba(255, 255, 255, .08)`, buttonColor2Hover: `rgba(255, 255, 255, .12)`, buttonColor2Pressed: `rgba(255, 255, 255, .08)`, boxShadow1: `0 1px 2px -2px rgba(0, 0, 0, .24), 0 3px 6px 0 rgba(0, 0, 0, .18), 0 5px 12px 4px rgba(0, 0, 0, .12)`, boxShadow2: `0 3px 6px -4px rgba(0, 0, 0, .24), 0 6px 12px 0 rgba(0, 0, 0, .16), 0 9px 18px 8px rgba(0, 0, 0, .10)`, boxShadow3: `0 6px 16px -9px rgba(0, 0, 0, .08), 0 9px 28px 0 rgba(0, 0, 0, .05), 0 12px 48px 16px rgba(0, 0, 0, .03)` }), J = { name: `Scrollbar`, common: q, self: ce }, Y = { name: `Empty`, common: q, self: hn }, Qn = { name: `InternalSelectMenu`, common: q, peers: { Scrollbar: J, Empty: Y }, self: on }, X = { name: `Popover`, common: q, peers: { Scrollbar: J }, self: oe }, $n = { name: `Tag`, common: q, self(e2) {
  ...
  return Object.assign(Object.assign({}, xn), { fontSize: v2, lineHeight: t2, titleFontWeight: r2, borderRadius: n2, border: `1px solid ${a2}`, color: o2, titleTextColor: s2, iconColor: c2, contentTextColor: c2, closeBorderRadius: n2, closeColorHover: l2, closeColorPressed: u2, closeIconColor: d2, closeIconColorHover: f2, closeIconColorPressed: p2, borderInfo: `1px solid ${i(m2, { alpha: 0.35 })}`, colorInfo: i(m2, { alpha: 0.25 }), titleTextColorInfo: s2, iconColorInfo: m2, contentTextColorInfo: c2, closeColorHoverInfo: l2, closeColorPressedInfo: u2, closeIconColorInfo: d2, closeIconColorHoverInfo: f2, closeIconColorPressedInfo: p2, borderSuccess: `1px solid ${i(h2, { alpha: 0.35 })}`, colorSuccess: i(h2, { alpha: 0.25 }), titleTextColorSuccess: s2, iconColorSuccess: h2, contentTextColorSuccess: c2, closeColorHoverSuccess: l2, closeColorPressedSuccess: u2, closeIconColorSuccess: d2, closeIconColorHoverSuccess: f2, closeIconColorPressedSuccess: p2, borderWarning: `1px solid ${i(g2, { alpha: 0.35 })}`, colorWarning: i(g2, { alpha: 0.25 }), titleTextColorWarning: s2, iconColorWarning: g2, contentTextColorWarning: c2, closeColorHoverWarning: l2, closeColorPressedWarning: u2, closeIconColorWarning: d2, closeIconColorHoverWarning: f2, closeIconColorPressedWarning: p2, borderError: `1px solid ${i(_2, { alpha: 0.35 })}`, colorError: i(_2, { alpha: 0.25 }), titleTextColorError: s2, iconColorError: _2, contentTextColorError: c2, closeColorHoverError: l2, closeColorPressedError: u2, closeIconColorError: d2, closeIconColorHoverError: f2, closeIconColorPressedError: p2 });
} }, nr = { name: `Anchor`, common: q, self: Cn };
function rr(e2) {
  let { textColor2: t2, textColor3: n2, textColorDisabled: r2, primaryColor: a2, primaryColorHover: o2, inputColor: s2, inputColorDisabled: c2, warningColor: l2, warningColorHover: u2, errorColor: d2, errorColorHover: f2, borderRadius: p2, lineHeight: m2, fontSizeTiny: h2, fontSizeSmall: g2, fontSizeMedium: _2, fontSizeLarge: v2, heightTiny: y2, heightSmall: b2, heightMedium: x2, heightLarge: S2, clearColor: C2, clearColorHover: w2, clearColorPressed: T2, placeholderColor: ee2, placeholderColorDisabled: E2, iconColor: D2, iconColorDisabled: O2, iconColorHover: te2, iconColorPressed: ne2, fontWeight: re2 } = e2;
  return Object.assign(Object.assign({}, Ue), { fontWeight: re2, countTextColorDisabled: r2, countTextColor: n2, heightTiny: y2, heightSmall: b2, heightMedium: x2, heightLarge: S2, fontSizeTiny: h2, fontSizeSmall: g2, fontSizeMedium: _2, fontSizeLarge: v2, lineHeight: m2, lineHeightTextarea: m2, borderRadius: p2, iconSize: `16px`, groupLabelColor: s2, textColor: t2, textColorDisabled: r2, textDecorationColor: t2, groupLabelTextColor: t2, caretColor: a2, placeholderColor: ee2, placeholderColorDisabled: E2, color: s2, colorDisabled: c2, colorFocus: i(a2, { alpha: 0.1 }), groupLabelBorder: `1px solid #0000`, border: `1px solid #0000`, borderHover: `1px solid ${o2}`, borderDisabled: `1px solid #0000`, borderFocus: `1px solid ${o2}`, boxShadowFocus: `0 0 8px 0 ${i(a2, { alpha: 0.3 })}`, loadingColor: a2, loadingColorWarning: l2, borderWarning: `1px solid ${l2}`, borderHoverWarning: `1px solid ${u2}`, colorFocusWarning: i(l2, { alpha: 0.1 }), borderFocusWarning: `1px solid ${u2}`, boxShadowFocusWarning: `0 0 8px 0 ${i(l2, { alpha: 0.3 })}`, caretColorWarning: l2, loadingColorError: d2, borderError: `1px solid ${d2}`, borderHoverError: `1px solid ${f2}`, colorFocusError: i(d2, { alpha: 0.1 }), borderFocusError: `1px solid ${f2}`, boxShadowFocusError: `0 0 8px 0 ${i(d2, { alpha: 0.3 })}`, caretColorError: d2, clearColor: C2, clearColorHover: w2, clearColorPressed: T2, iconColor: D2, iconColorDisabled: O2, iconColorHover: te2, iconColorPressed: ne2, suffixTextColor: t2 });
}
var Z = f({ name: `Input`, common: q, peers: { Scrollbar: J }, self: rr }), ir = { name: `AutoComplete`, common: q, peers: { InternalSelectMenu: Qn, Input: Z }, self: Jt }, ar = { name: `Avatar`, common: q, self: xt }, or = { name: `AvatarGroup`, common: q, peers: { Avatar: ar }, self: vt }, sr = { name: `BackTop`, common: q, self(e2) {
  let { popoverColor: t2, textColor2: n2, primaryColorHover: r2, primaryColorPressed: i2 } = e2;
  return Object.assign(Object.assign({}, Mt), { color: t2, textColor: n2, iconColor: n2, iconColorHover: r2, iconColorPressed: i2, boxShadow: `0 2px 8px 0px rgba(0, 0, 0, .12)`, boxShadowHover: `0 2px 12px 0px rgba(0, 0, 0, .18)`, boxShadowPressed: `0 2px 12px 0px rgba(0, 0, 0, .18)` });
...
} }, lr = { name: `Breadcrumb`, common: q, self: At }, Q = { name: `Button`, common: q, self(e2) {
  let t2 = un(e2);
...
} }, ur = { name: `Calendar`, common: q, peers: { Button: Q }, self: yt }, dr = { name: `Card`, common: q, self(e2) {
...
} }, fr = { name: `Carousel`, common: q, self: jt }, pr = { name: `Checkbox`, common: q, self(e2) {
  let { cardColor: t2 } = e2, n2 = pt(e2);
  return n2.color = `#0000`, n2.checkMarkColor = t2, n2;
} }, mr = { name: `Cascader`, common: q, peers: { InternalSelectMenu: Qn, InternalSelection: er, Scrollbar: J, Checkbox: pr, Empty: pn }, self: Dt }, hr = { name: `Code`, common: q, self(e2) {
...
} }, gr = { name: `Collapse`, common: q, self: gn }, _r = { name: `CollapseTransition`, common: q, self: St }, vr = { name: `ColorPicker`, common: q, peers: { Input: Z, Button: Q }, self: We }, yr = { name: `Popselect`, common: q, peers: { Popover: X, InternalSelectMenu: Qn } }, br = { name: `Select`, common: q, peers: { InternalSelection: er, InternalSelectMenu: Qn }, self: fn }, xr = { name: `Pagination`, common: q, peers: { Select: br, Input: Z, Popselect: yr }, self(e2) {
  let { primaryColor: t2, opacity3: n2 } = e2, r2 = i(t2, { alpha: Number(n2) }), a2 = _t(e2);
  ...
  let { primaryColorSuppl: t2, primaryColor: n2, popoverColor: r2 } = e2, a2 = Et(e2);
  ...
  return Object.assign(Object.assign({}, wn), { borderRadius: t2, boxShadow: n2, color: r2, textColor: i2 });
...
} }, Dr = { name: `Icon`, common: q, self: kn }, Or = { name: `TimePicker`, common: q, peers: { Scrollbar: J, Button: Q, Input: Z }, self: Vt }, kr = { name: `DatePicker`, common: q, peers: { Input: Z, Button: Q, TimePicker: Or, Scrollbar: J }, self(e2) {
  let { popoverColor: t2, hoverColor: n2, primaryColor: r2 } = e2, o2 = ft(e2);
  return o2.itemColorDisabled = a(t2, n2), o2.itemColorIncluded = i(r2, { alpha: 0.15 }), o2.itemColorHover = a(t2, n2), o2;
} }, Ar = { name: `Descriptions`, common: q, self: Ht }, jr = { name: `Dialog`, common: q, peers: { Button: Q }, self: Ge }, Mr = { name: `Modal`, common: q, peers: { Scrollbar: J, Dialog: jr, Card: dr }, self: Ve };
const Nr = Object.assign(Object.assign({}, He), { onAfterEnter: Function, onAfterLeave: Function, transformOrigin: String, blockScroll: { type: Boolean, default: true }, closeOnEsc: { type: Boolean, default: true }, onEsc: Function, autoFocus: { type: Boolean, default: true }, internalStyle: [String, Object], maskClosable: { type: Boolean, default: true }, zIndex: Number, onPositiveClick: Function, onNegativeClick: Function, onClose: Function, onMaskClick: Function, draggable: [Boolean, Object] }), Pr = P({ name: `DialogEnvironment`, props: Object.assign(Object.assign({}, Nr), { internalKey: { type: String, required: true }, to: [String, Object], onInternalAfterLeave: { type: Function, required: true } }), setup(e2) {
  let t2 = A(true);
  function n2() {
  ...
  return M(Je, { show: u2, onUpdateShow: t2, onMaskClick: a2, onEsc: o2, to: s2, zIndex: c2, maskClosable: l2, onAfterEnter: this.onAfterEnter, onAfterLeave: i2, closeOnEsc: this.closeOnEsc, blockScroll: this.blockScroll, autoFocus: this.autoFocus, transformOrigin: this.transformOrigin, draggable: this.draggable, internalAppear: true, internalDialog: true }, { default: ({ draggableClass: t3 }) => M(st, Object.assign({}, ie(this.$props, qe), { titleClass: ke([this.titleClass, t3]), style: this.internalStyle, onClose: r2, onNegativeClick: n2, onPositiveClick: e2 })) });
} }), Fr = P({ name: `DialogProvider`, props: { injectionKey: String, to: [String, Object] }, setup() {
  let e2 = A([]), t2 = {};
  function n2(n3 = {}) {
    let r3 = O(), i3 = de(Object.assign(Object.assign({}, n3), { key: r3, destroy: () => {
      var e3;
  ...
  return k(tt, o2), k(ze, { clickedRef: Ke(64), clickedPositionRef: ut() }), k(et, e2), Object.assign(Object.assign({}, o2), { dialogList: e2, dialogInstRefs: t2, handleAfterLeave: i2 });
}, render() {
  var _a2;
  var e2;
  return M(Ae, null, [this.dialogList.map((e3) => M(Pr, Re(e3, [`destroy`, `style`], { internalStyle: e3.style, to: this.to, ref: (t2) => {
...
} }, Lr = { name: `Message`, common: q, self: Tt };
...
var zr = c([x(`message-wrapper`, `
 ...
 display: flex;
 `, [Sn({ overflow: `visible`, originalTransition: `transform .3s var(--n-bezier)`, enterToProps: { transform: `scale(1)` }, leaveToProps: { transform: `scale(0.85)` } })]), x(`message`, `
 ...
 `)])]), Br = { info: () => M(yn, null), success: () => M(vn, null), warning: () => M(bn, null), error: () => M(_n, null), default: () => null }, Vr = P({ name: `Message`, props: Object.assign(Object.assign({}, Rr), { render: Function }), setup(e2) {
  ...
  s2 == null ? void 0 : s2();
  let f2;
  return M(`div`, { class: [`${i2}-message-wrapper`, o2], onMouseenter: this.onMouseenter, onMouseleave: this.onMouseleave, style: [{ alignItems: this.placement.startsWith(`top`) ? `flex-start` : `flex-end` }, a2] }, e2 ? e2(this.$props) : M(`div`, { class: [`${i2}-message ${i2}-message--${t2}-type`, this.rtlEnabled && `${i2}-message--rtl`] }, (f2 = Hr(c2, t2, i2)) && d2 ? M(`div`, { class: `${i2}-message__icon ${i2}-message__icon--${t2}-type` }, M(mn, null, { default: () => f2 })) : null, M(`div`, { class: `${i2}-message__content` }, V(r2)), n2 ? M(u, { clsPrefix: i2, class: `${i2}-message__close`, onClick: l2, absolute: true }) : null));
} });
function Hr(e2, t2, n2) {
  if (typeof e2 == `function`) return e2();
  {
    let e3 = t2 === `loading` ? M(an, { clsPrefix: n2, strokeWidth: 24, scale: 0.85 }) : Br[t2]();
    return e3 ? M(C, { clsPrefix: n2, key: t2 }, { default: () => e3 }) : null;
  }
}
var Ur = P({ name: `MessageEnvironment`, props: Object.assign(Object.assign({}, Rr), { duration: { type: Number, default: 3e3 }, onAfterLeave: Function, onLeave: Function, internalKey: { type: String, required: true }, onInternalAfterLeave: Function, onHide: Function, onAfterHide: Function }), setup(e2) {
  let t2 = null, n2 = A(true);
  le(() => {
    r2();
  });
  function r2() {
  ...
  return M(S, { appear: true, onAfterLeave: this.handleAfterLeave, onLeave: this.onLeave }, { default: () => [this.show ? M(Vr, { content: this.content, type: this.type, icon: this.icon, showIcon: this.showIcon, closable: this.closable, onClose: this.handleClose, onMouseenter: this.keepAliveOnHover ? this.handleMouseenter : void 0, onMouseleave: this.keepAliveOnHover ? this.handleMouseleave : void 0 }) : null] });
} }), Wr = P({ name: `MessageProvider`, props: Object.assign(Object.assign({}, m.props), { to: [String, Object], duration: { type: Number, default: 3e3 }, keepAliveOnHover: Boolean, max: Number, placement: { type: String, default: `top` }, closable: Boolean, containerClass: String, containerStyle: [String, Object] }), setup(e2) {
  let { mergedClsPrefixRef: t2 } = T(e2), n2 = A([]), r2 = A({}), i2 = { create(e3, t3) {
  ...
  k(Ze, { props: e2, mergedClsPrefixRef: t2 }), k(Qe, i2);
  function a2(t3, i3) {
    let a3 = O(), o3 = de(Object.assign(Object.assign({}, i3), { content: t3, key: a3, destroy: () => {
      var e3;
  ...
  var _a2;
  var e2;
  return M(Ae, null, (_a2 = (e2 = this.$slots).default) == null ? void 0 : _a2.call(e2), this.messageList.length ? M(De, { to: this.to ?? `body` }, M(`div`, { class: [`${this.mergedClsPrefix}-message-container`, `${this.mergedClsPrefix}-message-container--${this.placement}`, this.containerClass], key: `message-container`, style: this.containerStyle }, this.messageList.map((e3) => M(Ur, Object.assign({ ref: (t2) => {
    t2 && (this.messageRefs[e3.key] = t2);
  }, internalKey: e3.key, onInternalAfterLeave: this.handleAfterLeave }, Re(e3, [`destroy`], void 0), { duration: e3.duration === void 0 ? this.duration : e3.duration, keepAliveOnHover: e3.keepAliveOnHover === void 0 ? this.keepAliveOnHover : e3.keepAliveOnHover, closable: e3.closable === void 0 ? this.closable : e3.closable }))))) : null);
} });
const Gr = P({ name: `ModalEnvironment`, props: Object.assign(Object.assign({}, ot), { internalKey: { type: String, required: true }, onInternalAfterLeave: { type: Function, required: true } }), setup(e2) {
  let t2 = A(true);
  function n2() {
    let { onInternalAfterLeave: t3, internalKey: n3, onAfterLeave: r3 } = e2;
    t3 && t3(n3), r3 && r3();
  ...
  return M(Je, Object.assign({}, this.$props, { show: i2, onUpdateShow: e2, onMaskClick: n2, onEsc: r2, onAfterLeave: t2, internalAppear: true, internalModal: true }), this.$slots);
} }), Kr = P({ name: `ModalProvider`, props: { to: [String, Object] }, setup() {
  let e2 = A([]), t2 = {};
  function n2(n3 = {}) {
    let r3 = O(), i3 = de(Object.assign(Object.assign({}, n3), { key: r3, destroy: () => {
      var e3;
  ...
  return k(lt, a2), k(Ye, { clickedRef: Ke(64), clickedPositionRef: ut() }), k(ct, e2), Object.assign(Object.assign({}, a2), { modalList: e2, modalInstRefs: t2, handleAfterLeave: r2 });
}, render() {
  var _a2;
  var e2;
  return M(Ae, null, [this.modalList.map((e3) => M(Gr, Re(e3, [`destroy`, `render`], { to: e3.to ?? this.to, ref: (t2) => {
...
var qr = { name: `Notification`, common: q, peers: { Scrollbar: J }, self: gt }, Jr = { name: `Divider`, common: q, self: Mn }, Yr = { name: `Drawer`, common: q, peers: { Scrollbar: J }, self: rt }, Xr = { name: `DynamicInput`, common: q, peers: { Input: Z, Button: Q }, self() {
  return kt;
} }, Zr = { name: `Space`, self() {
  return Nn;
  ...
  return Xe;
} }, ti = { name: `ButtonGroup`, common: q }, ni = { name: `Form`, common: q, self: nt }, ri = { name: `GradientText`, common: q, self(e2) {
...
} }, ai = { name: `InputOtp`, common: q, peers: { Input: Z }, self: $t }, oi = { name: `Layout`, common: q, peers: { Scrollbar: J }, self(e2) {
...
} }, si = { name: `Row`, common: q }, ci = { name: `List`, common: q, self: se }, li = { name: `Log`, common: q, peers: { Scrollbar: J, Code: hr }, self(e2) {
  ...
  let { primaryColor: t2, primaryColorSuppl: n2 } = e2, r2 = mt(e2);
...
const fi = { name: `PageHeader`, common: q, self: en };
var pi = { name: `Popconfirm`, common: q, peers: { Button: Q, Popover: X }, self: it }, mi = { name: `Progress`, common: q, self(e2) {
  let t2 = Ft(e2);
...
} }, gi = { name: `Result`, common: q, self: Qt }, _i = { name: `Slider`, common: q, self(e2) {
  ...
  return Object.assign(Object.assign({}, Zt), { itemHeightSmall: o2, itemHeightMedium: o2, itemHeightLarge: a2, fontSizeSmall: i2, fontSizeMedium: r2, fontSizeLarge: n2, borderRadius: s2, dividerColor: b2, borderColor: `#0000`, listColor: c2, headerColor: l2, titleTextColor: u2, titleTextColorDisabled: d2, extraTextColor: p2, extraTextColorDisabled: d2, itemTextColor: f2, itemTextColorDisabled: d2, itemColorPending: m2, titleFontWeight: t2, closeColorHover: h2, closeColorPressed: g2, closeIconColor: _2, closeIconColorHover: v2, closeIconColorPressed: y2 });
} }, Di = { name: `Tree`, common: q, peers: { Checkbox: pr, Scrollbar: J, Empty: Y }, self(e2) {
  let { primaryColor: t2 } = e2, n2 = Ut(e2);
  return n2.nodeColorActive = i(t2, { alpha: 0.15 }), n2;
} }, Oi = { name: `TreeSelect`, common: q, peers: { Tree: Di, Empty: Y, InternalSelection: er } }, ki = { name: `Typography`, common: q, self: An }, Ai = { name: `Upload`, common: q, peers: { Button: Q, Progress: mi }, self(e2) {
  let { errorColor: t2 } = e2, n2 = It(e2);
...
} }, Fi = { name: `IconWrapper`, common: q, self: Pt };
...
var Ri = { name: `Transfer`, common: q, peers: { Checkbox: pr, Scrollbar: J, Input: Z, Empty: Y, Button: Q }, self(e2) {
...
var Ui = [c(`&::before`, `background-color: var(--n-item-color-hover);`), d(`arrow`, `
 ...
 `)]), w(`disabled`, [w(`selected, child-active`, [c(`&:focus-within`, Wi)]), v(`selected`, [$(null, [d(`icon`, `color: var(--n-item-icon-color-active-hover-horizontal);`), x(`menu-item-content-header`, `
 ...
 `, [c(`a`, `color: var(--n-item-text-color-child-active-hover-horizontal);`), d(`extra`, `color: var(--n-item-text-color-child-active-hover-horizontal);`)])])]), $(`border-bottom: 2px solid var(--n-border-color-horizontal);`, Wi)]), x(`menu-item-content-header`, [c(`a`, `color: var(--n-item-text-color-horizontal);`)])])]), w(`responsive`, [x(`menu-item-content-header`, `
 overflow: hidden;
 ...
 `)]), w(`disabled`, [w(`selected, child-active`, [c(`&:focus-within`, Ui)]), v(`selected`, [$(null, [d(`arrow`, `color: var(--n-arrow-color-active-hover);`), d(`icon`, `color: var(--n-item-icon-color-active-hover);`), x(`menu-item-content-header`, `
 ...
 `, [c(`a`, `color: var(--n-item-text-color-child-active-hover);`), d(`extra`, `color: var(--n-item-text-color-child-active-hover);`)])])]), v(`selected`, [$(null, [c(`&::before`, `background-color: var(--n-item-color-active-hover);`)])]), $(null, Ui)]), d(`icon`, `
 grid-area: icon;
 ...
 overflow: hidden;
 padding: 0;
 `, [Sn({ duration: `.2s` })])]), x(`menu-item-group`, [x(`menu-item-group-title`, `
 margin-top: 6px;
 color: var(--n-group-text-color);
 cursor: default;
 font-size: .93em;
...
var Ki = P({ name: `MenuOptionContent`, props: { collapsed: Boolean, disabled: Boolean, title: [String, Function], icon: Function, extra: [String, Function], showArrow: Boolean, childActive: Boolean, hover: Boolean, paddingLeft: Number, selected: Boolean, maxIconSize: { type: Number, required: true }, activeIconSize: { type: Number, required: true }, iconMarginRight: { type: Number, required: true }, clsPrefix: { type: String, required: true }, onClick: Function, tmNode: { type: Object, required: true }, isEllipsisPlaceholder: Boolean }, setup(e2) {
  let { props: t2 } = z(Bi);
  return { menuProps: t2, style: F(() => {
  ...
  }, role: `none`, class: [`${e2}-menu-item-content`, { [`${e2}-menu-item-content--selected`]: this.selected, [`${e2}-menu-item-content--collapsed`]: this.collapsed, [`${e2}-menu-item-content--child-active`]: this.childActive, [`${e2}-menu-item-content--disabled`]: this.disabled, [`${e2}-menu-item-content--hover`]: this.hover }], style: this.style }, o2 && M(`div`, { class: `${e2}-menu-item-content__icon`, style: this.iconStyle, role: `none` }, [o2]), M(`div`, { class: `${e2}-menu-item-content-header`, role: `none` }, this.isEllipsisPlaceholder ? this.title : r2 ? r2(t2.rawNode) : V(this.title), this.extra || i2 ? M(`span`, { class: `${e2}-menu-item-content-header__extra` }, ` `, i2 ? i2(t2.rawNode) : V(this.extra)) : null), this.showArrow ? M(C, { ariaHidden: true, class: `${e2}-menu-item-content__arrow`, clsPrefix: e2 }, { default: () => a2 ? a2(t2.rawNode) : M(qn, null) }) : null);
} }), qi = 8;
function Ji(e2) {
  let t2 = z(Bi), { props: n2, mergedCollapsedRef: r2 } = t2, i2 = z(Vi, null), a2 = z(Hi, null), o2 = F(() => n2.mode === `horizontal`), s2 = F(() => o2.value ? n2.dropdownPlacement : `tmNodes` in e2 ? `right-start` : `right`), c2 = F(() => Math.max(n2.collapsedIconSize ?? n2.iconSize, n2.iconSize));
  return { dropdownPlacement: s2, activeIconSize: F(() => !o2.value && e2.root && r2.value ? n2.collapsedIconSize ?? n2.iconSize : n2.iconSize), maxIconSize: c2, paddingLeft: F(() => {
    if (o2.value) return;
    ...
    return o2.value || !l2 || !r2.value ? qi : (a3 === void 0 ? i3 : a3) + s3 + qi - (t3 + s3) / 2;
  }), NMenu: t2, NSubmenu: i2, NMenuOptionGroup: a2 };
}
const Yi = { internalKey: { type: [String, Number], required: true }, root: Boolean, isGroup: Boolean, level: { type: Number, required: true }, title: [String, Function], extra: [String, Function] };
var Xi = P({ name: `MenuDivider`, setup() {
  let { mergedClsPrefixRef: e2, isHorizontalRef: t2 } = z(Bi);
  return () => t2.value ? null : M(`div`, { class: `${e2.value}-menu-divider` });
} });
const Zi = Object.assign(Object.assign({}, Yi), { tmNode: { type: Object, required: true }, disabled: Boolean, icon: Function, onClick: Function }), Qi = t(Zi), $i = P({ name: `MenuOption`, props: Zi, setup(e2) {
  let t2 = Ji(e2), { NSubmenu: n2, NMenu: r2, NMenuOptionGroup: i2 } = t2, { props: a2, mergedClsPrefixRef: o2, mergedCollapsedRef: s2 } = r2, c2 = n2 ? n2.mergedDisabledRef : i2 ? i2.mergedDisabledRef : { value: false }, l2 = F(() => c2.value || e2.disabled);
  function u2(t3) {
    let { onClick: n3 } = e2;
    n3 && n3(t3);
  }
  ...
  return M(`div`, Object.assign({}, a2, { role: `menuitem`, class: [`${e2}-menu-item`, a2 == null ? void 0 : a2.class] }), M(Tn, { theme: t2.peers.Tooltip, themeOverrides: t2.peerOverrides.Tooltip, trigger: `hover`, placement: this.dropdownPlacement, disabled: !this.dropdownEnabled || this.title === void 0, internalExtraClass: [`menu-tooltip`] }, { default: () => r2 ? r2(n2.rawNode) : V(this.title), trigger: () => M(Ki, { tmNode: n2, clsPrefix: e2, paddingLeft: this.paddingLeft, iconMarginRight: this.iconMarginRight, maxIconSize: this.maxIconSize, activeIconSize: this.activeIconSize, selected: this.selected, title: this.title, extra: this.extra, disabled: this.mergedDisabled, icon: this.icon, onClick: this.handleClick }) }));
} }), ea = Object.assign(Object.assign({}, Yi), { tmNode: { type: Object, required: true }, tmNodes: { type: Array, required: true } }), ta = t(ea), na = P({ name: `MenuOptionGroup`, props: ea, setup(e2) {
  let t2 = Ji(e2), { NSubmenu: n2 } = t2, r2 = F(() => (n2 == null ? void 0 : n2.mergedDisabledRef.value) ? true : e2.tmNode.disabled);
  k(Hi, { paddingLeftRef: t2.paddingLeft, mergedDisabledRef: r2 });
  let { mergedClsPrefixRef: i2, props: a2 } = z(Bi);
  return function() {
    let { value: n3 } = i2, r3 = t2.paddingLeft.value, { nodeProps: o2 } = a2, s2 = o2 == null ? void 0 : o2(e2.tmNode.rawNode);
    return M(`div`, { class: `${n3}-menu-item-group`, role: `group` }, M(`div`, Object.assign({}, s2, { class: [`${n3}-menu-item-group-title`, s2 == null ? void 0 : s2.class], style: [(s2 == null ? void 0 : s2.style) || ``, r3 === void 0 ? `` : `padding-left: ${r3}px;`] }), V(e2.title), e2.extra ? M(Ae, null, ` `, V(e2.extra)) : null), M(`div`, null, e2.tmNodes.map((e3) => aa(e3, a2))));
  };
} });
function ra(e2) {
...
function aa(e2, t2) {
  ...
  if (ra(n2)) return ia(n2) ? M(Xi, Object.assign({ key: e2.key }, n2.props)) : null;
  ...
  return e2.children ? e2.isGroup ? M(na, ie(c2, ta, { tmNode: e2, tmNodes: e2.children, key: a2 })) : M(ca, ie(c2, sa, { key: a2, rawNodes: n2[t2.childrenField], tmNodes: e2.children, tmNode: e2 })) : M($i, ie(c2, Qi, { key: a2, tmNode: e2 }));
}
const oa = Object.assign(Object.assign({}, Yi), { rawNodes: { type: Array, default: () => [] }, tmNodes: { type: Array, default: () => [] }, tmNode: { type: Object, required: true }, disabled: Boolean, icon: Function, onClick: Function, domId: String, virtualChildActive: { type: Boolean, default: void 0 }, isEllipsisPlaceholder: Boolean }), sa = t(oa), ca = P({ name: `Submenu`, props: oa, setup(e2) {
  let t2 = Ji(e2), { NMenu: n2, NSubmenu: r2 } = t2, { props: i2, mergedCollapsedRef: a2, mergedThemeRef: o2 } = n2, s2 = F(() => {
    let { disabled: t3 } = e2;
    return (r2 == null ? void 0 : r2.mergedDisabledRef.value) || i2.disabled ? true : t3;
  }), c2 = A(false);
  k(Vi, { paddingLeftRef: t2.paddingLeft, mergedDisabledRef: s2 }), k(Hi, null);
  function l2() {
    let { onClick: t3 } = e2;
    t3 && t3();
  }
...
var la = P({ name: `Menu`, inheritAttrs: false, props: Object.assign(Object.assign({}, m.props), { options: { type: Array, default: () => [] }, collapsed: { type: Boolean, default: void 0 }, collapsedWidth: { type: Number, default: 48 }, iconSize: { type: Number, default: 20 }, collapsedIconSize: { type: Number, default: 24 }, rootIndent: Number, indent: { type: Number, default: 32 }, labelField: { type: String, default: `label` }, keyField: { type: String, default: `key` }, childrenField: { type: String, default: `children` }, disabledField: { type: String, default: `disabled` }, defaultExpandAll: Boolean, defaultExpandedKeys: Array, expandedKeys: Array, value: [String, Number], defaultValue: { type: [String, Number], default: null }, mode: { type: String, default: `vertical` }, watchProps: { type: Array, default: void 0 }, disabled: Boolean, show: { type: Boolean, default: true }, inverted: Boolean, "onUpdate:expandedKeys": [Function, Array], onUpdateExpandedKeys: [Function, Array], onUpdateValue: [Function, Array], "onUpdate:value": [Function, Array], expandIcon: Function, renderIcon: Function, renderLabel: Function, renderExtra: Function, dropdownProps: Object, accordion: Boolean, nodeProps: Function, dropdownPlacement: { type: String, default: `bottom` }, responsive: Boolean, items: Array, onOpenNamesChange: [Function, Array], onSelect: [Function, Array], onExpandedNamesChange: [Function, Array], expandedNames: Array, defaultExpandedNames: Array }), setup(t2) {
  let { mergedClsPrefixRef: n2, inlineThemeDisabled: r2 } = T(t2), i2 = m(`Menu`, `-menu`, Gi, Ot, t2, n2), a2 = z(Li, null), o2 = F(() => {
    ...
    return cn(t2.items || t2.options, { getIgnored(e3) {
      return ra(e3);
    }, getChildren(e3) {
      return e3[n3];
    }, getDisabled(e3) {
  ...
  }), c2 = F(() => new Set(s2.value.treeNodes.map((e2) => e2.key))), { watchProps: l2 } = t2, u2 = A(null);
  (l2 == null ? void 0 : l2.includes(`defaultValue`)) ? he(() => {
    u2.value = t2.defaultValue;
  }) : u2.value = t2.defaultValue;
  let d2 = ne(ve(t2, `value`), u2), f2 = A([]), p2 = () => {
  ...
  (l2 == null ? void 0 : l2.includes(`defaultExpandedKeys`)) ? he(p2) : p2();
  let g2 = ee(t2, [`expandedNames`, `expandedKeys`]), _2 = ne(g2, f2), v2 = F(() => s2.value.treeNodes), y2 = F(() => s2.value.getPath(d2.value).keyPath);
  k(Bi, { props: t2, mergedCollapsedRef: o2, mergedThemeRef: i2, mergedValueRef: d2, mergedExpandedKeysRef: _2, activePathRef: y2, mergedClsPrefixRef: n2, isHorizontalRef: F(() => t2.mode === `horizontal`), invertedRef: ve(t2, `inverted`), doSelect: b2, toggleExpand: S2 });
  function b2(n3, r3) {
  ...
  }), E2 = r2 ? h(`menu`, F(() => t2.inverted ? `a` : `b`), w2, t2) : void 0, D2 = O(), te2 = A(null), re2 = A(null), ie2 = true, ae2 = () => {
    var e2;
    ie2 ? ie2 = false : (e2 = te2.value) == null || e2.sync({ showAllItemsBeforeCalculate: true });
  };
  function oe2() {
  ...
  let se2 = A(-1);
  function ce2(e2) {
    se2.value = t2.options.length - e2;
  }
  function le2(e2) {
    e2 || (se2.value = -1);
  }
  let ue2 = F(() => {
    ...
    return cn([ue2.value], { getIgnored(e3) {
      return ra(e3);
    }, getChildren(t3) {
      return t3[e2];
    }, getDisabled(e3) {
  ...
  }), fe2 = F(() => cn([{}]).treeNodes[0]);
  function pe2() {
    var _a2;
    if (se2.value === -1) return M(ca, { root: true, level: 0, key: `__ellpisisGroupPlaceholder__`, internalKey: `__ellpisisGroupPlaceholder__`, title: `\xB7\xB7\xB7`, tmNode: fe2.value, domId: D2, isEllipsisPlaceholder: true });
    let e2 = de2.value.treeNodes[0], t3 = y2.value;
    return M(ca, { level: 0, root: true, key: `__ellpisisGroup__`, internalKey: `__ellpisisGroup__`, title: `\xB7\xB7\xB7`, virtualChildActive: !!((_a2 = e2.children) == null ? void 0 : _a2.some((e3) => t3.includes(e3.key))), tmNode: e2, domId: D2, rawNodes: e2.rawNode.children || [], tmNodes: e2.children || [], isEllipsisPlaceholder: true });
  }
  return { mergedClsPrefix: n2, controlledExpandedKeys: g2, uncontrolledExpanededKeys: f2, mergedExpandedKeys: _2, uncontrolledValue: u2, mergedValue: d2, activePath: y2, tmNodes: v2, mergedTheme: i2, mergedCollapsed: o2, cssVars: r2 ? void 0 : w2, themeClass: E2 == null ? void 0 : E2.themeClass, overflowRef: te2, counterRef: re2, updateCounter: () => {
  }, onResize: ae2, onUpdateOverflow: le2, onUpdateCount: ce2, renderCounter: pe2, getCounter: oe2, onRender: E2 == null ? void 0 : E2.onRender, showOption: C2, deriveResponsiveState: ae2 };
}, render() {
  let { mergedClsPrefix: e2, mode: t2, themeClass: n2, onRender: r2 } = this;
  r2 == null ? void 0 : r2();
  let i2 = () => this.tmNodes.map((e3) => aa(e3, this.$props)), a2 = t2 === `horizontal` && this.responsive, o2 = () => M(`div`, Me(this.$attrs, { role: t2 === `horizontal` ? `menubar` : `menu`, class: [`${e2}-menu`, n2, `${e2}-menu--${t2}`, a2 && `${e2}-menu--responsive`, this.mergedCollapsed && `${e2}-menu--collapsed`], style: this.cssVars }), a2 ? M(tn, { ref: `overflowRef`, onUpdateOverflow: this.onUpdateOverflow, getCounter: this.getCounter, onUpdateCount: this.onUpdateCount, updateCounter: this.updateCounter, style: { width: `100%`, display: `flex`, overflow: `hidden` } }, { default: i2, counter: this.renderCounter }) : i2());
  return a2 ? M(te, { onResize: this.onResize }, { default: o2 }) : o2();
} });
const ua = { name: `dark`, common: q, Alert: tr, Anchor: nr, AutoComplete: ir, Avatar: ar, AvatarGroup: or, BackTop: sr, Badge: cr, Breadcrumb: lr, Button: Q, ButtonGroup: ti, Calendar: ur, Card: dr, Carousel: fr, Cascader: mr, Checkbox: pr, Code: hr, Collapse: gr, CollapseTransition: _r, ColorPicker: vr, DataTable: Er, DatePicker: kr, Descriptions: Ar, Dialog: jr, Divider: Jr, Drawer: Yr, Dropdown: Sr, DynamicInput: Xr, DynamicTags: Qr, Element: $r, Empty: Y, Ellipsis: wr, Equation: { name: `Equation`, common: q, self: Gt }, Flex: ei, Form: ni, GradientText: ri, Heatmap: Pi, Icon: Dr, IconWrapper: Fi, Image: Ii, Input: Z, InputNumber: ii, InputOtp: ai, LegacyTransfer: Ri, Layout: oi, List: ci, LoadingBar: Ir, Log: li, Menu: di, Mention: ui, Message: Lr, Modal: Mr, Notification: qr, PageHeader: fi, Pagination: xr, Popconfirm: pi, Popover: X, Popselect: yr, Progress: mi, QrCode: { name: `QrCode`, common: q, self: (e2) => ({ borderRadius: e2.borderRadius }) }, Radio: Tr, Rate: hi, Result: gi, Row: si, Scrollbar: J, Select: br, Skeleton: { name: `Skeleton`, common: q, self(e2) {
...
var da = { key: 0, class: `nav-bar` }, fa = { class: `software-info-menu` }, pa = { style: { width: `100%` } }, ma = { key: 0, style: { width: `100%`, "text-align": `center`, padding: `4px` } }, ha = { key: 1, class: `nav-bar` }, ga = { key: 0, style: { width: `100%`, "text-align": `center`, padding: `4px` } }, _a = { class: `main-layout` }, va = Oe(P({ __name: `AppLayout`, setup(e2) {
  _e((e3) => ({ dba89f70: p2.value ? `column` : `row` }));
  let t2 = Ne(), n2 = Dn(), r2 = new On(), { t: i2, locale: a2 } = dt();
  function o2(e3) {
    return () => M(jn, null, { default: () => M(e3) });
  }
  n2.settings.interfaceLanguage = n2.settings.interfaceLanguage ?? a2.value, a2.value = n2.settings.interfaceLanguage, fe(() => n2.settings.interfaceLanguage, (e3) => {
    e3 && (a2.value = e3);
  });
  let s2 = [{ label: () => M(Fe, { to: `/tracker` }, { default: () => i2(`router.tracker`) }), key: `tracker`, icon: o2(Le) }, { label: () => M(Fe, { to: `/sketch-centre` }, { default: () => i2(`router.sketchCentre`) }), key: `sketch-centre`, icon: o2(Be) }], c2 = [{ label: () => M(Fe, { to: `/settings` }, { default: () => i2(`router.settings`) }), key: `settings`, icon: o2(Ie) }, { label: () => M(Fe, { to: `/about` }, { default: () => i2(`router.about`) }), key: `about`, icon: o2(In) }], l2 = F(() => t2.path.slice(1)), u2 = `6a1edc3
`, { width: d2, height: f2 } = nn(), p2 = F(() => d2.value > f2.value);
  return (e3, t3) => (N(), R(`div`, { class: ke([`app-layout`, p2.value ? `app-layout-horizontal` : `app-layout-vertical`]) }, [p2.value ? (N(), R(`div`, da, [I(j(la), { options: s2, "default-value": `tracker`, value: l2.value, mode: p2.value ? `vertical` : `horizontal` }, null, 8, [`value`, `mode`]), L(`div`, fa, [L(`div`, pa, [I(j(la), { options: c2, mode: p2.value ? `vertical` : `horizontal`, value: l2.value }, null, 8, [`mode`, `value`])]), j(u2) ? (N(), R(`div`, ma, [I(j(at), { depth: `3` }, { default: B(() => [be(Ee(`Commit:` + j(u2).toLocaleUpperCase()), 1)]), _: 1 })])) : Se(``, true)])])) : (N(), R(`div`, ha, [I(j(re), { trigger: j(r2).isMobile ? `click` : `hover`, style: { padding: `2px 0`, transform: `translateX(2px)` }, placement: `bottom-start` }, { trigger: B(() => [I(j(ln), { style: { width: `48px` } }, { icon: B(() => [I(j(jn), null, { default: B(() => [I(j(Rn))]), _: 1 })]), _: 1 })]), default: B(() => [I(j(la), { options: s2.concat(c2), "default-value": `tracker`, value: l2.value, "dropdown-placement": `top-start`, mode: `vertical` }, null, 8, [`options`, `value`])]), _: 1 }, 8, [`trigger`]), j(u2) ? (N(), R(`div`, ga, [I(j(at), { depth: `3` }, { default: B(() => [be(Ee(`Commit:` + j(u2).toLocaleUpperCase()), 1)]), _: 1 })])) : Se(``, true)])), L(`div`, _a, [I(j(Pe), null, { default: B(({ Component: e4 }) => [I(ue, { name: `slide-fade`, mode: `out-in` }, { default: B(() => [(N(), ye(Ce, null, [(N(), ye(pe(e4), { key: l2.value }))], 1024))]), _: 2 }, 1024)]), _: 1 })])], 2));
} }), [[`__scopeId`, `data-v-ee060632`]]), ya = xe(((e2, t2) => {
  ...
  var { webm: n2, mp4: r2 } = ya(), i2 = () => typeof navigator < `u` && parseFloat((`` + (/CPU.*OS ([0-9_]{3,4})[0-9_]{0,1}|(CPU like).*AppleWebKit.*Mobile/i.exec(navigator.userAgent) || [0, ``])[1]).replace(`undefined`, `3_2`).replace(`_`, `.`).replace(`_`, ``)) < 10 && !window.MSStream, a2 = () => `wakeLock` in navigator;
  t2.exports = class {
    constructor() {
...
}))(), 1), xa = P({ __name: `App`, setup(e2) {
  let t2 = Dn(), n2 = window.GeolocationManager, r2 = Kn(), i2 = F(() => (t2.settings.theme === `system` ? r2.value : t2.settings.theme) === `dark` ? ua : Xt), a2 = { common: { fontFamily: `Barlow, -apple-system, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"` } };
  return k(`platformInfo`, new On()), k(`settings`, t2), k(`noSleep`, new ba.default()), k(`geolocation`, n2), le(() => t2.init()), (e3, t3) => (N(), ye(j(bt), { theme: i2.value, abstract: true, "inline-theme-disabled": true, "theme-overrides": a2 }, { default: B(() => [I(j(Fr), null, { default: B(() => [I(j(Kr), null, { default: B(() => [I(j(Wr), { placement: `bottom-right` }, { default: B(() => [I(va), I(j(Ni))]), _: 1 })]), _: 1 })]), _: 1 })]), _: 1 }, 8, [`theme`]));
} });
export {
  xa as default
};
