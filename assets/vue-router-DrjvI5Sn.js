import { Ct as e, Jt as t, Qt as n, Xt as r, Zt as i, _t as a, ht as o, jt as s, nn as c, st as l, yt as u, zt as d } from "./index-C4uc8sCV.js";
...
function $e(e2) {
  let t2 = u(J), n2 = u(De), r2 = l(() => {
    ...
    if (o3 > -1) return o3;
    let s3 = it(e3[t3 - 2]);
    return t3 > 1 && it(i3) === s3 && a3[a3.length - 1].path !== s3 ? a3.findIndex(M.bind(null, e3[t3 - 2])) : o3;
  }), a2 = l(() => i2.value > -1 && rt(n2.params, r2.value.params)), o2 = l(() => i2.value > -1 && i2.value === n2.matched.length - 1 && N(n2.params, r2.value.params));
  function s2(n3 = {}) {
    if (nt(n3)) {
      let n4 = t2[c(e2.replace) ? `replace` : `push`](c(e2.to)).catch(_);
      return e2.viewTransition && typeof document < `u` && `startViewTransition` in document && document.startViewTransition(() => n4), n4;
    }
    return Promise.resolve();
  }
  return { route: r2, href: l(() => r2.value.href), isActive: a2, isExactActive: o2, navigate: s2 };
}
function et(e2) {
  return e2.length === 1 ? e2[0] : e2;
}
var tt = o({ name: `RouterLink`, compatConfig: { MODE: 3 }, props: { to: { type: [String, Object], required: true }, replace: Boolean, activeClass: String, exactActiveClass: String, custom: Boolean, ariaCurrentValue: { type: String, default: `page` }, viewTransition: Boolean }, useLink: $e, setup(e2, { slots: n2 }) {
  let r2 = t($e(e2)), { options: i2 } = u(J), o2 = l(() => ({ [at(e2.activeClass, i2.linkActiveClass, `router-link-active`)]: r2.isActive, [at(e2.exactActiveClass, i2.linkExactActiveClass, `router-link-exact-active`)]: r2.isExactActive }));
  return () => {
    let t2 = n2.default && et(n2.default(r2));
    return e2.custom ? t2 : a(`a`, { "aria-current": r2.isExactActive ? e2.ariaCurrentValue : null, href: r2.href, onClick: r2.navigate, class: o2.value }, t2);
  };
} });
function nt(e2) {
...
var at = (e2, t2, n2) => e2 ?? t2 ?? n2, ot = o({ name: `RouterView`, inheritAttrs: false, props: { name: { type: String, default: `default` }, route: Object }, compatConfig: { MODE: 3 }, setup(e2, { attrs: t2, slots: n2 }) {
  let i2 = u(Oe), o2 = l(() => e2.route || i2.value), f2 = u(Ee, 0), p2 = l(() => {
    let e3 = c(f2), { matched: t3 } = o2.value, n3;
    for (; (n3 = t3[e3]) && !n3.components; ) e3++;
    return e3;
  }), m2 = l(() => o2.value.matched[p2.value]);
  s(Ee, l(() => p2.value + 1)), s(Te, m2), s(Oe, o2);
  let g2 = r();
  return d(() => [g2.value, m2.value, e2.name], ([e3, t3, n3], [r2, i3, a2]) => {
    t3 && (t3.instances[n3] = e3, i3 && i3 !== t3 && e3 && e3 === r2 && (t3.leaveGuards.size || (t3.leaveGuards = i3.leaveGuards), t3.updateGuards.size || (t3.updateGuards = i3.updateGuards))), e3 && t3 && (!i3 || !M(t3, i3) || !r2) && (t3.enterCallbacks[n3] || []).forEach((t4) => t4(e3));
  }, { flush: `post` }), () => {
    let r2 = o2.value, i3 = e2.name, s2 = m2.value, c2 = s2 && s2.components[i3];
    if (!c2) return st(n2.default, { Component: c2, route: r2 });
    let l2 = s2.props[i3], u2 = a(c2, h({}, l2 ? l2 === true ? r2.params : typeof l2 == `function` ? l2(r2) : l2 : null, t2, { onVnodeUnmounted: (e3) => {
      e3.component.isUnmounted && (s2.instances[i3] = null);
    }, ref: g2 }));
    return st(n2.default, { Component: u2, route: r2 }) || u2;
  };
} });
function st(e2, t2) {
  if (!e2) return null;
...
var ct = ot;
function lt(t2) {
  let r2 = We(t2.routes, t2), a2 = t2.parseQuery || Se, o2 = t2.stringifyQuery || Ce, s2 = t2.history, l2 = Y(), u2 = Y(), d2 = Y(), p2 = n(I), m2 = I;
  f && t2.scrollBehavior && `scrollRestoration` in history && (history.scrollRestoration = `manual`);
  let ee2 = g.bind(null, (e2) => `` + e2), y2 = g.bind(null, ue), te2 = g.bind(null, k);
  function ne2(e2, t3) {
    let n2, i2;
    return be(e2) ? (n2 = r2.getRecordMatcher(e2), i2 = t3) : i2 = e2, r2.addRoute(i2, n2);
  }
  function re2(e2) {
    let t3 = r2.getRecordMatcher(e2);
    t3 && r2.removeRoute(t3);
  }
  function ie2() {
    return r2.getRoutes().map((e2) => e2.record);
  }
  function ae2(e2) {
    return !!r2.getRecordMatcher(e2);
  }
  function b2(e2, t3) {
    if (t3 = h({}, t3 || p2.value), typeof e2 == `string`) {
      let n3 = j(a2, e2, t3.path), i3 = r2.resolve({ path: n3.path }, t3), o3 = s2.createHref(n3.fullPath);
      return h(n3, i3, { params: te2(i3.params), hash: k(n3.hash), redirectedFrom: void 0, href: o3 });
    }
    let n2;
    if (e2.path != null) n2 = h({}, e2, { path: j(a2, e2.path, t3.path).path });
    else {
      let r3 = h({}, e2.params);
      for (let e3 in r3) r3[e3] ?? delete r3[e3];
      n2 = h({}, e2, { params: y2(r3) }), t3.params = y2(t3.params);
    }
    let i2 = r2.resolve(n2, t3), c2 = e2.hash || ``;
    i2.params = ee2(te2(i2.params));
    let l3 = fe(o2, h({}, e2, { hash: ce(c2), path: i2.path })), u3 = s2.createHref(l3);
    return h({ fullPath: l3, hash: c2, query: o2 === Ce ? we(e2.query) : e2.query || {} }, i2, { redirectedFrom: void 0, href: u3 });
  }
  function x2(e2) {
    return typeof e2 == `string` ? j(a2, e2, p2.value.path) : h({}, e2);
  }
  function S2(e2, t3) {
    if (m2 !== e2) return K(G.NAVIGATION_CANCELLED, { from: t3, to: e2 });
  }
  function C2(e2) {
    return T2(e2);
  }
  function w2(e2) {
    return C2(h(x2(e2), { replace: true }));
  }
  function oe2(e2, t3) {
    let n2 = e2.matched[e2.matched.length - 1];
    if (n2 && n2.redirect) {
      let { redirect: r3 } = n2, i2 = typeof r3 == `function` ? r3(e2, t3) : r3;
      return typeof i2 == `string` && (i2 = i2.includes(`?`) || i2.includes(`#`) ? i2 = x2(i2) : { path: i2 }, i2.params = {}), h({ query: e2.query, hash: e2.hash, params: i2.path == null ? e2.params : {} }, i2);
    }
  }
  function T2(e2, t3) {
    let n2 = m2 = b2(e2), r3 = p2.value, i2 = e2.state, a3 = e2.force, s3 = e2.replace === true, c2 = oe2(n2, r3);
    if (c2) return T2(h(x2(c2), { state: typeof c2 == `object` ? h({}, i2, c2.state) : i2, force: a3, replace: s3 }), t3 || n2);
    let l3 = n2;
    l3.redirectedFrom = t3;
    let u3;
    return !a3 && pe(o2, r3, n2) && (u3 = K(G.NAVIGATION_DUPLICATED, { to: l3, from: r3 }), z2(r3, r3, true, false)), (u3 ? Promise.resolve(u3) : D2(l3, r3)).catch((e3) => q(e3) ? q(e3, G.NAVIGATION_GUARD_REDIRECT) ? e3 : R2(e3) : F2(e3, l3, r3)).then((e3) => {
      if (e3) {
        if (q(e3, G.NAVIGATION_GUARD_REDIRECT)) return T2(h({ replace: s3 }, x2(e3.to), { state: typeof e3.to == `object` ? h({}, i2, e3.to.state) : i2, force: a3 }), t3 || l3);
      } else e3 = O2(l3, r3, true, s3, i2);
      return le2(l3, r3, e3), e3;
    });
  }
  function se2(e2, t3) {
    let n2 = S2(e2, t3);
    return n2 ? Promise.reject(n2) : Promise.resolve();
  }
  function E2(e2) {
    let t3 = H2.values().next().value;
    return t3 && typeof t3.runWithContext == `function` ? t3.runWithContext(e2) : e2();
  }
  function D2(e2, t3) {
    let n2, [r3, i2, a3] = Ae(e2, t3);
    n2 = ke(r3.reverse(), `beforeRouteLeave`, e2, t3);
    for (let i3 of r3) i3.leaveGuards.forEach((r4) => {
      n2.push(X(r4, e2, t3));
    });
    let o3 = se2.bind(null, e2, t3);
    return n2.push(o3), W2(n2).then(() => {
      n2 = [];
      for (let r4 of l2.list()) n2.push(X(r4, e2, t3));
      return n2.push(o3), W2(n2);
    }).then(() => {
      n2 = ke(i2, `beforeRouteUpdate`, e2, t3);
      ...
      n2 = [];
      for (let r4 of a3) if (r4.beforeEnter) if (v(r4.beforeEnter)) for (let i3 of r4.beforeEnter) n2.push(X(i3, e2, t3));
      else n2.push(X(r4.beforeEnter, e2, t3));
      return n2.push(o3), W2(n2);
    }).then(() => (e2.matched.forEach((e3) => e3.enterCallbacks = {}), n2 = ke(a3, `beforeRouteEnter`, e2, t3, E2), n2.push(o3), W2(n2))).then(() => {
      n2 = [];
      for (let r4 of u2.list()) n2.push(X(r4, e2, t3));
      return n2.push(o3), W2(n2);
    }).catch((e3) => q(e3, G.NAVIGATION_CANCELLED) ? e3 : Promise.reject(e3));
  }
  function le2(e2, t3, n2) {
    d2.list().forEach((r3) => E2(() => r3(e2, t3, n2)));
  }
  function O2(e2, t3, n2, r3, i2) {
    let a3 = S2(e2, t3);
    if (a3) return a3;
    let o3 = t3 === I, c2 = f ? history.state : {};
    n2 && (r3 || o3 ? s2.replace(e2.fullPath, h({ scroll: o3 && c2 && c2.scroll }, i2)) : s2.push(e2.fullPath, i2)), p2.value = e2, z2(e2, t3, n2, o3), R2();
  }
  let A2;
  function de2() {
    A2 || (A2 = s2.listen((e2, t3, n2) => {
      if (!U2.listening) return;
      let r3 = b2(e2), i2 = oe2(r3, U2.currentRoute.value);
      if (i2) {
      ...
      m2 = r3;
      let a3 = p2.value;
      f && ve(_e(a3.fullPath, n2.delta), he()), D2(r3, a3).catch((e3) => q(e3, G.NAVIGATION_ABORTED | G.NAVIGATION_CANCELLED) ? e3 : q(e3, G.NAVIGATION_GUARD_REDIRECT) ? (T2(h(x2(e3.to), { force: true }), r3).then((e4) => {
        q(e4, G.NAVIGATION_ABORTED | G.NAVIGATION_DUPLICATED) && !n2.delta && n2.type === L.pop && s2.go(-1, false);
      }).catch(_), Promise.reject()) : (n2.delta && s2.go(-n2.delta, false), F2(e3, r3, a3))).then((e3) => {
        e3 || (e3 = O2(r3, a3, false)), e3 && (n2.delta && !q(e3, G.NAVIGATION_CANCELLED) ? s2.go(-n2.delta, false) : n2.type === L.pop && q(e3, G.NAVIGATION_ABORTED | G.NAVIGATION_DUPLICATED) && s2.go(-1, false)), le2(r3, a3, e3);
      }).catch(_);
    }));
  }
  let M2 = Y(), N2 = Y(), P2;
  function F2(e2, t3, n2) {
    R2(e2);
    let r3 = N2.list();
    return r3.length ? r3.forEach((r4) => r4(e2, t3, n2)) : console.error(e2), Promise.reject(e2);
  }
  function me2() {
    return P2 && p2.value !== I ? Promise.resolve() : new Promise((e2, t3) => {
      M2.add([e2, t3]);
    });
  }
  function R2(e2) {
    return P2 || (P2 = !e2, de2(), M2.list().forEach(([t3, n2]) => e2 ? n2(e2) : t3()), M2.reset()), e2;
  }
  function z2(n2, r3, i2, a3) {
    let { scrollBehavior: o3 } = t2;
    if (!f || !o3) return Promise.resolve();
    let s3 = !i2 && ye(_e(n2.fullPath, 0)) || (a3 || !i2) && history.state && history.state.scroll || null;
    return e().then(() => o3(n2, r3, s3)).then((e2) => e2 && ge(e2)).catch((e2) => F2(e2, n2, r3));
  }
  let B2 = (e2) => s2.go(e2), V2, H2 = /* @__PURE__ */ new Set(), U2 = { currentRoute: p2, listening: true, addRoute: ne2, removeRoute: re2, clearRoutes: r2.clearRoutes, hasRoute: ae2, getRoutes: ie2, resolve: b2, options: t2, push: C2, replace: w2, go: B2, back: () => B2(-1), forward: () => B2(1), beforeEach: l2.add, beforeResolve: u2.add, afterEach: d2.add, onError: N2.add, isReady: me2, install(e2) {
    e2.component(`RouterLink`, tt), e2.component(`RouterView`, ct), e2.config.globalProperties.$router = U2, Object.defineProperty(e2.config.globalProperties, `$route`, { enumerable: true, get: () => c(p2) }), f && !V2 && p2.value === I && (V2 = true, C2(s2.location).catch((e3) => {
    }));
    let t3 = {};
    for (let e3 in I) Object.defineProperty(t3, e3, { get: () => p2.value[e3], enumerable: true });
    e2.provide(J, U2), e2.provide(De, i(t3)), e2.provide(Oe, p2);
    let n2 = e2.unmount;
    H2.add(e2), e2.unmount = function() {
      H2.delete(e2), H2.size < 1 && (m2 = I, A2 && A2(), A2 = null, p2.value = I, V2 = false, P2 = false), n2();
    };
  } };
  function W2(e2) {
    return e2.reduce((e3, t3) => e3.then(() => E2(t3)), Promise.resolve());
  }
  return U2;
}
function ut() {
