import { Gt as e, Ot as t, Qt as n, Tt as r, Ut as i, Xt as a, _t as o, at as s, gt as c, ht as l, kt as u, mt as d, nt as f, st as p, yt as m, zt as h } from "./index-C4uc8sCV.js";
function g(e2, t2) {
...
function hr(e2 = {}, t2) {
  let { __root: r2, __injectWithOption: i2 } = e2, o2 = r2 === void 0, s2 = e2.flatJson, c2 = _ ? a : n, l2 = !!e2.translateExistCompatible, u2 = I(e2.inheritLocale) ? e2.inheritLocale : true, d2 = c2(r2 && u2 ? r2.locale.value : F(e2.locale) ? e2.locale : en), f2 = c2(r2 && u2 ? r2.fallbackLocale.value : F(e2.fallbackLocale) || N(e2.fallbackLocale) || z(e2.fallbackLocale) || e2.fallbackLocale === false ? e2.fallbackLocale : d2.value), m2 = c2(sr(d2.value, e2)), g2 = c2(z(e2.datetimeFormats) ? e2.datetimeFormats : { [d2.value]: {} }), v2 = c2(z(e2.numberFormats) ? e2.numberFormats : { [d2.value]: {} }), y2 = r2 ? r2.missingWarn : I(e2.missingWarn) || C(e2.missingWarn) ? e2.missingWarn : true, b2 = r2 ? r2.fallbackWarn : I(e2.fallbackWarn) || C(e2.fallbackWarn) ? e2.fallbackWarn : true, S2 = r2 ? r2.fallbackRoot : I(e2.fallbackRoot) ? e2.fallbackRoot : true, w2 = !!e2.fallbackFormat, E2 = P(e2.missing) ? e2.missing : null, D2 = P(e2.missing) ? mr(e2.missing) : null, O2 = P(e2.postTranslation) ? e2.postTranslation : null, k2 = r2 ? r2.warnHtmlMessage : I(e2.warnHtmlMessage) ? e2.warnHtmlMessage : true, ee2 = !!e2.escapeParameter, te2 = r2 ? r2.modifiers : z(e2.modifiers) ? e2.modifiers : {}, A2 = e2.pluralRules || r2 && r2.pluralRules, j2;
  j2 = (() => {
    o2 && pn(null);
    let t3 = { version: Yn, locale: d2.value, fallbackLocale: f2.value, messages: m2.value, modifiers: te2, pluralRules: A2, missing: D2 === null ? void 0 : D2, missingWarn: y2, fallbackWarn: b2, fallbackFormat: w2, unresolving: true, postTranslation: O2 === null ? void 0 : O2, warnHtmlMessage: k2, escapeParameter: ee2, messageResolver: e2.messageResolver, messageCompiler: e2.messageCompiler, __meta: { framework: `vue` } };
    t3.datetimeFormats = g2.value, t3.numberFormats = v2.value, t3.__datetimeFormatters = z(j2) ? j2.__datetimeFormatters : void 0, t3.__numberFormatters = z(j2) ? j2.__numberFormatters : void 0;
    let n2 = gn(t3);
    return o2 && pn(n2), n2;
  })(), yn(j2, d2.value, f2.value);
  function ne2() {
    return [d2.value, f2.value, m2.value, g2.value, v2.value];
  }
  let R2 = p({ get: () => d2.value, set: (e3) => {
    d2.value = e3, j2.locale = d2.value;
  } }), re2 = p({ get: () => f2.value, set: (e3) => {
    f2.value = e3, j2.fallbackLocale = f2.value, yn(j2, d2.value, e3);
  } }), ie2 = p(() => m2.value), ae2 = p(() => g2.value), oe2 = p(() => v2.value);
  function se2() {
    return P(O2) ? O2 : null;
  }
  function le2(e3) {
  ...
  let B2 = (e3, t3, n2, i3, a2, s3) => {
    ne2();
    let c3;
    try {
      __INTLIFY_PROD_DEVTOOLS__, o2 || (j2.fallbackContext = r2 ? mn() : void 0), c3 = e3(j2);
    } finally {
      __INTLIFY_PROD_DEVTOOLS__, o2 || (j2.fallbackContext = void 0);
    }
    if (n2 !== `translate exists` && x(c3) && c3 === -1 || n2 === `translate exists` && !c3) {
      let [e4, n3] = t3();
      return r2 && S2 ? i3(r2) : a2(e4);
    } else if (s3(c3)) return c3;
    else throw $(Q.UNEXPECTED_RETURN_TYPE);
  };
  function fe2(...e3) {
    return B2((t3) => Reflect.apply(Mn, null, [t3, ...e3]), () => Ln(...e3), `translate`, (t3) => Reflect.apply(t3.t, t3, [...e3]), (e4) => e4, (e4) => F(e4));
  }
  function pe2(...e3) {
    let [t3, n2, r3] = e3;
    if (r3 && !L(r3)) throw $(Q.INVALID_ARGUMENT);
    return fe2(t3, n2, T({ resolvedMessage: true }, r3 || {}));
  }
  function me2(...e3) {
    return B2((t3) => Reflect.apply(Vn, null, [t3, ...e3]), () => Un(...e3), `datetime format`, (t3) => Reflect.apply(t3.d, t3, [...e3]), () => ``, (e4) => F(e4));
  }
  function he2(...e3) {
    return B2((t3) => Reflect.apply(Gn, null, [t3, ...e3]), () => qn(...e3), `number format`, (t3) => Reflect.apply(t3.n, t3, [...e3]), () => ``, (e4) => F(e4));
  }
  function ge2(e3) {
  ...
  function ve2(...e3) {
    return B2((t3) => {
      ...
      return n2;
    }, () => Ln(...e3), `translate`, (t3) => t3[er](...e3), (e4) => [ur(e4)], (e4) => N(e4));
  }
  function V2(...e3) {
    return B2((t3) => Reflect.apply(Gn, null, [t3, ...e3]), () => qn(...e3), `number format`, (t3) => t3[nr](...e3), dr, (e4) => F(e4) || N(e4));
  }
  function ye2(...e3) {
    return B2((t3) => Reflect.apply(Vn, null, [t3, ...e3]), () => Un(...e3), `datetime format`, (t3) => t3[tr](...e3), dr, (e4) => F(e4) || N(e4));
  }
  function be2(e3) {
  ...
  function xe2(e3, t3) {
    return B2(() => {
      if (!e3) return false;
      let n2 = U2(F(t3) ? t3 : d2.value), r3 = j2.messageResolver(n2, e3);
      return l2 ? r3 != null : K(r3) || Y(r3) || F(r3);
    }, () => [e3], `translate exists`, (n2) => Reflect.apply(n2.te, n2, [e3, t3]), fr, (e4) => I(e4));
  }
  function H2(e3) {
    let t3 = null, n2 = Yt(j2, f2.value, d2.value);
    for (let r3 = 0; r3 < n2.length; r3++) {
      let i3 = m2.value[n2[r3]] || {}, a2 = j2.messageResolver(i3, e3);
      if (a2 != null) {
        t3 = a2;
        break;
      }
  ...
  function Ce2(e3, t3) {
    ...
    m2.value[e3] = t3, j2.messages = m2.value;
  }
  function we2(e3, t3) {
    m2.value[e3] = m2.value[e3] || {};
    let n2 = { [e3]: t3 };
    if (s2) for (let e4 in n2) M(n2, e4) && or(n2[e4]);
    t3 = n2[e3], ce(t3, m2.value[e3]), j2.messages = m2.value;
  }
  function Te2(e3) {
    return g2.value[e3] || {};
  }
  function Ee2(e3, t3) {
    g2.value[e3] = t3, j2.datetimeFormats = g2.value, Wn(j2, e3, t3);
  }
  function De2(e3, t3) {
    g2.value[e3] = T(g2.value[e3] || {}, t3), j2.datetimeFormats = g2.value, Wn(j2, e3, t3);
  }
  function Oe2(e3) {
    return v2.value[e3] || {};
  }
  function ke2(e3, t3) {
    v2.value[e3] = t3, j2.numberFormats = v2.value, Jn(j2, e3, t3);
  }
  function Ae2(e3, t3) {
    v2.value[e3] = T(v2.value[e3] || {}, t3), j2.numberFormats = v2.value, Jn(j2, e3, t3);
  }
  pr++, r2 && _ && (h(r2.locale, (e3) => {
    u2 && (d2.value = e3, j2.locale = e3, yn(j2, d2.value, f2.value));
  }), h(r2.fallbackLocale, (e3) => {
    u2 && (f2.value = e3, j2.fallbackLocale = e3, yn(j2, d2.value, f2.value));
  }));
  let W2 = { id: pr, locale: R2, fallbackLocale: re2, get inheritLocale() {
    return u2;
  }, set inheritLocale(e3) {
    u2 = e3, e3 && r2 && (d2.value = r2.locale.value, f2.value = r2.fallbackLocale.value, yn(j2, d2.value, f2.value));
  }, get availableLocales() {
    return Object.keys(m2.value).sort();
  ...
  return W2.datetimeFormats = ae2, W2.numberFormats = oe2, W2.rt = pe2, W2.te = xe2, W2.tm = Se2, W2.d = me2, W2.n = he2, W2.getDateTimeFormat = Te2, W2.setDateTimeFormat = Ee2, W2.mergeDateTimeFormat = De2, W2.getNumberFormat = Oe2, W2.setNumberFormat = ke2, W2.mergeNumberFormat = Ae2, W2[ir] = i2, W2[er] = ve2, W2[tr] = ye2, W2[nr] = V2, W2;
}
function gr(e2) {
...
function yr({ slots: e2 }, t2) {
  return t2.length === 1 && t2[0] === `default` ? (e2.default ? e2.default() : []).reduce((e3, t3) => [...e3, ...t3.type === f ? t3.children : [t3]], []) : t2.reduce((t3, n2) => {
    let r2 = e2[n2];
...
var xr = l({ name: `i18n-t`, props: T({ keypath: { type: String, required: true }, plural: { type: [Number, String], validator: (e2) => x(e2) || !isNaN(e2) } }, vr), setup(e2, t2) {
  let { slots: n2, attrs: r2 } = t2, i2 = e2.i18n || Fr({ useScope: e2.scope, __useComponent: true });
  return () => {
    let a2 = Object.keys(n2).filter((e3) => e3 !== `_`), s2 = D();
    e2.locale && (s2.locale = e2.locale), e2.plural !== void 0 && (s2.plural = F(e2.plural) ? +e2.plural : e2.plural);
    let c2 = yr(t2, a2), l2 = i2[er](e2.keypath, c2, s2), u2 = T(D(), r2);
    return o(F(e2.tag) || L(e2.tag) ? e2.tag : br(), u2, l2);
  };
} });
function Sr(e2) {
  return N(e2) && !F(e2[0]);
...
function Cr(e2, t2, n2, r2) {
  ...
  return () => {
    let t3 = { part: true }, s2 = D();
    e2.locale && (t3.locale = e2.locale), F(e2.format) ? t3.key = e2.format : L(e2.format) && (F(e2.format.key) && (t3.key = e2.format.key), s2 = Object.keys(e2.format).reduce((t4, r3) => n2.includes(r3) ? T(D(), t4, { [r3]: e2.format[r3] }) : t4, D()));
    let c2 = r2(e2.value, t3, s2), l2 = [t3.key];
...
var wr = l({ name: `i18n-n`, props: T({ value: { type: Number, required: true }, format: { type: [String, Object] } }, vr), setup(e2, t2) {
  let n2 = e2.i18n || Fr({ useScope: e2.scope, __useComponent: true });
  return Cr(e2, t2, Kn, (...e3) => n2[nr](...e3));
} }), Tr = l({ name: `i18n-d`, props: T({ value: { type: [Number, Date], required: true }, format: { type: [String, Object] } }, vr), setup(e2, t2) {
  let n2 = e2.i18n || Fr({ useScope: e2.scope, __useComponent: true });
...
function Dr(e2) {
  ...
  return { created: (n2, r2) => {
    let [i2, a2] = t2(r2);
    _ && e2.global === a2 && (n2.__i18nWatcher = h(a2.locale, () => {
      r2.instance && r2.instance.$forceUpdate();
    })), n2.__composer = a2, n2.textContent = i2;
  }, unmounted: (e3) => {
...
function Hr(e2, n2, r2) {
  t(() => {
  }, n2), u(() => {
    let t2 = r2;
    e2.__deleteInstance(n2);
    let i2 = t2[ar];
    i2 && (i2(), delete t2[ar]);
  }, n2);
}
function Ur(e2, t2, i2, o2 = {}) {
  let s2 = t2 === `local`, c2 = n(null);
  if (s2 && e2.proxy && !(e2.proxy.$options.i18n || e2.proxy.$options.__i18n)) throw $(Q.MUST_DEFINE_I18N_OPTION_IN_ALLOW_COMPOSITION);
  let l2 = I(o2.inheritLocale) ? o2.inheritLocale : !F(o2.locale), u2 = a(!s2 || l2 ? i2.locale.value : F(o2.locale) ? o2.locale : en), d2 = a(!s2 || l2 ? i2.fallbackLocale.value : F(o2.fallbackLocale) || N(o2.fallbackLocale) || z(o2.fallbackLocale) || o2.fallbackLocale === false ? o2.fallbackLocale : u2.value), f2 = a(sr(u2.value, o2)), m2 = a(z(o2.datetimeFormats) ? o2.datetimeFormats : { [u2.value]: {} }), h2 = a(z(o2.numberFormats) ? o2.numberFormats : { [u2.value]: {} }), g2 = s2 ? i2.missingWarn : I(o2.missingWarn) || C(o2.missingWarn) ? o2.missingWarn : true, _2 = s2 ? i2.fallbackWarn : I(o2.fallbackWarn) || C(o2.fallbackWarn) ? o2.fallbackWarn : true, v2 = s2 ? i2.fallbackRoot : I(o2.fallbackRoot) ? o2.fallbackRoot : true, y2 = !!o2.fallbackFormat, b2 = P(o2.missing) ? o2.missing : null, x2 = P(o2.postTranslation) ? o2.postTranslation : null, S2 = s2 ? i2.warnHtmlMessage : I(o2.warnHtmlMessage) ? o2.warnHtmlMessage : true, w2 = !!o2.escapeParameter, T2 = s2 ? i2.modifiers : z(o2.modifiers) ? o2.modifiers : {}, E2 = o2.pluralRules || s2 && i2.pluralRules;
  function D2() {
    return [u2.value, d2.value, f2.value, m2.value, h2.value];
  }
  let O2 = p({ get: () => c2.value ? c2.value.locale.value : u2.value, set: (e3) => {
    c2.value && (c2.value.locale.value = e3), u2.value = e3;
  } }), k2 = p({ get: () => c2.value ? c2.value.fallbackLocale.value : d2.value, set: (e3) => {
    c2.value && (c2.value.fallbackLocale.value = e3), d2.value = e3;
  } }), ee2 = p(() => c2.value ? c2.value.messages.value : f2.value), te2 = p(() => m2.value), A2 = p(() => h2.value);
  function j2() {
    return c2.value ? c2.value.getPostTranslationHandler() : x2;
  }
  function M2(e3) {
    c2.value && c2.value.setPostTranslationHandler(e3);
  }
  function L2() {
    return c2.value ? c2.value.getMissingHandler() : b2;
  }
  function ne2(e3) {
    c2.value && c2.value.setMissingHandler(e3);
  }
  function R2(e3) {
    return D2(), e3();
  }
  function re2(...e3) {
    return c2.value ? R2(() => Reflect.apply(c2.value.t, null, [...e3])) : R2(() => ``);
  }
  function ie2(...e3) {
    return c2.value ? Reflect.apply(c2.value.rt, null, [...e3]) : ``;
  }
  function ae2(...e3) {
    return c2.value ? R2(() => Reflect.apply(c2.value.d, null, [...e3])) : R2(() => ``);
  }
  function oe2(...e3) {
    return c2.value ? R2(() => Reflect.apply(c2.value.n, null, [...e3])) : R2(() => ``);
  }
  function se2(e3) {
    return c2.value ? c2.value.tm(e3) : {};
  }
  function ce2(e3, t3) {
    return c2.value ? c2.value.te(e3, t3) : false;
  }
  function le2(e3) {
    return c2.value ? c2.value.getLocaleMessage(e3) : {};
  }
  function ue2(e3, t3) {
    c2.value && (c2.value.setLocaleMessage(e3, t3), f2.value[e3] = t3);
  }
  function de2(e3, t3) {
    c2.value && c2.value.mergeLocaleMessage(e3, t3);
  }
  function B2(e3) {
    return c2.value ? c2.value.getDateTimeFormat(e3) : {};
  }
  function fe2(e3, t3) {
    c2.value && (c2.value.setDateTimeFormat(e3, t3), m2.value[e3] = t3);
  }
  function pe2(e3, t3) {
    c2.value && c2.value.mergeDateTimeFormat(e3, t3);
  }
  function me2(e3) {
    return c2.value ? c2.value.getNumberFormat(e3) : {};
  }
  function he2(e3, t3) {
    c2.value && (c2.value.setNumberFormat(e3, t3), h2.value[e3] = t3);
  }
  function ge2(e3, t3) {
    c2.value && c2.value.mergeNumberFormat(e3, t3);
  }
  let _e2 = { get id() {
    return c2.value ? c2.value.id : -1;
  }, locale: O2, fallbackLocale: k2, messages: ee2, datetimeFormats: te2, numberFormats: A2, get inheritLocale() {
    return c2.value ? c2.value.inheritLocale : l2;
  }, set inheritLocale(e3) {
    c2.value && (c2.value.inheritLocale = e3);
  }, get availableLocales() {
    return c2.value ? c2.value.availableLocales : Object.keys(f2.value);
  }, get modifiers() {
    return c2.value ? c2.value.modifiers : T2;
  }, get pluralRules() {
    return c2.value ? c2.value.pluralRules : E2;
  }, get isGlobal() {
    return c2.value ? c2.value.isGlobal : false;
  }, get missingWarn() {
    return c2.value ? c2.value.missingWarn : g2;
  }, set missingWarn(e3) {
    c2.value && (c2.value.missingWarn = e3);
  }, get fallbackWarn() {
    return c2.value ? c2.value.fallbackWarn : _2;
  }, set fallbackWarn(e3) {
    c2.value && (c2.value.missingWarn = e3);
  }, get fallbackRoot() {
    return c2.value ? c2.value.fallbackRoot : v2;
  }, set fallbackRoot(e3) {
    c2.value && (c2.value.fallbackRoot = e3);
  }, get fallbackFormat() {
    return c2.value ? c2.value.fallbackFormat : y2;
  }, set fallbackFormat(e3) {
    c2.value && (c2.value.fallbackFormat = e3);
  }, get warnHtmlMessage() {
    return c2.value ? c2.value.warnHtmlMessage : S2;
  }, set warnHtmlMessage(e3) {
    c2.value && (c2.value.warnHtmlMessage = e3);
  }, get escapeParameter() {
    return c2.value ? c2.value.escapeParameter : w2;
  }, set escapeParameter(e3) {
    c2.value && (c2.value.escapeParameter = e3);
  ...
  function ve2(e3) {
    e3.locale.value = u2.value, e3.fallbackLocale.value = d2.value, Object.keys(f2.value).forEach((t3) => {
      e3.mergeLocaleMessage(t3, f2.value[t3]);
    }), Object.keys(m2.value).forEach((t3) => {
      e3.mergeDateTimeFormat(t3, m2.value[t3]);
    }), Object.keys(h2.value).forEach((t3) => {
      e3.mergeNumberFormat(t3, h2.value[t3]);
  ...
  return r(() => {
    ...
    let n2 = c2.value = e2.proxy.$i18n.__composer;
    t2 === `global` ? (u2.value = n2.locale.value, d2.value = n2.fallbackLocale.value, f2.value = n2.messages.value, m2.value = n2.datetimeFormats.value, h2.value = n2.numberFormats.value) : s2 && ve2(n2);
  }), _e2;
}
var Wr = [`locale`, `fallbackLocale`, `availableLocales`], Gr = [`t`, `rt`, `d`, `n`, `tm`, `te`];
function Kr(t2, n2) {
  let r2 = /* @__PURE__ */ Object.create(null);
  return Wr.forEach((t3) => {
    let i2 = Object.getOwnPropertyDescriptor(n2, t3);
    if (!i2) throw $(Q.UNEXPECTED_ERROR);
    let a2 = e(i2.value) ? { get() {
      return i2.value.value;
    }, set(e2) {
      i2.value.value = e2;
    } } : { get() {
      return i2.get && i2.get();
    } };
    Object.defineProperty(r2, t3, a2);
  }), t2.config.globalProperties.$i18n = r2, Gr.forEach((e2) => {
    let r3 = Object.getOwnPropertyDescriptor(n2, e2);
    if (!r3 || !r3.value) throw $(Q.UNEXPECTED_ERROR);
    Object.defineProperty(t2.config.globalProperties, `$${e2}`, r3);
  }), () => {
    delete t2.config.globalProperties.$i18n, Gr.forEach((e2) => {
      delete t2.config.globalProperties[`$${e2}`];
    });
  };
}
